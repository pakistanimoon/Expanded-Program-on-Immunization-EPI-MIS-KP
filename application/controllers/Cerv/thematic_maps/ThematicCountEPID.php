...
class ThematicCountEPID extends CI_Controller {
	...
	public function index(){
		...
		if($this -> session -> District || $this -> input -> post('id')){
			...
			$data['heading']['mapName'] = "Suspected ".ucfirst($data['disease'])." Cases, {$districtName} Year-{$year} {$con} {$investigationResultText}";
			$data['heading']['barName'] = "Suspected ".ucfirst($data['disease'])." Cases, {$districtName} Year-{$year} {$con} {$investigationResultText}";
			...
			$data['heading']['mapName'] = "Suspected ".ucfirst($data['disease'])." Cases, Year-{$year} {$con} {$investigationResultText}";
			$data['heading']['barName'] = "Suspected ".ucfirst($data['disease'])." Cases, Year-{$year} {$con} {$investigationResultText}";
	...
	public function onClickUcWiseMapData(){
		...
		//print_r($data);exit;
		$data['colorAxis'] = $this -> colorAxis();
		$data['heading']['mapName'] = "Suspected ".ucfirst($data['disease'])." Cases, {$districtName} Year-{$year} {$con}";
		if($this -> session -> District || $this -> uri -> segment(4)){
			...
			$data['heading']['barName'] = "Suspected ".ucfirst($data['disease'])." Cases, {$districtName} Year-{$year} {$con}";
			$data['heading']['subtittle'] = $this -> session -> provincename;
			$data['heading']['run'] = false;
			$data['ucwisemap'] = 'true';
			$viewData['data'] = $data;
