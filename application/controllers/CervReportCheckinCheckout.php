<?php
class CervReportCheckinCheckout extends CI_Controller {
	//================ Constructor function Starts Here ==================//
	public function __construct() {
		parent::__construct();
		$this -> load -> helper('epi_functions_helper');
		authentication();
		$this -> load -> model('Cerv_reports_model_checkin_checkout');
	...
	function reportFilters(){
		...
		$reportPath = base_url()."CervReportCheckinCheckout/".$functionName;
	...
	function CERV_PVR(){		
		...
		//print_r($data); exit;
		$dataPVR['dataposted'] = $data;
		$dataPVR['data'] = $this -> Cerv_reports_model_checkin_checkout -> CERV_PVR($data);
		$dataPVR['fileToLoad'] 	= 'cervReports/monthly_checkin_checkout';
		$dataPVR['pageTitle']	='CERV | Monthly Checkin Checkout Report';
