<?php
class CervReports extends CI_Controller {
	//================ Constructor function Starts Here ==================//
	public function __construct() {
		parent::__construct();
		$this -> load -> helper('epi_functions_helper');
		authentication();
		$this -> load -> model('Cerv_reports_model');
	...
	function reportFilters(){
		...
		$reportPath = base_url()."CervReports/".$functionName;
	...
	function CERV_PVR(){		
		...
		$dataPVR['data'] = $this -> Cerv_reports_model -> CERV_PVR($data);
		$dataPVR['fileToLoad'] 	= 'cervReports/permanent_vaccination_register_view';
