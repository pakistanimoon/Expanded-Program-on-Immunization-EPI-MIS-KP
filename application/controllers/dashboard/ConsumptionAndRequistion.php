<?php
class ConsumptionAndRequistion extends CI_Controller {
	...
	public function index(){
		...
		$data['data'] = $data;
		$data['fileToLoad'] = 'dashboard/maincr';
	...
	public function getDistrictSeriesData($fmonth){
		...
		$seriesData = $this -> dashboard -> getCRComplianceData($fmonth);
		$category = array();
		$serieses = array();
		$result = array();
		$cat = array();
	...
	public function getProvincialSeriesData($fmonth){
		...
		$drilldown = array();
		$lastDistrictValue = "";
		$drilldownSeriesData = $this -> dashboard -> getCRComplianceDataDrillDownSeries($fmonth);
		$k=0;$ind=0;
