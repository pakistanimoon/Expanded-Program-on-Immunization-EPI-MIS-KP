...
class UtilizationOfServices extends CI_Controller {
	...
	public function index(){
		...
		if ($yearfrom == $yearto && $monthnamefrom != $monthnameto){
			$monthQauarterYear = " From {$monthnamefrom} to {$monthnameto}, {$yearfrom}" ;
		...
		//print_r($data);exit;
		$vaccinesArray = array('9' => 'Penta 1 - Penta 3', '18' => 'MR 1 - MR 2', '2' => 'TT 1 - TT 2', '16' => 'Penta 1 - MR 1', '21' => 'IPV 1 - IPV 2');
		$data['heading']['mapName'] = "";
		//$monthQauarterYear = "";
		//$year = $data['year'];
		...
		if($this -> session -> District || $this -> input -> post('id')){
			...
			$data['heading']['barName'] = $data['heading']['mapName'] = "UC Wise ".$vaccinesArray[$data['vaccineId']]." Dropout Rate, ".$LabelName." {$monthQauarterYear}";
			...
			$data['heading']['barName'] = $data['heading']['mapName'] = "District Wise ".$vaccinesArray[$data['vaccineId']]." Dropout Rate, {$provicialdistlevel} {$monthQauarterYear}";
	...
	public function onClickUcWiseMapData(){
		...
		$data['colorAxis'] = $this -> colorAxis();
		//echo "abc"; exit();
		$result1 = $this -> maps -> getMainIndicatorsData(0,$yearto);
		$data['indicators'] = $result1;
		if($data['vaccineId']=='1'){
			$data['vaccineId']= "9";
		}
		$vaccinesArray = array('9' => 'Penta 1 - Penta 3', '18' => 'MR 1 - MR 2', '2' => 'TT 1 - TT 2', '16' => 'Penta 1 - MR 1', '21' => 'IPV 1 - IPV 2'); 
		$data['heading']['mapName'] = $data['heading']['barName'] = "UC Wise ".$vaccinesArray[$data['vaccineId']]." Dropout Rate, ".$districtName." {$monthQauarterYear}";
		$data['heading']['subtittle'] = $this -> session -> provincename;
	...
	public function getQuerySelectPortion($data){
		...
		if($data['gender'] == "Male" && $vaccineId != "2"){
			if($data['vaccineBy'] == "Fixed"){
				...
				}else if($vaccineId == "21"){
					$q .= $subPartOfQuery . "as  first, (select sum(cri_r1_f13)+sum(cri_r3_f13)+sum(cri_r5_f13) " . $subPartOfQuery . " as second ";
				}else{}
				...
				if($vaccineId == "16"){
					...
					$q .= $subPartOfQuery . "as  first, (select sum(cri_r7_f13)+sum(cri_r9_f13)+sum(cri_r11_f13) " . $subPartOfQuery . " as second ";
				}else{}
				...
				if($vaccineId == "16"){
					...
					$q .= $subPartOfQuery . "as  first, (select sum(cri_r13_f13)+sum(cri_r15_f13)+sum(cri_r17_f13) " . $subPartOfQuery . " as second ";
				}else{}
				...
				if($vaccineId == "16"){
					...
					$q .= $subPartOfQuery . "as  first, (select sum(cri_r19_f13)+sum(cri_r21_f13)+sum(cri_r23_f13) " . $subPartOfQuery . " as second ";
				}else{}
			}else{
				...
				if($vaccineId == "16"){
					...
					$q .= $subPartOfQuery . "as  first, (select sum(cri_r25_f13) " . $subPartOfQuery . " as second ";
				}else{}
			}
			...
			if($data['vaccineBy'] == "Fixed"){
				...
				if($vaccineId == "16"){
					...
					$q .= $subPartOfQuery . "as  first, (select sum(cri_r2_f13)+sum(cri_r4_f13)+sum(cri_r6_f13) " . $subPartOfQuery . " as second ";
				}else{}
			}else if($data['vaccineBy'] == "Outreach"){
				...
				if($vaccineId == "16"){
					...
					$q .= $subPartOfQuery . "as  first, (select sum(cri_r8_f13)+sum(cri_r10_f13)+sum(cri_r12_f13) " . $subPartOfQuery . " as second ";
				}else{}
			}else if($data['vaccineBy'] == "Mobile"){
				...
				if($vaccineId == "16"){
					...
					$q .= $subPartOfQuery . "as  first, (select sum(cri_r14_f13)+sum(cri_r16_f13)+sum(cri_r18_f13) " . $subPartOfQuery . " as second ";
				}else{}
			}else if($data['vaccineBy'] == "LHW"){
				...
				if($vaccineId == "16"){
					...
					$q .= $subPartOfQuery . "as  first, (select sum(cri_r20_f13)+sum(cri_r22_f13)+sum(cri_r24_f13) " . $subPartOfQuery . " as second ";
				}else{}
			}else{
				...
				if($vaccineId == "16"){
					...
					$q .= $subPartOfQuery . "as  first, (select sum(cri_r26_f13) " . $subPartOfQuery . " as second ";
				}else{}
			}
			...
			if($vaccineId == "2" && $data['vaccGivento']){
				...
				if($data['vaccineBy'] == "Fixed"){
					...
					if($vaccineId == "16"){
						...
						$q .= $subPartOfQuery . "as  first, (select sum(cri_r1_f13)+sum(cri_r2_f13)+sum(cri_r3_f13)+sum(cri_r4_f13)+sum(cri_r5_f13)+sum(cri_r6_f13) " . $subPartOfQuery . " as second ";
					}else{}
				}else if($data['vaccineBy'] == "Outreach"){
					...
					if($vaccineId == "16"){
						...
						$q .= $subPartOfQuery . "as  first, (select sum(cri_r7_f13)+sum(cri_r8_f13)+sum(cri_r9_f13)+sum(cri_r10_f13)+sum(cri_r11_f13)+sum(cri_r12_f13) " . $subPartOfQuery . " as second ";
					}else{}
				}else if($data['vaccineBy'] == "Mobile"){
					...
					if($vaccineId == "16"){
						...
						$q .= $subPartOfQuery . "as  first, (select sum(cri_r13_f13)+sum(cri_r14_f13)+sum(cri_r15_f13)+sum(cri_r16_f13)+sum(cri_r17_f13)+sum(cri_r18_f13) " . $subPartOfQuery . " as second ";
					}else{}
				}else if($data['vaccineBy'] == "LHW"){
					...
					if($vaccineId == "16"){
						...
						$q .= $subPartOfQuery . "as  first, (select sum(cri_r19_f13)+sum(cri_r20_f13)+sum(cri_r21_f13)+sum(cri_r22_f13)+sum(cri_r23_f13)+sum(cri_r24_f13) " . $subPartOfQuery . " as second ";
					}else{}
				}else{
					...
					if($vaccineId == "16"){
						...
						$q .= $subPartOfQuery . "as  first, (select sum(cri_r25_f13)+sum(cri_r26_f13) " . $subPartOfQuery . " as second ";
					}else{}
				}
			}
		}		
	...
	public function ucSummary($parametersData){
		...
		$data['monthlyTotTarget'] = getmonthlyTotalTarget($code,$parametersData['yearto'],$parametersData['monthto'],$productsArray[$vaccineId]);
