...
class ThematicVaccineIndicator extends CI_Controller {
	...
	public function index(){
		...
		$data['indicator']  = ($this -> input -> post('indicator'))?$this -> input -> post('indicator'):'55';
		$data['vacc_ind']  = $vacc_ind = ($this -> input -> post('vacc_ind'))?$this -> input -> post('vacc_ind'):'cr_r1_f6';
		$queryData = $data;
