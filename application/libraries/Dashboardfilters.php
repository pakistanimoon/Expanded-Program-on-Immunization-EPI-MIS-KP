 ...
 * @co-author 	Engineer Uzair Khalid Baloch
 * @copyright 	Copyright (c) 2018, Pace Technologies
 * @link		
 */
class Dashboardfilters {
	
	/**
	 * Dashboardfilters stack
	 *
     */
	...
	function extraNeededFilters($extraNeededFilters){
		...
		//edited by raja imran 2018-09-18
	 ...
	 * @return	void
	 */		
	function filterRowCreation($title=NULL, $for=NULL, $attr=NULL, $opt=NULL, $type=NULL, $classes=NULL){
		$this->outputHtml .=	'<div class="form-group '.$classes.'">';
		if($type == "dropdown"){
	...
	function filtersHeader($path,$title){
		return '<div class="filterbarwraper">
					<div id="mySidenavR" class="sidenavR">
						<a href="javascript:void(0)" class="closebtn" title="Filters" onclick="closeNavR()">×</a>
						<div class="filter_formwrp">
							<h2> '.$title.' </h2>
							<form method="post" name="theForm" id="filter-form" class="form-horizontal form-bordered" action="'.$path.'">';
	}
	...
	function filtersFooter($advanceReport="No"){
			$toReturn = '</div>
				...
				<div class="container-fluid">
					<span class="tooglebtnfilter"  onclick="openNavR()"><img src="'.base_url().'includes/images1/filericon.png"></span>
				</div>
			</div>';
		return $toReturn;
	}
...
// END Dashboardfilters Class

/* End of file Dashboardfilters.php */
/* Location: ./application/libraries/Dashboardfilters.php */
