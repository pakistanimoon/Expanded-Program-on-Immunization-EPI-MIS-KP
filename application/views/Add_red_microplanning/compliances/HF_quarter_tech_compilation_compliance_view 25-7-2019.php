	...
	<div class="container bodycontainer">
				<div class="row">
					...
					<div class="col-xs-12" style="margin-top: -12px;text-align:center">
						<h5 style="text-align: center"><?php echo 'District Name: '.get_District_Name($data['data'][0]['distcode']).''; ?></h5>
					</div>
					<div class="col-xs-12" style="margin-top: -12px;text-align:center">
						<h5 style="text-align: center"><?php echo 'Union Council Name: '.get_UC_Name($data['data'][0]['uncode']).''; ?></h5>
					</div>
					<div class="col-xs-12" style="margin-top: -12px;text-align:center">
						<h5 style="text-align: center"><?php echo 'Technician Name: '.$data['data'][0]['technicianname'].''; ?></h5>
					</div>
					<div class="col-xs-12" style="margin-top: -12px;text-align:center">
						<h5 style="text-align: center"><?php echo 'year: '.($moonyear=$data['data'][0]['year']).''; ?></h5>
					</div>
					<div class="col-xs-12" style="margin-top: -12px;text-align:center">
						<h5 style="text-align: center"><?php echo 'Quarter: '.$data['data'][0]['quarter'].''; ?></h5>
					</div>
		...
		<div id="parent" style="overflow:auto">
			...
			<table id="fixTable" class="table">
				<thead>
						...
						echo '<th colspan="2">'.implode('</th><th colspan="2">',$monthsofqtr[$data['data'][0]['quarter']]).'</th>';
						echo '</tr><tr>';
								for($i=1; $i<=3; $i++) {
				...
				for($i=1;$i<32;$i++){
					...
					echo "<tr><td style='left: 0px;background: #008D4C !important;color: white;font-size: 16px;'>Day $i</td>";
					///////////////////////////////////////////////
