						...
						<table class="table table-bordered plan_table" >
							...
							<tbody>
								...
								<tr>
									...
									<td><textarea  id="abc" name="problems_r<?php echo $index; ?>_c1" class="form-control" rows="3" cols="5" ></textarea></td>
									<td><textarea  id="abc" name="actlimitres_r<?php echo $index; ?>_c2" class="form-control" rows="3" cols="5"></textarea></td>
									<td><textarea  id="abc" name="actneedresources_r<?php echo $index; ?>_c3" class="form-control" rows="3" cols="5"></textarea></td>
									<td><input type="text"  id="abc" name="date_r<?php echo $index; ?>_c4" class="form-control text-center calendar" readonly ></td>
									<td><textarea  id="abc" name="area_r<?php echo $index; ?>_c5" class="form-control" required rows="3" cols="5"></textarea></td>
									<td><textarea  id="abc" name="person_r<?php echo $index; ?>_c6" class="form-control" rows="3" cols="5"></textarea></td>
								</tr>								
								<?php } ?>
							</tbody>							
						</table>
