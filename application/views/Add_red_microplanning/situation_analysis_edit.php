						...
						<table class="table table-bordered plan_table">
							...
							<tbody id="trRow">
								...
								<tr>	
									...
									<label class="srno-lbl" name="lb[1]" >1</label></td>
									<td>
									<select class="form-control village "  id="village" name="area_name[1]" required="required" class="form-control areaName" >
												<?php echo get_Village_Name($val['area_name']); ?> 
												<!--<option value="<?php// if ($data != 'undefined'){ echo get_Village_Name($val['area_name']);}else { echo '';} ?>" > </option>-->
												<?php //echo getFacilities_options(false);  ?>
											</select>
											<!--<input type="text" name="area_name[1]" class="form-control areaName" required="required">-->
									</td>
									
									<td>
									<input type="text" readonly id="population_less_year[1]"  name="less_one_year[1]" class="form-control text-center numberclass calculation less_one_year">
								...
								<tr>
									...
									<td>
									<select class="form-control village "   id="village" name="area_name[<?php echo $key+1; ?>]" required="required" class="form-control areaName" >
									...
									<td>
									<input type="text" readonly value="<?php echo $val['less_one_year']; ?>" id="population_less_year[1]"  name="less_one_year[<?php echo $key+1; ?>]" class="form-control text-center numberclass calculation less_one_year">
  ...
  $('#trRow').find('tr:last').find('td:last').html('<button type="button" onclick="deleteRow(this)" class="minus"><i class="fa fa-minus-circle" aria-hidden="true"></i></button><button onclick="addRow(this)" id="addButton1" type="button" class="plus" style="background:#057140;"><i class="fa fa-plus-circle" aria-hidden="true"></i></button>');
    ...
    function reindex_serialnumber_and_trainingCompleted(){
		$('#trRow > tr').each(function(i,k){
			...
			$(this).find("td:nth-child(1)").find('input').attr('name','recid['+i+']');
