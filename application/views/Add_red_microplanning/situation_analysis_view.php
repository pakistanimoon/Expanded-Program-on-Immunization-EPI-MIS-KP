				...
				<div class="panel-body" style="padding-top:1px;">
					...
					<div class="row">
						...
						<?php } elseif ($filter_view == 2) {?>
							<a href="<?php echo base_url();?>red_rec_microplan/RedRec_report/redrec_Filters"><button type="button" class="form-btn" id="form_cancel"><i class="fa fa-arrow-left" aria-hidden="true"></i> Back</button></a>
						<?php }else{ ?>
