...
/*		$('#ticode').attr("disabled", false); 
         ...
         $('#myBtn').show();*/ 
		$.ajax({
			url: "<?php echo base_url(); ?>Ajax_red_rec/red_map_edit/"+techniciancode+"/"+year,  
			success: function(result){
				$('#6a').html(result);				
			}
					...
					<div class="tab-content clearfix">
						...
						<div class="row" style="width:100%; padding:4px 17px">
							...
							<input type="hidden" name="uncodeh" id="uncode" value="<?php echo $data[0]['uncode']; ?>" class="form-control">					
							<input type="hidden" name="facodeh" id="facodeh" value="<?php echo $data[0]['facode']; ?>" class="form-control">					
							...
							<div class="col-md-3">
								...
								<select class="form-control" name="ticode" id="ticode" required="required">
									<option value="<?php echo $data[0]['tcode'];?>"><?php echo get_Tehsil_Name($data[0]['tcode']);?></option>
								</select>
							</div>
							<div class="col-md-2">
							...
							<div class="col-md-3">
								<select hidden class="form-control" name="unicode" id="unicode">
									<option value="<?php echo $data[0]['uncode'];?>"><?php echo get_UC_Name($data[0]['uncode']);?></option>
								</select>
							</div>
						...
						<div class="row" style="width:100%; padding:4px 17px">					
							...
							<div class="col-md-3">
								<select class="form-control" name="facode" id="faicode" required="required">
									<option value="<?php echo $data[0]['facode'];?>"><?php echo get_Facility_Name($data[0]['facode']);?></option>
								</select>
							</div>
							<div class="col-md-2">
							...
							<div class="col-md-3">
								<select class="form-control" name="techniciancode" id="technician">
									<?php if($data[0]['year']=='2019' || $data[0]['year']=='2018') { ?>
										<option value="<?php echo $data[0]['techniciancode'];?>"><?php echo get_Technician_Name($data[0]['techniciancode']);?></option>
										<?php }else{ ?>
										<option value="<?php echo $data[0]['techniciancode'];?>"><?php echo get_Hr_Name($data[0]['techniciancode'],'01');?></option>
										<?php } ?>								
								<!--<option value="<?php echo $data[0]['techniciancode'];?>"><?php echo get_Technician_Name($data[0]['techniciancode']);?></option>-->
								</select>
							</div>				
