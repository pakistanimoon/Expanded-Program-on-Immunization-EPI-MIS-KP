		...
		<div class="row">
			<div class="panel panel-primary">
				<div class="panel-heading" style="font-size:17px;"> 
					Planning special activities for hard to reach and problem areas edit <br><span class="urdu" style="font-size:12px; font-weight:400;">پلان برائے مشکل گزار اور دور دراز علاقہ جات</span>
				</div>
				<form>
								...
								<tr>
									...
									<td>
										<select class="form-control text-center htr" name="hard_to_reach[<?php echo $key+1; ?>]" required>
											...
											<option <?php if($val['f2_hard_to_reach'] == 'Yes') { echo 'selected="selected"'; } else { echo ''; } ?> value="Yes">Yes</option>
											<option <?php if($val['f2_hard_to_reach'] == 'No') { echo 'selected="selected"'; } else { echo ''; } ?> value="No">No</option>
										</select>
									</td>
									<td><input type="text" value="<?php if ($data != 'undefined'){ echo $val['f2_reached_last_year']; }else { echo '';} ?>" name="reached_last_year[<?php echo $key+1; ?>]" class="form-control text-center numberclass" required></td>
									<td><input type="text" value="<?php if ($data != 'undefined'){ echo $val['f2_activities_improve_hf']; }else { echo '';} ?>" name="activities_improve_hf[<?php echo $key+1; ?>]" class="form-control "></td>
									<td><input type="text" value="<?php if ($data != 'undefined'){ echo $val['f2_activities_need_support']; }else { echo '';} ?>" name="activities_need_support[<?php echo $key+1; ?>]" class="form-control "></td>
									<td><input type="text" value="<?php if ($data != 'undefined'){ echo $val['f2_interventions_delivered']; }else { echo '';} ?>" name="interventions_delivered[<?php echo $key+1; ?>]" class="form-control "></td>
								</tr>
								<?php } ?>
							</tbody>
						</table>
