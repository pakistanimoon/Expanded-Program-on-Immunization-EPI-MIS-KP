...
$(document).ready(function(){
	...
	$(document).on('click', '.crdview_grphwrp', function (){
		...
		if(dataId){
			var data = {id:dataId,ajax:true,reportType:reportType,month:month,year:year,gender_wise:gender,vaccineBy:vaccineBy,map_id:'livefeedleftmap',bar_id:'bar_graph_1',fmonth:fmonth,biyear:biyear};
		}
		else{
			var data = {ajax:true,reportType:reportType,month:month,year:year,gender_wise:gender,vaccineBy:vaccineBy,map_id:'livefeedleftmap',bar_id:'bar_graph_1',fmonth:fmonth,biyear:biyear};
		}
		//console.log(index);
		$.ajax({
			type: "POST",
