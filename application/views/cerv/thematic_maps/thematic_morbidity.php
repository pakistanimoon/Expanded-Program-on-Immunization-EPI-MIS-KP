					...
					<ul class="row">
						<?php
							...
							*/
							...
							/* $cardFour['heading'] 	= 'Total Deaths';
							$cardFour['image'] 		= "total.png";
							$cardFour['value'] 		= $data['indicators']['alltotal']; // For Percentage Values Send value concatenated with % to be shown in percentage.
							$cardFour['width'] 		= '3'; */
...
<script type="text/javascript">
	...
	/* function eventHandler(e, run, fmonth, casetype){
		if(run){
        	...
        	var url = '<?php echo base_url(); ?>thematic_maps/ThematicMorbidity/onClickUcWiseMapData/'+dataId+'/'+year+'/'+week+'/'+disease+'/'+gender+'/'+casetype;
	...
	function eventHandler(e, run, fmonth){
		...
		var casetype='cases'
		 if(run){
			...
			var url = '<?php echo base_url(); ?>thematic_maps/ThematicMorbidity/onClickUcWiseMapData/'+dataId+'/'+year+'/'+from_week+'/'+to_week+'/'+disease+'/'+gender+'/'+casetype;
			window.open(url, '_blank');
		}else{
