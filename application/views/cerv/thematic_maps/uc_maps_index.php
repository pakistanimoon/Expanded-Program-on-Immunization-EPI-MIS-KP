...
<div class="container bodycontainer">
	...
	<div class="row">
		...
		<div class="col-md-12">
			...
			<div id="pop1" class="simplePopup" style="position: absolute; top: 0px !important; left: 143px;height: 500px;scroll-y: auto;overflow-y:  auto;overflow-x: hidden;"><div class="simplePopupClose">X</div>
...
<div class="container">
	...
	<form class="form-inline" method="post" action="<?php echo base_url(); ?>maps/Maps_Main">
