...
$(document).ready(function(){
	...
	$(document).on('click', '.crdview_grphwrp', function (){
		...
		if(dataId){
			var data = {id:dataId,ajax:true,reportType:reportType,month:month,year:year,quarter:quarter,vaccineId:vaccineId,gender_wise:gender,vaccineBy:vaccineBy,map_id:'livefeedleftmap',bar_id:'bar_graph_1',fmonth:fmonth,biyear:biyear};
		}
		else{
			var data = {ajax:true,reportType:reportType,month:month,year:year,quarter:quarter,vaccineId:vaccineId,gender_wise:gender,vaccineBy:vaccineBy,map_id:'livefeedleftmap',bar_id:'bar_graph_1',fmonth:fmonth,biyear:biyear};
		}
		//console.log(data);
		$.ajax({
			type: "POST",
	...
	function eventHandler(e, run, fmonth){
		...
		var gender = '<?php echo $gender; ?>';
		 if(run){
			var vaccineBy = '<?php echo $vaccineBy; ?>';
			var url = '<?php echo base_url(); ?>thematic_maps/UtilizationOfServices/onClickUcWiseMapData/'+dataId+'/'+reportType+'/'+month+'/'+year+'/'+quarter+'/'+vaccineId+'/'+gender+'/'+vaccineBy+'/'+biyear;
			window.open(url, '_blank');
		}else{
	...
	function getDistrictWiseData(e, fmonth){
		...
		var code="";
		if(dataId.length==3){
			var data = {distcode:dataId,vaccineId:vaccineId,reportType:reportType,month:month,year:year,gender_wise:gender,fmonth:fmonth,quarter:quarter,vaccineBy:vaccineBy,biyear:biyear};
		}
		if(dataId.length==9){
			var data = {uncode:dataId,vaccineId:vaccineId,reportType:reportType,month:month,year:year,gender_wise:gender,fmonth:fmonth,quarter:quarter,vaccineBy:vaccineBy,biyear:biyear};
		}
