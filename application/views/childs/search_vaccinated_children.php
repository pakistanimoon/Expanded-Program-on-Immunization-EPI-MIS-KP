...
<?php } ?>
		<table id="fixTable" class="table table-bordered table-hover table-striped">
			<th class="Heading text-center" style="background: #008d4c; color: white; width: 200px; border: 1px solid black"ead>
				<tr>
			...
			foreach($PVRresult as $key => $val){ ?>
				<tr style="cursor: pointer;">
				   ...
				   <td style='text-align:center; border: 1px solid black;' class='text-center DrillDownRow'>
					...
					<td style='text-align:center; border: 1px solid black;' class='text-center DrillDownRow'color:#FFF;background-color:<?php $doseResult = dueDoses('opv1',$val['date_of_birth']); echo ($val['opv1'] != NULL)?'green':(($doseResult == NULL || ($val['opv2'] != NULL || $val['opv3'] != NULL))?'grey':'red'); ?>"><?php echo ($val['opv1'] != NULL)?date("M d, Y", strtotime($val['opv1'])):(($doseResult == NULL || ($val['opv2'] != NULL || $val['opv3'] != NULL))?'':date("M d, Y", strtotime($doseResult))); ?></td>
					<td style='text-align:center; border: 1px solid black;' class='text-center DrillDownRow'color:#FFF;background-color:<?php $doseResult = dueDoses('opv2',$val['opv1']); echo ($val['opv2'] != NULL)?'green':(($doseResult == NULL || $val['opv3'] != NULL)?'grey':'red'); ?>"><?php echo ($val['opv2'] != NULL)?date("M d, Y", strtotime($val['opv2'])):(($doseResult == NULL || $val['opv3'] != NULL)?'':date("M d, Y", strtotime($doseResult))); ?></td>
					<td style='text-align:center; border: 1px solid black;' class='text-center DrillDownRow'color:#FFF;background-color:<?php $doseResult = dueDoses('opv3',$val['opv2']); echo ($val['opv3'] != NULL)?'green':(($doseResult == NULL)?'grey':'red'); ?>"><?php echo ($val['opv3'] != NULL)?date("M d, Y", strtotime($val['opv3'])):(($doseResult == NULL)?'':date("M d, Y", strtotime($doseResult))); ?></td>
					<td style='text-align:center; border: 1px solid black;' class='text-center DrillDownRow'color:#FFF;background-color:<?php $doseResult = dueDoses('penta1',$val['date_of_birth']); echo ($val['penta1'] != NULL)?'green':(($doseResult == NULL || ($val['penta2'] != NULL || $val['penta3'] != NULL))?'grey':'red'); ?>"><?php echo ($val['penta1'] != NULL)?date("M d, Y", strtotime($val['penta1'])):(($doseResult == NULL || ($val['penta2'] != NULL || $val['penta3'] != NULL))?'':date("M d, Y", strtotime($doseResult))); ?></td>
					<td style='text-align:center; border: 1px solid black;' class='text-center DrillDownRow'color:#FFF;background-color:<?php $doseResult = dueDoses('penta2',$val['penta1']); echo ($val['penta2'] != NULL)?'green':(($doseResult == NULL || $val['penta3'] != NULL)?'grey':'red'); ?>"><?php echo ($val['penta2'] != NULL)?date("M d, Y", strtotime($val['penta2'])):(($doseResult == NULL || $val['penta3'] != NULL)?'':date("M d, Y", strtotime($doseResult))); ?></td>
					<td style='text-align:center; border: 1px solid black;' class='text-center DrillDownRow'color:#FFF;background-color:<?php $doseResult = dueDoses('penta3',$val['penta2']); echo ($val['penta3'] != NULL)?'green':(($doseResult == NULL)?'grey':'red'); ?>"><?php echo ($val['penta3'] != NULL)?date("M d, Y", strtotime($val['penta3'])):(($doseResult == NULL)?'':date("M d, Y", strtotime($doseResult))); ?></td>
					<td style='text-align:center; border: 1px solid black;' class='text-center DrillDownRow'color:#FFF;background-color:<?php $doseResult = dueDoses('pcv1',$val['date_of_birth']); echo ($val['pcv10_1'] != NULL)?'green':(($doseResult == NULL || ($val['pcv10_2'] != NULL && $val['pcv10_3'] != NULL))?'grey':'red'); ?>"><?php echo ($val['pcv10_1'] != NULL)?date("M d, Y", strtotime($val['pcv10_1'])):(($doseResult == NULL || ($val['pcv10_2'] != NULL && $val['pcv10_3'] != NULL))?'':date("M d, Y", strtotime($doseResult))); ?></td>
					<td style='text-align:center; border: 1px solid black;' class='text-center DrillDownRow'color:#FFF;background-color:<?php $doseResult = dueDoses('pcv2',$val['pcv10_1']); echo ($val['pcv10_2'] != NULL)?'green':(($doseResult == NULL || $val['pcv10_3'] != NULL)?'grey':'red'); ?>"><?php echo ($val['pcv10_2'] != NULL)?date("M d, Y", strtotime($val['pcv10_2'])):(($doseResult == NULL || $val['pcv10_3'] != NULL)?'':date("M d, Y", strtotime($doseResult))); ?></td>
					<td style='text-align:center; border: 1px solid black;' class='text-center DrillDownRow'color:#FFF;background-color:<?php $doseResult = dueDoses('pcv3',$val['pcv10_2']); echo ($val['pcv10_3'] != NULL)?'green':(($doseResult == NULL)?'grey':'red'); ?>"><?php echo ($val['pcv10_3'] != NULL)?date("M d, Y", strtotime($val['pcv10_3'])):(($doseResult == NULL)?'':date("M d, Y", strtotime($doseResult))); ?></td>
					<td style='text-align:center; border: 1px solid black;' class='text-center DrillDownRow'color:#FFF;background-color:<?php $doseResult = dueDoses('ipv',$val['date_of_birth']); echo ($val['ipv'] != NULL)?'green':(($doseResult == NULL)?'grey':'red'); ?>"><?php echo ($val['ipv'] != NULL)?date("M d, Y", strtotime($val['ipv'])):(($doseResult == NULL)?'':date("M d, Y", strtotime($doseResult))); ?></td>
					<td style='text-align:center; border: 1px solid black;' class='text-center DrillDownRow'color:#FFF;background-color:<?php $doseResult = dueDoses('rota1',$val['date_of_birth']); echo ($val['rota1'] != NULL)?'green':(($doseResult == NULL || $val['rota2'] != NULL)?'grey':'red'); ?>"><?php echo ($val['rota1'] != NULL)?date("M d, Y", strtotime($val['rota1'])):(($doseResult == NULL || $val['rota2'] != NULL)?'':date("M d, Y", strtotime($doseResult))); ?></td>
					<td style='text-align:center; border: 1px solid black;' class='text-center DrillDownRow'color:#FFF;background-color:<?php $doseResult = dueDoses('rota2',$val['rota1']); echo ($val['rota2'] != NULL)?'green':(($doseResult == NULL)?'grey':'red'); ?>"><?php echo ($val['rota2'] != NULL)?date("M d, Y", strtotime($val['rota2'])):(($doseResult == NULL)?'':date("M d, Y", strtotime($doseResult))); ?></td>
					<td style='text-align:center; border: 1px solid black;' class='text-center DrillDownRow'color:#FFF;background-color:<?php $doseResult = dueDoses('measles1',$val['date_of_birth']); echo ($val['measles1'] != NULL)?'green':(($doseResult == NULL || $val['measles2'] != NULL)?'grey':'red'); ?>"><?php echo ($val['measles1'] != NULL)?date("M d, Y", strtotime($val['measles1'])):(($doseResult == NULL || $val['measles2'] != NULL)?'':date("M d, Y", strtotime($doseResult))); ?></td>
					<td style='text-align:center; border: 1px solid black;' class='text-center DrillDownRow'color:#FFF;background-color:<?php $doseResult = dueDoses('measles2',$val['date_of_birth']); echo ($val['measles2'] != NULL)?'green':(($doseResult == NULL)?'grey':'red'); ?>"><?php echo ($val['measles2'] != NULL)?date("M d, Y", strtotime($val['measles2'])):(($doseResult == NULL)?'':date("M d, Y", strtotime($doseResult))); ?></td>
					<?php }else{ ?>
					<td style='text-align:center; border: 1px solid black;' class='text-center DrillDownRow'<?php echo ($val['opv1'] != NULL && $val['opv1'] < date('Y-m-d', strtotime($val['date_of_birth']. ' + 43 days')))?'color:#FFF;background-color:red':''; ?>"><?php echo (isset($val['opv1']) && $val['opv1'] != NULL)?date("M d, Y", strtotime($val['opv1'])):''; ?></td>
					<td style='text-align:center; border: 1px solid black;' class='text-center DrillDownRow'<?php echo ($val['opv1'] != NULL && $val['opv2'] != NULL && $val['opv2'] < date('Y-m-d', strtotime($val['opv1']. ' + 29 days')))?'color:#FFF;background-color:red':''; ?>"><?php echo (isset($val['opv2']) && $val['opv2'] != NULL)?date("M d, Y", strtotime($val['opv2'])):''; ?></td>
					<td style='text-align:center; border: 1px solid black;' class='text-center DrillDownRow'<?php echo ($val['opv2'] != NULL && $val['opv3'] != NULL && $val['opv3'] < date('Y-m-d', strtotime($val['opv2']. ' + 29 days')))?'color:#FFF;background-color:red':''; ?>"><?php echo (isset($val['opv3']) && $val['opv3'] != NULL)?date("M d, Y", strtotime($val['opv3'])):''; ?></td>
					<td style='text-align:center; border: 1px solid black;' class='text-center DrillDownRow'<?php echo ($val['penta1'] != NULL && $val['penta1'] < date('Y-m-d', strtotime($val['date_of_birth']. ' + 43 days')))?'color:#FFF;background-color:red':''; ?>"><?php echo (isset($val['penta1']) && $val['penta1'] != NULL)?date("M d, Y", strtotime($val['penta1'])):''; ?></td>
					<td style='text-align:center; border: 1px solid black;' class='text-center DrillDownRow'<?php echo ($val['penta1'] != NULL && $val['penta2'] != NULL && $val['penta2'] < date('Y-m-d', strtotime($val['penta1']. ' + 29 days')))?'color:#FFF;background-color:red':''; ?>"><?php echo (isset($val['penta2']) && $val['penta2'] != NULL)?date("M d, Y", strtotime($val['penta2'])):''; ?></td>
					<td style='text-align:center; border: 1px solid black;' class='text-center DrillDownRow'<?php echo ($val['penta2'] != NULL && $val['penta3'] != NULL && $val['penta3'] < date('Y-m-d', strtotime($val['penta2']. ' + 29 days')))?'color:#FFF;background-color:red':''; ?>"><?php echo (isset($val['penta3']) && $val['penta3'] != NULL)?date("M d, Y", strtotime($val['penta3'])):''; ?></td>
					<td style='text-align:center; border: 1px solid black;' class='text-center DrillDownRow'<?php echo ($val['pcv10_1'] != NULL && $val['pcv10_1'] < date('Y-m-d', strtotime($val['date_of_birth']. ' + 43 days')))?'color:#FFF;background-color:red':''; ?>"><?php echo (isset($val['pcv10_1']) && $val['pcv10_1'] != NULL)?date("M d, Y", strtotime($val['pcv10_1'])):''; ?></td>
					<td style='text-align:center; border: 1px solid black;' class='text-center DrillDownRow'<?php echo ($val['pcv10_1'] != NULL && $val['pcv10_2'] != NULL && $val['pcv10_2'] < date('Y-m-d', strtotime($val['pcv10_1']. ' + 29 days')))?'color:#FFF;background-color:red':''; ?>"><?php echo (isset($val['pcv10_2']) && $val['pcv10_2'] != NULL)?date("M d, Y", strtotime($val['pcv10_2'])):''; ?></td>
					<td style='text-align:center; border: 1px solid black;' class='text-center DrillDownRow'<?php echo ($val['pcv10_2'] != NULL && $val['pcv10_3'] != NULL && $val['pcv10_3'] < date('Y-m-d', strtotime($val['pcv10_2']. ' + 29 days')))?'color:#FFF;background-color:red':''; ?>"><?php echo (isset($val['pcv10_3']) && $val['pcv10_3'] != NULL)?date("M d, Y", strtotime($val['pcv10_3'])):''; ?></td>
					<td style='text-align:center; border: 1px solid black;' class='text-center DrillDownRow'<?php echo ($val['penta2'] != NULL && $val['ipv'] != NULL && $val['ipv'] < date('Y-m-d', strtotime($val['date_of_birth']. ' + 99 days')))?'color:#FFF;background-color:red':''; ?>"><?php echo (isset($val['ipv']) && $val['ipv'] != NULL)?date("M d, Y", strtotime($val['ipv'])):''; ?></td>
					<td style='text-align:center; border: 1px solid black;' class='text-center DrillDownRow'<?php echo ($val['rota1'] != NULL && $val['rota1'] < date('Y-m-d', strtotime($val['date_of_birth']. ' + 43 days')))?'color:#FFF;background-color:red':''; ?>"><?php echo (isset($val['rota1']) && $val['rota1'] != NULL)?date("M d, Y", strtotime($val['rota1'])):''; ?></td>
					<td style='text-align:center; border: 1px solid black;' class='text-center DrillDownRow'<?php echo ($val['rota1'] != NULL && $val['rota2'] != NULL && $val['rota2'] < date('Y-m-d', strtotime($val['rota1']. ' + 29 days')))?'color:#FFF;background-color:red':''; ?>"><?php echo (isset($val['rota2']) && $val['rota2'] != NULL)?date("M d, Y", strtotime($val['rota2'])):''; ?></td>
					<td style='text-align:center; border: 1px solid black;' class='text-center DrillDownRow'<?php echo ($val['measles1'] != NULL && $val['measles1'] < date('Y-m-d', strtotime($val['date_of_birth']. ' +9 month +1 day')))?'color:#FFF;background-color:red':''; ?>"><?php echo (isset($val['measles1']) && $val['measles1'] != NULL)?date("M d, Y", strtotime($val['measles1'])):''; ?></td>
					<td style='text-align:center; border: 1px solid black;' class='text-center DrillDownRow'<?php echo ($val['measles1'] != NULL && $val['measles2'] != NULL && ($val['measles2'] < date('Y-m-d', strtotime($val['date_of_birth']. ' +1 year +3 month +1 day'))) && ($val['measles2'] < date('Y-m-d',strtotime($val['measles1']. ' + 29 days'))))?'color:#FFF;background-color:red':''; ?>"><?php echo (isset($val['measles2']) && $val['measles2'] != NULL)?date("M d, Y", strtotime($val['measles2'])):''; ?></td>
					<?php } ?>
				</tr>
			<?php } ?>
			</tbody>
