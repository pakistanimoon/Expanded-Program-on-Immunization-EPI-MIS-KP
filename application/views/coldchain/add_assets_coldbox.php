...
<div class="container bodycontainer">
  ...
  <div class="tabs" style="border: 1px solid #77e588; margin-bottom: -2px;">
		...
		<ul class="nav nav-pills">
			...
			<li role="presentation" class="active"><a class="assets fa fa-table" data-id="33-Cold Box" href="<?php echo base_url(); ?>Coldchain/coldbox_list/33"><i></i><span class="strong" style="padding-left:5px">Cold Box</span></a></li>
		</ul>
  </div>
  </div>
</div><!---- row ---->
			...
			<tr role="row"> 
			  ...
			  <td>
					<?php if( $row['warehouse_type_id']== 0){?>
						<a href="<?php echo base_url(); ?>Coldchain/coldBoxView/<?php echo $row['id']?>" class="btn view-btn"><i class="fa fa-eye" aria-hidden="true" data-toggle="tooltip" title="View"></i></a>
						<a href="<?php echo base_url(); ?>Coldchain/coldBoxEdit/<?php echo $row['id']?>" class="btn view-btn"><i class="fa fa-pencil" aria-hidden="true" data-toggle="tooltip" title="Edit"></i></a> 
