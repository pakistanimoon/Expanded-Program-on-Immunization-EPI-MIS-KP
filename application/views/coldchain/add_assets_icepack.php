...
<div class="container bodycontainer">
  ...
  <div class="tabs" style="border: 1px solid #77e588; margin-bottom: -2px;">
		...
		<ul class="nav nav-pills">
			...
			<li role="presentation" class="active"><a class="assets fa fa-table" data-id="27-Ice Pack" href="<?php echo base_url(); ?>Coldchain/icepack_add/27"><i></i><span class="strong" style="padding-left:5px">Ice Pack</span></a></li>
	...
	<?php if($this->session->UserLevel == '3' && $this->session->utype == "DEO" )
		...
		<div class="row" > 
			...
			<div class="col-md-5 text-right" >
	         <button type="button" id="addNew" class="submit btn-success btn-sm pull-right" style="background:#008d4c;color:white;"><i class="fa fa-plus" aria-live="polite"></i>
		     Add Asset</button>	
			</div>
			<?php }?>
		</div> 
