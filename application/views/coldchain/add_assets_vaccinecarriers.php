...
<div class="container bodycontainer">
  ...
  <div class="tabs" style="border: 1px solid #77e588; margin-bottom: -2px;">
		...
		<ul class="nav nav-pills">
			...
			<li role="presentation" class="active"><a class="assets fa fa-table" data-id="26-Vaccine Carriers" href="<?php echo base_url(); ?>Coldchain/vaccinecarriers_list/26"><i></i><span class="strong" style="padding-left:5px">Vaccine Carriers</span></a></li>
	...
	<?php if($this->session->UserLevel == '3' && $this->session->utype == "DEO" )
		...
		<div class="row" > 
			...
			<a href="<?php echo base_url(); ?>Coldchain/vaccineCarriers_add" data-toggle="tooltip" title=" Add Asset">
			...
			<tr role="row"> 
			  ...
			  <td>
					<?php if( $row['warehouse_type_id']== 0){?>
						<a href="<?php echo base_url(); ?>Coldchain/vaccineCarriersView/<?php echo $row['id']?>" class="btn view-btn"><i class="fa fa-eye" aria-hidden="true" data-toggle="tooltip" title="View"></i></a>
						<a href="<?php echo base_url(); ?>Coldchain/vaccineCarriersEdit/<?php echo $row['id']?>" class="btn view-btn"><i class="fa fa-pencil" aria-hidden="true" data-toggle="tooltip" title="Edit"></i></a> 
