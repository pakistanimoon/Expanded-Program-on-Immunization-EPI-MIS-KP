...
<div class="container bodycontainer">
  ...
  <div class="tabs" style="border: 1px solid #77e588; margin-bottom: -2px;">
		...
		<ul class="nav nav-pills">
			...
			<li role="presentation" class="active"><a class="assets fa fa-table" data-id="23-Voltage Regulator" href="<?php echo base_url(); ?>Coldchain/voltageregulator_list/23"><i></i><span class="strong" style="padding-left:5px">Voltage Regulator</span></a></li>
			<li role="presentation" ><a class="assets fa fa-table" data-id="24-Generator" href="<?php echo base_url(); ?>Coldchain/generator_list/24"><i></i><span class="strong" style="padding-left:5px">Generator</span></a></li>
	...
	<?php if($this->session->UserLevel == '3' && $this->session->utype == "DEO" )
		...
		<div class="row" > 
			...
			<a href="<?php echo base_url(); ?>Coldchain/voltageregulator_add" data-toggle="tooltip" title=" Add Asset">
			...
			<tr role="row"> 
			  ...
			  <td>
						<?php if( $row['warehouse_type_id']== 0){?>
							<a href="<?php echo base_url(); ?>Coldchain/voltageRegulatorView/<?php echo $row['id']?>" class="btn view-btn"><i class="fa fa-eye" aria-hidden="true" data-toggle="tooltip" title="View"></i></a>
							<a href="<?php echo base_url(); ?>Coldchain/voltageRegulatorEdit/<?php echo $row['id']?>" class="btn view-btn"><i class="fa fa-pencil" aria-hidden="true" data-toggle="tooltip" title="Edit"></i></a> 
