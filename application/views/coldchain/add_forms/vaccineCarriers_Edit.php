...
<div class="panel panel-primary">
  <div class="panel-heading">Edit Vaccine Carriers</div>
	<div class="panel-body">
				<!-- main form start-->
				<div class="row add_refrigerator inside-page">
					<div class="col-md-12">
						<form method="post" action="<?php echo base_url() ?>/Coldchain/vaccineCarriersUpdate" onsubmit="return checkRequired();" enctype="multipart/form-data">
						...
						<div class="row">
							...
							<div class="col-md-4"> 
								<div class="form-group">
									...
									<input type="text" id="quantity" value="<?php echo $data['quantity'];?>" name="quantity" class="form-control numberclass" required>
								</div>
							</div>
							<div class="col-md-4">
							<div class="form-group">
