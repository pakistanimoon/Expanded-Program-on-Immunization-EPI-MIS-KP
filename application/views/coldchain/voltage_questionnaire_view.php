        ...
        <table class="table table-bordered   table-striped table-hover  2 mytable3">
          ...
          <tbody>
            <tr>
              ...
              <td><?php if(isset($a)){ echo $a['catalogue_id'];} ?></td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td><?php if(isset($a)){ echo $a['quantity_present'];} ?></td>
              <td><label>11. Quantity not working</label></td>
              <td><?php if(isset($a)){ echo $a['quantity_not_working'];} ?></td>
            </tr>                       
          </tbody>
        </table>
...
<?php if (($_SESSION['UserLevel']=='3') && ($_SESSION['utype']=='DEO') ){?>                                             
			 <a href="<?php echo base_url(); ?>Voltage-Questionnaire/Edit/<?php echo $a['id']?>" style="background:#008d4c none repeat scroll 0% 0%;" class="btn btn-primary btn-md" href="#"><i class="fa fa-pencil-square-o"></i> Update </a>
<?php } ?>           
		   <a href="<?php echo base_url(); ?>Voltage-Questionnaire/List" style="background:#008d4c none repeat scroll 0% 0%;" class="btn btn-primary btn-md"><i class="fa fa-arrow-left"></i> Back </a>
            </div>
        </div>
