...
foreach($cr_items as $key=>$singleVacc){
	...
	<tr class="onebatch">
		...
		<td>
			<!--Used Vials-->
			<input class="form-control numberclass usedinv" name="product[<?php echo $singleVacc["itemid"]; ?>][<?php echo $batch; ?>][usedvials]" type="text" <?php /* echo ($singleVacc["in_doses"])?'disabled="disabled"':''; */ ?> value="<?php echo ($singleVacc["used_vials"])?$singleVacc["used_vials"]:''; ?>" disabled="disabled">
		</td>
		<td>
			<!--Used Doses-->
			<input class="form-control numberclass usedind" name="product[<?php echo $singleVacc["itemid"]; ?>][<?php echo $batch; ?>][useddoses]" type="text" <?php /* echo ($singleVacc["in_doses"])?'':'disabled="disabled"'; */ ?> value="<?php echo ($singleVacc["used_doses"])?$singleVacc["used_doses"]:''; ?>" disabled="disabled">
		</td>
		<td>
			<!--Unused Vials-->
			<input class="form-control numberclass unusedinv" name="product[<?php echo $singleVacc["itemid"]; ?>][<?php echo $batch; ?>][unusedvials]" type="text" <?php /* echo ($singleVacc["in_doses"])?'disabled="disabled"':''; */ ?> value="<?php echo ($singleVacc["unused_vials"])?$singleVacc["unused_vials"]:''; ?>" disabled="disabled">
		</td>
		<td>
			<!--Unused Doses-->
			<input class="form-control numberclass unusedind" name="product[<?php echo $singleVacc["itemid"]; ?>][<?php echo $batch; ?>][unuseddoses]" type="text" <?php /* echo ($singleVacc["in_doses"])?'':'disabled="disabled"'; */ ?> value="<?php echo ($singleVacc["unused_doses"])?$singleVacc["unused_doses"]:''; ?>" disabled="disabled">
		</td>
		<td>
			<!--Adjustment-->
