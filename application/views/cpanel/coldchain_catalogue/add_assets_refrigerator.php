...
<div class="container bodycontainer">
  ...
  <div class="tabs" style="border: 1px solid #77e588; margin-bottom: -2px;">
		...
		<ul class="nav nav-pills">
			<li role="presentation" class="active"><a class="assets fa fa-table" data-id="1-Refrigerator" href="<?php echo base_url(); ?>Coldchain/Catalogue_Refrigerator_List/1"><i></i><span class="strong" style="padding-left:5px">Refrigerator</span></a></li>
			...
			<li role="presentation"	><a class="assets fa fa-table" data-id="33-Cold Box" href="<?php echo base_url(); ?>Coldchain/Catalogue_Coldbox_List/33"><i></i><span class="strong" style="padding-left:5px">Cold Box</span></a></li>
		</ul>
  </div>
  </div>
</div><!---- row ---->
	<div id="deorowhide">
		<div class="row" > 
			...
			<a href="<?php echo base_url(); ?>Coldchain/Catalogue_refrigeratorAdd" data-toggle="tooltip" title="Add Catalogues">
	  ...
	  <tbody id="tbody" style="text-align:center;"> 
		...
		?>
			<tr role="row"> 
			  ...
			  <td>
				<a href="<?php echo base_url(); ?>Coldchain/Catalogue_refrigeratorEdit/<?php echo $row['pk_id']?>" class="btn view-btn"><i class="fa fa-pencil" aria-hidden="true" data-toggle="tooltip" title="Edit"></i></a> 
				<label class="switch">
