...
<div class="container bodycontainer">
  ...
  <div class="tabs" style="border: 1px solid #77e588; margin-bottom: -2px;">
		...
		<ul class="nav nav-pills">
			...
			<li role="presentation" class="active"><a class="assets fa fa-table" data-id="25-Transport" href="<?php echo base_url(); ?>Coldchain/Catalogue_Transport_List/25"><i></i><span class="strong" style="padding-left:5px">Transport</span></a></li>
	...
	<div id="deorowhide">
		<div class="row" > 
			...
			<a href="<?php echo base_url(); ?>Coldchain/Catalogue_transportAdd" data-toggle="tooltip" title="Add Catalogues">
	  ...
	  <tbody id="tbody" style="text-align:center;"> 
		...
		?>
			<tr role="row"> 
			  ...
			  <td>
				<a href="<?php echo base_url(); ?>Coldchain/Catalogue_transportEdit/<?php echo $row['pk_id']?>" class="btn view-btn"><i class="fa fa-pencil" aria-hidden="true" data-toggle="tooltip" title="Edit"></i></a> 
				<label class="switch">
