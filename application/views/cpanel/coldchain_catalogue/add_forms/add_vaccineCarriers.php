...
<div class="panel panel-primary cst-label">
  <div class="panel-heading">Add Vaccine Carriers Catalogues</div>
	<div class="panel-body">
		<!-- main form start-->
		<div class="add_refrigerator inside-page">
			<form method="post" action="<?php echo base_url() ?>/Coldchain/Catalogue_vaccinecarriersSave" onsubmit="return checkRequired();" enctype="multipart/form-data">
							...
							<div class="row">
								<div class="col-md-3">
									<div class="form-group">
										...
										<input type="hidden" id="sub_asset_type_id" name="ccm_sub_asset_type_id" value="26" class="form-control" />                                                        
									</div> 
								</div>
								<div class="col-md-3">
									<div class="form-group">
