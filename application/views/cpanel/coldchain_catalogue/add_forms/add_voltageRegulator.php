<div class="panel panel-primary cst-label">
  <div class="panel-heading">New/Add Voltage Regulator Catalogues</div>
					...
					<div class="row">
						<div class="col-md-4">
							<div class="form-group">
								...
								<input type="text" id="catalogue_id_popup" name="catalogue_id" class="form-control" required />
							</div>
						</div>
						<div class="col-md-4">
							<div class="form-group">
					...
					<div class="row">
						<div class="col-md-4">
							<div class="form-group">
								...
								<input type="text" id="nominal_voltage" name="nominal_voltage" class="form-control numberclass nominal" placeholder="" required>
							</div>
						</div>
						<div class="col-md-4">
							<div class="form-group">
								<label>Continous Power(watts) </label>
								<input type="text" id="continous_power" name="continous_power" class="form-control numberclass continous" required>
							</div>
						</div>
						<div class="col-md-4">
							<div class="form-group">
								<label>Frequency(Hz)</label>
								<input type="text" id="frequency" name="frequency" class="form-control frequency" required>
							</div>
						</div>
					</div><!--- row --->
					<div class="row">
						<div class="col-md-4">
							<div class="form-group">
								...
								<input type="text" id="product_price" name="product_price" class="form-control numberclass" placeholder="" required>
							</div>
						</div>
						...
						<div class="col-md-4">
							<div class="form-group">
								...
								<input type="text" id="input_voltage_range" name="input_voltage_range" class="form-control" required>
							</div>
						</div>
						<div class="col-md-4">
							<div class="form-group">
								<label>Output&nbsp;Voltage&nbsp;Range&nbsp;(vAC)</label>
								<input type="text" id="output_voltage_range" name="output_voltage_range" class="form-control" required>
							</div>
						</div>
					</div><!--- row --->
					<div class="row">
