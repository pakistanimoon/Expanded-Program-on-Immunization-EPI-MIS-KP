<div class="panel panel-primary cst-label">
  <div class="panel-heading">Generator Catalogues Edit Form</div>
	  <div class="panel-body">
		<form action="<?php echo base_url()?>Coldchain/Catalogue_generatorUpdate" method="post" onsubmit="return checkRequired();" enctype="multipart/form-data">
					...
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
								...
								<input type="text" id="ccm_make_popup" value="<?php echo $data['make_name'];?>" name="make_name" class="form-control" required />
							</div>
						</div>
						<div class="col-md-6">
							<div class="form-group">
								<label>Model<span style="color:red;">*</span></label>
								<input type="text" id="ccm_model_popup" value="<?php echo $data['model_name'];?>" name="model_name" class="form-control" required />
							</div>
						</div>
					</div> <!--- row --->
