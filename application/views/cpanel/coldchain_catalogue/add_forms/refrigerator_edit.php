...
<div class="panel panel-primary">
  <div class="panel-heading">Refrigerator/Freezer/ILR Catalogues Edit Form</div>
	<div class="panel-body">
		<form action="<?php echo base_url()?>Coldchain/Catalogue_refrigeratorUpdate" onsubmit="return checkRequired();" method="post" enctype="multipart/form-data">
			<div class="row" style="margin-bottom:10px">
				<div class="modal-body">
							...
							<div class="row">	
								...
								<div class="col-md-6">	
									<div class="controls cfc_radio">
										<label><input name="is_pqs" id="is_pis_pqs-1" value="1"  <?php echo ($data['is_pqs']== 1) ?  "checked" : "" ;  ?> type="radio"><span class="radio-opt">Yes</span></label><label><input name="is_pqs" id="is_pis_pqs-0" value="0"  <?php echo ($data['is_pqs']== 0) ?  "checked" : "" ;  ?> type="radio"><span class="radio-opt">No</span></label>                                
									</div>
								</div>	
							</div>	
						</div>	
					...
					<div class="form-group row">
						<div class="col-md-3"><input name="asset_dimension_length" id="asset_dimension_length_popup" value="<?php echo $data['asset_dimension_length'];?>" class="form-control numberclass dimension" placeholder="Length" readonly="" type="text">      </div>                              
						<div class="col-md-3"><input name="asset_dimension_width" id="asset_dimension_width_popup" value="<?php echo $data['asset_dimension_width'];?>" class="form-control numberclass dimension" placeholder="Width" readonly="" type="text">   </div>                                 
						<div class="col-md-3"><input name="asset_dimension_height" id="asset_dimension_height_popup" value="<?php echo $data['asset_dimension_height'];?>" class="form-control numberclass dimension" placeholder="Height" readonly="" type="text"></div>                                
					</div>
					<div class="row radio-row">
						<div class="col-md-12">
					...
					<br>
					<div class="form-group row">
						<div class="col-md-3">	<input name="gross_capacity_4" id="gross_capacity_4_popup" value="<?php echo $data['gross_capacity_4'];?>" class="form-control numberclass capacity" placeholder="Gross +2 to +8" readonly="" type="text">          </div>                          
						<div class="col-md-3">	<input name="gross_capacity_20" id="gross_capacity_20_popup" value="<?php echo $data['gross_capacity_20'];?>" class="form-control numberclass capacity" placeholder="Gross 15 to 20" readonly="" type="text">  </div>                                  
						<div class="col-md-3">	<input name="net_capacity_4" id="net_capacity_4_popup" value="<?php echo $data['net_capacity_4'];?>" class="form-control numberclass capacity" placeholder="Net +2 to +8" readonly="" type="text">    </div>                                
						<div class="col-md-3">	<input name="net_capacity_20" id="net_capacity_20_popup" value="<?php echo $data['net_capacity_20'];?>" class="form-control numberclass capacity" placeholder="Net 15 to 20" readonly="" type="text">  </div>                              
					</div>
					...
					<div class="row radio-row">		
						<div class="col-md-6">
							<div class="row">
								...
								<div class="col-md-6">
									<div class="controls cfc_radio">
										<label><input name="cfc_free" id="cfc_free-2" value="2" <?php echo ($data['cfc_free']== 2) ?  "checked" : "" ;  ?> type="radio"><span class="radio-opt">NA</span></label><label><input name="cfc_free" id="cfc_free-1" value="1" <?php echo ($data['cfc_free']== 1) ?  "checked" : "" ;  ?> type="radio"><span class="radio-opt">Yes</span></label><label><input name="cfc_free" id="cfc_free-0" value="0" <?php echo ($data['cfc_free']== 0) ?  "checked" : "" ;  ?>  type="radio"><span class="radio-opt">No</span></label>                                
									</div>
								</div>
							</div>
						</div>
					...
					<div class="row" style="margin-top:10px;">
						...
						<div class="col-md-4">
							...
							<div class="controls ">     
								<input name="product_price" id="product_price" value="<?php echo $data['product_price'];?>" class="form-control numberclass" type="text">                                
							</div>
						</div>
						<div class="col-md-4">
