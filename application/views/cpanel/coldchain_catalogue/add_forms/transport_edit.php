<div class="panel panel-primary cst-label">
  <div class="panel-heading">Edit Transport Catalogues</div>
	  <div class="panel-body">
		<form action="<?php echo base_url()?>Coldchain/Catalogue_transportUpdate" method="post" onsubmit="return checkRequired();" enctype="multipart/form-data">
