               ...
               <thead>
                  <tr class="info">
                     ...
                     <th class="text-center Heading">
						<button id="add_button" class="submit custom-add-btn btn-sm" onclick="location.href='<?php echo base_url(); ?>Donors_management/donors_add'">
               ...
               <tbody id="tbody"> 
                  ...
                  <tr id="row" class="DrilledDown">
                     ...
                     <td class="text-center">
                        <a data-original-title="Edit" href="<?php echo base_url(); ?>Donors_management/donors_edit/<?php echo $row['id']; ?>" data-toggle="tooltip" title="" class="btn btn-xs btn-default"><i class="fa fa-pencil"></i></a>
                        <a data-original-title="Delete" href="javascript:void(0);" onclick="javascript:del_item('<?php echo $row['id']; ?>');" data-toggle="tooltip" title="" class="btn btn-xs btn-danger" ><i class="fa fa-times"></i></a>
                     </td>
                  </tr>
                  <?php
                  } ?>                       
...
<script type="text/javascript">
   $(function () {
	...
	function del_item(obj){
		//alert(obj); exit();
		var myurl = '<?php echo base_url(); ?>Donors_management/donors_del/'+obj;		
	   ...
	   var columns = [
			...
			{ data: "id",
				...
				render : function(data, type, row) 
					{				
					 return '<a data-original-title="Edit" href="<?php echo base_url(); ?>Donors_management/donors_edit/'+data+'" data-toggle="tooltip" title="" class="btn btn-xs btn-default"><i class="fa fa-pencil"></i></a> <a data-original-title="Delete" href="javascript:void(0);" onclick="javascript:del_item(\''+data+'\')" data-toggle="tooltip" title="" class="btn btn-xs btn-danger" ><i class="fa fa-times"></i></a>'
					}
			},
		]; 
		var table = $('#itemList').DataTable(
		{
			...
			"ajax": {
				url : "<?php echo base_url(); ?>Ajax_hr_management/donors_list_search",
				type : 'GET'
			},
			"columns": columns,
			dom: 'lrtips',
