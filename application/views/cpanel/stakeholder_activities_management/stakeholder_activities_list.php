   ...
   <div class="row">
      ...
      <div class="panel panel-primary">
         ...
         <div class="panel-body">
            ...
            <br>
            <table class="table table-bordered table-hover table-striped footable table-vcenter" data-filter="#filter" data-filter-text-only="true" id="itemList">
               <thead>
                  <tr class="info">
                     <th class="text-center Heading">S#</th>
                     <th class="text-center Heading">Activity Name</th>
                     <th class="text-center Heading">
						<button id="add_button" class="submit custom-add-btn btn-sm" onclick="location.href='<?php echo base_url(); ?>Stakeholder_activities_management/stakeholder_activities_add'">
               ...
               <tbody id="tbody"> 
                  ...
                  <tr id="row" class="DrilledDown">
                     ...
                     <td class="text-left"><?php echo $row['activity']; ?></td>
                     <td class="text-center">
                        <a data-original-title="Edit" href="<?php echo base_url(); ?>Stakeholder_activities_management/stakeholder_activities_edit/<?php echo $row['pk_id']; ?>" data-toggle="tooltip" title="" class="btn btn-xs btn-default"><i class="fa fa-pencil"></i></a>
...
<script type="text/javascript">
   $(function () {
	...
	function del_item(obj){
		//alert(obj); exit();
		var myurl = '<?php echo base_url(); ?>Stakeholder_activities_management/stakeholder_activities_del/'+obj;		
	   ...
	   var columns = [
			...
			{ data: "pk_id",
				...
				render : function(data, type, row) 
					{				
					 return '<a data-original-title="Edit" href="<?php echo base_url(); ?>Stakeholder_activities_management/stakeholder_activities_edit/'+data+'" data-toggle="tooltip" title="" class="btn btn-xs btn-default"><i class="fa fa-pencil"></i></a> <a data-original-title="Delete" href="javascript:void(0);" onclick="javascript:del_item(\''+data+'\')" data-toggle="tooltip" title="" class="btn btn-xs btn-danger" ><i class="fa fa-times"></i></a>'
					}
			},
		]; 
		var table = $('#itemList').DataTable(
		{
			...
			"ajax": {
				url : "<?php echo base_url(); ?>Ajax_hr_management/stakeholder_activities_list_search",
				type : 'GET'
			},
			"columns": columns,
			dom: 'lrtips',
