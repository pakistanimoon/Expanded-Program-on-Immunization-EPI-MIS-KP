		...
		<div class="row">
			<div class="section-title" style="padding: 0px 6px; line-height:30px;">
				...
				<div class="pull-right">
					<?php if($distcode ==""){ ?>
					<a href="javascript:void(1);" id="equip-info-icp-table" style="color:#000000;font-size: 20px;" title="Tabular View">
...
<script type="text/javascript">
	...
	<?php 	} ?>
		...
		$("#equip-info-icp-table").click(function(){
			equdataTable(wh_type_wise_data,'charts-ice-pack','Store Level','Available Ice Pack','350');
		});
