<div class="container-fluid">
	...
	<div class="row">
		...
		<div class="col-md-6">
			...
			<div id="store-ws-cr-trend">Your desire result will render here....</div>
		</div>
	</div>
	<br>
	<div class="row">
		<div class="col-md-6">
			...
			<div id="district-ws-cr-trend">Your desire result will render here....</div>
		</div>
		<div class="col-md-6">
			<div class="section-title" style="padding: 0px 6px; line-height:30px;">
			...
			<div id="atw-cr-trend">Your desire result will render here....</div>
		</div>
	</div>
	<br>
	<div class="row">
		<div class="col-md-6">
			...
			<div id="store-atw-cr-trend">Your desire result will render here....</div>
		</div>
		<div class="col-md-6">
			<div class="section-title" style="padding: 0px 6px; line-height:30px;">
				<span>Asset Type Wise Cold Room Available</span>
				<div class="pull-right">
					<!--<a href="javascript:void(1);" id="district-atw-cr-pie" style="color:#000000;font-size: 20px;" title="Graphical View (Bar chart)">
						<span class="icon fa fa-pie-chart"></span>
					</a>
					<a href="javascript:void(1);" id="district-atw-cr-bar" style="color:#000000;font-size: 20px;" title="Graphical View (Bar chart)">
						<span class="icon fa fa-bar-chart"></span>
					</a>-->
				</div>
			</div>
			<div id="district-atw-cr-trend">Your desire result will render here....</div>
		</div>
	</div>
</div>
<script type="text/javascript">
	...
	function loadCRWsSection(type='column2d'){
	...
	function loadCRATWSection(type='column2d'){
	...
	$("#store-atw-cr-bar").click(function(){
		atwCountgetData('9','coldroom','Cold Room -20c','store-atw-cr-trend','column2d');
	});
