...
<div class="container bodycontainer">
	<div class="row">
		<div class="panel panel-primary">
			...
			<div class="panel-heading"> List Monthly Vaccination Reports (Health Facility)</div>
				...
				<form method="post" id="filter-form">
					<div class="row">   
						<div class="form-group">
							...
							<div class="col-xs-2">
								<input id="filter" onkeyup="search(this.value);" name="searchParam" class="form-control form-control" type="text"/>
							</div>
							<label class="col-xs-1 control-label lbl-setting"  for = "year" >Year:</label>
							<div class="col-xs-2" >
							  <select id="yearHF" name="year" class="filter-status  form-control">
					...
					<thead>
						<tr>
							...
							<th class="text-center Heading">
								<a href="<?php echo base_url(); ?>HFMVRF/Add" data-toggle="tooltip" title="Add New Facility Monthly Vaccination Report">
						...
						foreach($result as $row){
							...
							<tr>
								...
								<td class="text-center">
									<a href="<?php echo base_url(); ?>HFMVRF/View/<?php echo $row['facode']; ?>/<?php echo $row['fmonth']; ?>" data-toggle="tooltip" title="View" class="btn btn-xs btn-default"><i class="fa fa-search"></i></a>
									<a href="<?php echo base_url(); ?>HFMVRF/Edit/<?php echo $row['facode']; ?>/<?php echo $row['fmonth']; ?>" data-toggle="tooltip" title="Edit" class="btn btn-xs btn-default"><i class="fa fa-pencil"></i></a>
 ...
 function search(term){
	...
	$('.filter-status').on('change' , function (){
        ...
        $.ajax({
			type: "GET",
			data: $('#filter-form').serialize(),
			url: "<?php echo base_url(); ?>Ajax_calls/fmvrf_filter",
			dataType: "json",
			success: function(result){
				console.log(result);
				$('#tbody').html('');
