       ...
       <form class="form-horizontal" method="post" action="<?php echo base_url(); ?>data_entry/form_A1_fed_Save">
        ...
        <table class="table table-bordered   table-striped table-hover  ">
          <tr>
            ...
            <td style="text-align: center;"><label style="margin-top: 7px;">Issued To(Provincial)</label></td> 
            <td><input class="form-control" name="procode"  readonly="readonly" id="procode" placeholder="Provincial" type="text"></td>
				...
				if(count($vacc) > 0){
					...
					<tr>
					 ...
					 <input class="form-control numberclass" name="column_id[]" value="<?php  if(isset($vacc[$m]['id'])){ echo $vacc[$m]['id']; } ?>" type="hidden">
					  ...
					  <td><?php if(isset($vacc[$m]['expirydate'])){ echo $vacc[$m]['expirydate']; } ?></td>
					  <td><?php if(isset($vacc[$m]['unitcost'])){ echo $vacc[$m]['unitcost']; } ?></td>
         ...
         <div class="col-sm-6">
            <table class="table table-bordered table-striped">
              <tr>
                ...
                <td><?php if(isset($main_array)){ echo $main_array['0']['received_by']; } ?></td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td><?php if(isset($main_array)){ echo $main_array['0']['supply_store']; } ?></td>
       ...
       <div class="row">
         <hr>
            <div style="text-align: right;" class="col-md-4 col-md-offset-8">
              ...
              <a style="background: rgb(22, 108, 29) none repeat scroll 0% 0%;" class="btn btn-primary btn-md" href="<?php echo base_url(); ?>Federal-Issue-Receipt/Edit/<?php echo $main_array['0']['id']; ?>"><i class="fa fa-pencil-square-o"></i> Update </a>
