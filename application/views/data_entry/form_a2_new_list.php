...
<div class="row">
    <div class="panel panel-primary">
     ...
     <ol class="breadcrumb">
      ...
      <div class="panel-heading"> List of District Form A-2(Stock Issue & Receipt Voucher) Form
        </div>
            ...
            <thead>
				<tr>
					...
					<th class="text-center Heading">
						<a href="<?php echo base_url(); ?>District-Issue-Receipt/Add" data-toggle="tooltip" title="Add New UC Demand, Consumption & Receipt Form">
...
?>
                           <tr>
                              ...
                              <td class="text-center">                                
                                   <a href="<?php echo base_url(); ?>District-Issue-Receipt/View/<?php echo $row['group_id']; ?>" data-toggle="tooltip" title="View" class="btn btn-xs btn-default"><i class="fa fa-search"></i></a>
                                   <a href="<?php echo base_url(); ?>District-Issue-Receipt/Edit/<?php echo $row['group_id']; ?>" data-toggle="tooltip" title="Edit" class="btn btn-xs btn-default"><i class="fa fa-pencil"></i></a>
                              </td>
                           </tr>
<?php
}
...
<script src="<?php echo base_url(); ?>includes/js/fooTable/footable.filter.js" type="text/javascript"></script>
    ...
    $(document).on("click",".paginateMe",  function (e){
      ...
      $('#tbody').html('<h1><td colspan="10" class="text-center" ><img src="<?php echo base_url(); ?>includes/images/ajax-loader_blue.gif"> loading...</td></h1>');
        ...
        $.ajax({
          ...
          dataType:"json",
          url: "<?php echo base_url(); ?>Ajax_calls/form_a2_filter_new?page="+page,
	...
	$('.filter-status').on('change' , function (){
        ...
        $.ajax({
			type: "GET",
			data: $('#filter-form').serialize(),
			url: "<?php echo base_url(); ?>Ajax_calls/form_a2_filter_new",
			dataType: "json",
			success: function(result){
				console.log(result);
				$('#tbody').html('');
