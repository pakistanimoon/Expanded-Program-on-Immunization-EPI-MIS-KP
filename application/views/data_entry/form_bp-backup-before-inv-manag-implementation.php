						...
						<tbody id="myTable">
							...
							?>
								<tr class="vialused">
									...
									<!--<td>
										<input class="gp form-control numberclass" name="cr_r<?php echo $i; ?>_f7" id="cr_r<?php echo $i; ?>_f7" readonly value="<?php if(isset($formB_Result)){ $name="cr_r".$i."_f7"; if($formB_Result->$name != '0'){ echo $formB_Result->$name; }} ?>" type="text">
									</td>
									<td>
										<input class="form-control numberclass" name="cr_r<?php echo $i; ?>_f8" id="cr_r<?php echo $i; ?>_f8" readonly value="<?php if(isset($formB_Result)){ $name="cr_r".$i."_f8"; if($formB_Result->$name != '0'){ echo $formB_Result->$name; }} ?>" type="text">
									</td>
									<td>
										<input class="form-control numberclass" name="cr_r<?php echo $i; ?>_f9" id="cr_r<?php echo $i; ?>_f9" value="<?php if(isset($formB_Result)){ $name="cr_r".$i."_f9"; if($formB_Result->$name != '0'){ echo $formB_Result->$name; }} ?>" type="text">
									</td>-->
