...
<div class="container bodycontainer">  
	<div class="row">
		<div class="panel panel-primary">
			...
			<div class="panel-heading"><?php if(isset($formB_Result)){?> HF Consumption and Requisition <?php }else{ ?> HF Consumption and Requisition Form  <?php } ?></div>
			<div class="panel-body">
				<form class="form-horizontal" method="post" action="<?php echo base_url(); ?>data_entry/form_B_Save">
								...
								<table style="width: 100%;">
									<tr>
										<td>
											...
											<?php if(isset($formB_Result)){ ?> <option value="<?php echo $month; ?>"><?php echo monthname($month); ?></option> <?php }else{ getAllMonthsOptionsNew(false);/* getAllMonthsOptions(false) */; } ?>
											</select>
										</td>
										<td>
											<select name="year" id="year" class="form-control">
											<?php if(isset($formB_Result)){ ?> <option value="<?php echo $year; ?>"><?php echo $year; ?></option> <?php }else{ /* getAllYearsOptions(false); */getAllYearsOptionsTill2018(false); /* getAllYearsOptionsIncludingCurrent(false); */ } ?>
											</select>
										</td>
									</tr>
								</table>             	
					...
					<table class="table table-bordered table-condensed table-striped table-hover mytable">
						...
						<tbody id="myTable">
							<?php
							foreach($vaccinesDetails as $key=>$value){	
								//get_product_wise_facility_received_quantity_in_month('2018-04',2,'365219');
							?>
								<tr class="vialused">
									<td style="padding-top:11px;"><?php echo $value['item_name']; ?></td>
									<td value="<?php echo sprintf('%02d',$value['number_of_doses']); ?>" class="ob text-center" style="padding-top:11px;<?php if($value['number_of_doses']==1){ echo "background-color:#eee;"; } ?>"> <?php if($value['number_of_doses']!=1){ echo sprintf('%02d',$value['number_of_doses']); } ?></td>
									<td class="ob">
										<input readonly class=" form-control numberclass opbal" name="cr_r<?php echo $value['cr_table_row_numb']; ?>_f1" id="cr_r<?php echo $value['cr_table_row_numb']; ?>_f1" value="<?php if(isset($formB_Result)){ $name="cr_r".$value['cr_table_row_numb']."_f1";  echo $formB_Result->$name; }else{ echo set_value("cr_r".$value['cr_table_row_numb']."_f1");} ?>" type="text"><?php echo form_error("cr_r".$value['cr_table_row_numb']."_f1"); ?>
									</td>
									<td class="ob">
										<input  readonly class=" form-control received_qty" data-productid="<?php echo $value['pk_id']; ?>" name="cr_r<?php echo $value['cr_table_row_numb']; ?>_f2" id="cr_r<?php echo $value['cr_table_row_numb']; ?>_f2" value="<?php if(isset($formB_Result)){ $name="cr_r".$value['cr_table_row_numb']."_f2"; if($formB_Result->$name != '0'){ echo $formB_Result->$name; }}else{ echo set_value("cr_r".$value['cr_table_row_numb']."_f2");} ?>" type="text"><?php echo form_error("cr_r".$value['cr_table_row_numb']."_f2"); ?>
									</td>
									<td class="ob">
										<input class="form-control numberclass" name="cr_r<?php echo $value['cr_table_row_numb']; ?>_f3" id="cr_r<?php echo $value['cr_table_row_numb']; ?>_f3" type="text" <?php if($value=='' && $key!='DIL BCG' && $key!='DIL Measles'){echo 'readonly="readonly"';}else{ ?>value="<?php if(isset($formB_Result)){ $name="cr_r".$value['cr_table_row_numb']."_f3"; if($formB_Result->$name != '0'){ echo $formB_Result->$name; }}else{ echo set_value("cr_r".$value['cr_table_row_numb']."_f3");} ?>"<?php } ?>><?php echo form_error("cr_r".$value['cr_table_row_numb']."_f3"); ?>
									</td>
									<td class="ob test">
										<input class=" form-control numberclass" name="cr_r<?php echo $value['cr_table_row_numb']; ?>_f4" id="cr_r<?php echo $value['cr_table_row_numb']; ?>_f4" value="<?php if(isset($formB_Result)){ $name="cr_r".$value['cr_table_row_numb']."_f4"; if($formB_Result->$name != '0'){ echo $formB_Result->$name; }}else{ echo set_value("cr_r".$value['cr_table_row_numb']."_f4");} ?>" type="text"><?php echo form_error("cr_r".$value['cr_table_row_numb']."_f4"); ?>
									</td>
									<td class="ob">
										<input class=" form-control numberclass" name="cr_r<?php echo $value['cr_table_row_numb']; ?>_f5" id="cr_r<?php echo $value['cr_table_row_numb']; ?>_f5" value="<?php if(isset($formB_Result)){ $name="cr_r".$value['cr_table_row_numb']."_f5"; if($formB_Result->$name != '0'){ echo $formB_Result->$name; }}else{ echo set_value("cr_r".$value['cr_table_row_numb']."_f5");} ?>" type="text"><?php echo form_error("cr_r".$value['cr_table_row_numb']."_f5"); ?>
									</td>
									<td>
										<input class=" form-control numberclass" name="cr_r<?php echo $value['cr_table_row_numb']; ?>_f6" id="cr_r<?php echo $value['cr_table_row_numb']; ?>_f6" readonly  value="<?php if(isset($formB_Result)){ $name="cr_r".$value['cr_table_row_numb']."_f6"; if($formB_Result->$name != '0'){ echo $formB_Result->$name; }}else{ echo set_value("cr_r".$value['cr_table_row_numb']."_f6");} ?>" type="text" ><?php echo form_error("cr_r".$value['cr_table_row_numb']."_f6"); ?>
									</td>									
								</tr>
							<?php
							}
						?>
							<tr class="vialused">
								<td style="padding-top:11px;">OTHER</td>
								<td style="background-color:#eee;"></td>
								<td class="ob">
									<input readonly class=" form-control numberclass opbal" name="cr_r17_f1" id="cr_r17_f1" value="<?php if(isset($formB_Result)){ $name="cr_r17_f1";  echo $formB_Result->$name; }else{ echo set_value("cr_r17_f1");} ?>" type="text"><?php echo form_error("cr_r17_f1"); ?>
								</td>
								<td class="ob">
									<input class=" form-control numberclass" name="cr_r17_f2" id="cr_r17_f2" value="<?php if(isset($formB_Result)){ $name="cr_r17_f2"; if($formB_Result->$name != '0'){ echo $formB_Result->$name; }}else{ echo set_value("cr_r17_f2");} ?>" type="text"><?php echo form_error("cr_r17_f2"); ?>
								</td>
								<td class="ob">
									<input class="form-control numberclass" name="cr_r17_f3" id="cr_r17_f3" type="text" <?php if($value=='' && $key!='DIL BCG' && $key!='DIL Measles'){echo 'readonly="readonly"';}else{ ?>value="<?php if(isset($formB_Result)){ $name="cr_r17_f3"; if($formB_Result->$name != '0'){ echo $formB_Result->$name; }}else{ echo set_value("cr_r17_f3");} ?>"<?php } ?>><?php echo form_error("cr_r17_f3"); ?>
								</td>
								<td class="ob test">
									<input class=" form-control numberclass" name="cr_r17_f4" id="cr_r17_f4" value="<?php if(isset($formB_Result)){ $name="cr_r17_f4"; if($formB_Result->$name != '0'){ echo $formB_Result->$name; }}else{ echo set_value("cr_r17_f4");} ?>" type="text"><?php echo form_error("cr_r17_f4"); ?>
								</td>
								<td class="ob">
									<input class=" form-control numberclass" name="cr_r17_f5" id="cr_r17_f5" value="<?php if(isset($formB_Result)){ $name="cr_r17_f5"; if($formB_Result->$name != '0'){ echo $formB_Result->$name; }}else{ echo set_value("cr_r17_f5");} ?>" type="text"><?php echo form_error("cr_r17_f5"); ?>
								</td>
								<td>
									<input class=" form-control numberclass" name="cr_r17_f6" id="cr_r17_f6" readonly  value="<?php if(isset($formB_Result)){ $name="cr_r17_f6"; if($formB_Result->$name != '0'){ echo $formB_Result->$name; }}else{ echo set_value("cr_r17_f6");} ?>" type="text" ><?php echo form_error("cr_r17_f6"); ?>
								</td>									
							</tr>
						</tbody>
					</table>
...
$(document).ready(function(){
		...
		if(facode!=0){
				...
				success: function(result){
					...
					if(result == 'Yes'){
						if (confirm("Report Already Exists! Do you want to edit it?")==true) {
							...
							window.location.href = "<?php echo base_url(); ?>HF-Consumption-Requisition/Edit/"+year+"-"+month+"/"+facode;
						} else {
			...
			if(facode!=0 && month > 0){
				$('.received_qty').each(function(){
					...
					$.ajax({
						type: "POST",
						data: {month:month,year:year,facode:facode,product_id:product_id},
						async:false,
						url: "<?php echo base_url(); ?>Ajax_calls/getProductReceivedBalanceForTheSelectedMonth",
						success: function(result){
							obj.val(result);
						}
					});
	...
	$(document).on('change','#month', function(){
		...
		//alert(month);
		if(month == '01'){
			$('.opbal').removeAttr('readonly','readonly');
		}
		else if(month != '01'){
			$('.opbal').attr('readonly','readonly');
		}
