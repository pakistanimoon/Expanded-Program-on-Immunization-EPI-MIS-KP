...
<div class="row">
    <div class="panel panel-primary">
     <ol class="breadcrumb">
      ...
      <div class="panel-heading"> List of Monthly Surveillance Reports
        </div>
        ...
        <div class="form-group">
           <label class="col-xs-2 col-xs-offset-1 control-label lbl-setting"  for = "facode" >Center Type:</label>
           <div class="col-xs-3">
 ...
 <?php if($UserLevel == 2 || $UserLevel == 3 ){  ?>
           ...
           <label class="col-xs-2 control-label lbl-setting"  for = "facode" >Center Name:</label>
           <div class="col-xs-3">
...
<table class="table table-bordered table-hover table-striped footable table-vcenter tbl-listing" data-filter="#filter" data-filter-text-only="true">
            <thead>
              <tr>
                ...
                <th class="text-center Heading">Center Code</th>
                <th class="text-center Heading">Center Name</th>
                <th class="text-center Heading">Center Type</th>
                <th class="text-center Heading">Year-Month</th>
                 <th class="text-center Heading">
                  <a href="<?php echo base_url(); ?>Data_entry/msr" data-toggle="tooltip" title="Add New MSR">
...
?>
                           ...
                           <tr>
                              ...
                              <td class="text-center">
                                    ...
                                    <a href="<?php echo base_url(); ?>Data_entry/msr_view/<?php echo $row['facode']; ?>/<?php echo $row['fmonth']; ?>" data-toggle="tooltip" title="View" class="btn btn-xs btn-default"><i class="fa fa-search"></i></a>

                                   <a href="<?php echo base_url(); ?>Data_entry/msr_edit/<?php echo $row['facode']; ?>/<?php echo $row['fmonth']; ?>" data-toggle="tooltip" title="Edit" class="btn btn-xs btn-default"><i class="fa fa-pencil"></i></a>

                                    <a href="<?php echo base_url(); ?>Data_entry/msr_delete/<?php echo $row['facode']; ?>/<?php echo $row['fmonth']; ?>" data-toggle="tooltip" title="Delete" class="btn btn-xs btn-danger"><i class="fa fa-times"></i></a>
    ...
    $(document).on("click",".paginateMe",  function (e){
      ...
      $('#tbody').html('<h1><td colspan="10" class="text-center" ><img src="<?php echo base_url(); ?>includes/images/ajax-loader_blue.gif"> loading...</td></h1>');
        ...
        $.ajax({
          ...
          dataType:"json",
          url: "<?php echo base_url(); ?>Ajax_calls/msr_filter?page="+page,
  ...
  $('.filter-status').on('change' , function (){
    ...
    $('#tbody').html('<h1><td colspan="10" class="text-center" ><img src="<?php echo base_url(); ?>includes/images/ajax-loader_blue.gif"> loading...</td></h1>');
        ...
        $.ajax({
          type: "GET",
          data: $('#filter-form').serialize(),
          url: "<?php echo base_url(); ?>Ajax_calls/msr_filter",
          dataType: "json",
          success: function(result){
            console.log(result);
            $('#tbody').html('');
