...
<div class="row">
    ...
    <div class="panel panel-primary">
     <ol class="breadcrumb">
      ...
      <div class="panel-heading"> List of Monthly Vaccine Consumption & Requisition Form Reports
        </div>
 ...
 <?php if($UserLevel == 2 || $UserLevel == 3 ){  ?>
           ...
           <label class="col-xs-2 col-xs-offset-1 control-label lbl-setting"  for = "facode" >FLCF Name:</label>
           <div class="col-xs-3">
              ...
              <tr>
                ...
                <th class="text-center Heading">Year-Month</th>
                 <th class="text-center Heading">
                  <a href="<?php echo base_url(); ?>Data_entry/vacc_cons_req_add" data-toggle="tooltip" title="Add New Consumption Report">
...
?>
                           ...
                           <tr>
                              ...
                              <td class="text-center">
                                    ...
                                    <a href="<?php echo base_url(); ?>Data_entry/vacc_cons_req_view/<?php echo $row['facode']; ?>/<?php echo $row['fmonth']; ?>" data-toggle="tooltip" title="View" class="btn btn-xs btn-default"><i class="fa fa-search"></i></a>

                                   <a href="<?php echo base_url(); ?>Data_entry/vacc_cons_req_edit/<?php echo $row['facode']; ?>/<?php echo $row['fmonth']; ?>" data-toggle="tooltip" title="Edit" class="btn btn-xs btn-default"><i class="fa fa-pencil"></i></a>
    ...
    $(document).on("click",".paginateMe",  function (e){
      ...
      $('#tbody').html('<h1><td colspan="10" class="text-center" ><img src="<?php echo base_url(); ?>includes/images/ajax-loader_blue.gif"> loading...</td></h1>');
        ...
        $.ajax({
          ...
          dataType:"json",
          url: "<?php echo base_url(); ?>Ajax_calls/vacc_cr_mr_filter?page="+page,
  ...
  $('.filter-status').on('change' , function (){
    ...
    $('#tbody').html('<h1><td colspan="10" class="text-center" ><img src="<?php echo base_url(); ?>includes/images/ajax-loader_blue.gif"> loading...</td></h1>');
        ...
        $.ajax({
          type: "GET",
          data: $('#filter-form').serialize(),
          url: "<?php echo base_url(); ?>Ajax_calls/vacc_cr_mr_filter",
          dataType: "json",
          success: function(result){
            console.log(result);
            $('#tbody').html('');
       ...
       function search(){
        ...
        $.ajax({
			...
			url: "<?php echo base_url(); ?>Ajax_calls/vaccCrFormSearch",
			dataType: "json",
			success: function(result){
				$('#tbody').html('');
				if(result != null){
