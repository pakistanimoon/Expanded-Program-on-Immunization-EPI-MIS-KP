	...
	<div class="container heading-line top-margin">
         ...
         <h3 class="heading-1">Vaccine Manufacturers</h3>
		  ...
		  <div id="demo-1" class="collapse">
			...
			margin-left: 14px;height: 45px;padding-top: 6px;"><span class="bps">Name:</span></div>
				...
				<div class="col-md-4 coll-2" style="border:1px solid lightgray;  height:45px; padding-top:2px"><span class="input-bps"><input id="purpose" class="form-control" name="purpose" type="text" placeholder=""></span></div>
				<div class="col-md-4 coll-3" style="border:1px solid lightgray;  height:45px; padding-top:6px">
					<Button type = "Button" class="btn-background box1" style="margin-left:100px;" id = "save"> <span class="save-1" style="border:none; top:0px;"><i class="fa fa-floppy-o" aria-hidden="true"></i>Save</span></button>
        ...
        <thead>
            <tr>
                ...
                <th style="width:75%;background-color:#008d4c; color:white; text-align:center">Manufacturer Name</th>
		...
		<?php $i=1; ?>
            ...
            <tr>
                ...
                <td><a style="color:#008d4c" href = "<?php echo base_url(); ?>Admin_Configuration/delete_manufacturer/<?php echo $val['id']; ?>" ><i class="fa fa-times" aria-hidden="true"></i></a>
				    <a data-id="<?php echo $val['id']; ?>" style="color:#008d4c" id = "edit" href = "#"  ><i class="fa fa-pencil-square" aria-hidden="true"></i></a></td></td>
				</td>
            </tr>
			<?php $i++; }	?>
        </tbody>
 ...
 $(document).on('click','#save',function(){
		...
		if(purpose=="")
			...
			$.ajax({
				...
				url:"<?php echo base_url(); ?>Admin_Configuration/manufacturer_save",
				success: function(result){
								if(result==1){
									window.location.href = '<?php echo base_url(); ?>Admin_Configuration/manufacturer';
								}else{
    ...
    $.ajax({ 
     ...
     data:"id="+id,
     async:false,
     url: "<?php echo base_url(); ?>Admin_Configuration/edit_manufacturer",
     success: function(result){
		//alert(result);
      $('#idd').val(id);
      $('#purpose').val(result);
