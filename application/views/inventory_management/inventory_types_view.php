	...
	<div class="container heading-line top-margin">
         ...
         <h3 class="heading-1">Vaccine Purpose</h3>
			<button type="button" id = "addNew" style="margin-left:41%;" class="btn btn-primary add-new-1 box" ><i class="fa fa-plus" aria-hidden="true"></i>
             Add New</button>
		     <div id="demo-1" class="collapse">
			 <div class="row" style="position:relative;">
		     <div class="col-md-4 coll-1" style="border: 1px solid lightgray;
			 margin-left: 14px;height: 45px;padding-top: 6px;"><span class="bps">Purpose:</span></div>
			   <input name="idd" id="idd" type="hidden" value="">
			   <div class="col-md-4 coll-2" style="border:1px solid lightgray;  height:45px; padding-top:2px;"><span class="input-bps"><input id="purpose" name="purpose" class="form-control" type="text" placeholder=""></span>
				</div>
				<div class="col-md-4 coll-3" style="border:1px solid lightgray;  height:45px; padding-top:6px">
					<Button type = "Button" class="btn-background box1" style="margin-left:90px;" id = "save"> <span style="border:none; top:0px;" class="save-1"><i class="fa fa-floppy-o" aria-hidden="true"></i> Save</span></button>
        ...
        <thead>
            <tr>
                ...
                <th style="width:75%;background-color:#008d4c; color:white; text-align:center">Purpose</th>
		...
		<?php $i=1; ?>
            ...
            <tr>
                ...
                <td><a style="color:#008d4c" href = "<?php echo base_url(); ?>Admin_Configuration/delete_type/<?php echo $val['id']; ?>" ><i class="fa fa-times" aria-hidden="true"></i></a>
 ...
 $(document).on('click','#save',function(){
		...
		if(purpose=="")
			...
			$.ajax({
				...
				url:"<?php echo base_url(); ?>Admin_Configuration/type_save",
				success: function(result){
								if(result==1){
									window.location.href = '<?php echo base_url(); ?>Admin_Configuration/type_purpose';
								}else{
    ...
    $.ajax({ 
     ...
     data:"id="+id,
     async:false,
     url: "<?php echo base_url(); ?>Admin_Configuration/edit_type",
     success: function(result){
		//alert(result);
      $('#idd').val(id);
      $('#purpose').val(result);
