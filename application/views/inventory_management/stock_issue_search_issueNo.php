...
<center><label>Date: </label><span style="positon:center"><?php echo $searchResult[0]['transaction_date'];?></span><label style="padding-left:15px;">#Dispatch  Voucher : </label><span style="positon:center"><?php echo $issueNo;?></span><label style="positon:center;padding-left:15px">From (Issued By):</label><span style="positon:center;"><?php echo get_store_name(false,$searchResult[0]['from_warehouse_type_id'],$searchResult[0]['from_warehouse_code']);?></span><label style="positon:center;padding-left:15px">To (Received By):</label><span style="positon:center;"><?php echo get_store_name(false,$searchResult[0]['to_warehouse_type_id'],$searchResult[0]['to_warehouse_code']);?></span><label  style="padding-left:15px">Purpose:</label><span style="positon:center;"><?php echo $searchResult[0]['purpose'];?></span></center>
<center>
