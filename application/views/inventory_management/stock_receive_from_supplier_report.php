...
<center><label>Receive Voucher : </label><label style="positon:center"><?php echo "#".$draftdata['master']->transaction_number;?></label></center>
<center>
<table class="table table-bordered table-condensed"  cellpadding="0" border="0" id="table">
						 <tr>
								...
								<th rowspan="2" style="text-align:center;"><label>Placed At </label></th>
