<!-- handle none parameter for Detail Report -->
 ...
 if($groupBy=="none"){
	...
	echo '<center><label style="padding:5px">Stock Receive Detail</label></center>';
	 }
 ?>
	<table class="table table-bordered table-condensed mytable3" border ="1" id="table">
						...
						<tr>
								...
								<th  rowspan="2" style="text-align:center;"><label>Receive No.</label></th>
								<th  rowspan="2" style="text-align:center;"><label>Received From</label></th>
...
<center><label style="padding:5px"><?php echo $groupBy."	Wise Stock Receive Detail";?></label></center>
<center>
<?php	
	...
	foreach($uniqueProd as $k=>$val)
	{
		...
		echo '<th rowspan="2">Receive No</th>';
