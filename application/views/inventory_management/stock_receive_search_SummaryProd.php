...
<center><label style="padding:5px"><?php echo $summaryType."	Wise Stock Receive Summary";?></label><label style="padding:5px">Date From  : </label><label style="padding:5px"><?php echo $date_from;?></label><label style="padding:5px">Date To  : </label><label style="padding:5px"><?php echo $date_to;?></label></center>
<center>
<?php	
	...
	foreach($uniqueProd as $k=>$val)
	{
		...
		{
			echo '<th rowspan="2">Receive From</th>';
		}
		...
		echo '<th style="text-align:center" rowspan="2">Store Location</th>';		
