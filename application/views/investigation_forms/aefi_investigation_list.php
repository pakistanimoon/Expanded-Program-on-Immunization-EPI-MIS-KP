...
<div class="row">
    <div class="panel panel-primary">
     ...
     <ol class="breadcrumb">
      ...
      <div class="panel-heading"> List of AEFI Investigation Form
        </div>
...
<table class="table table-bordered table-hover table-striped footable table-vcenter tbl-listing" data-filter="#filter" data-filter-text-only="true">
            <thead>
              <tr>
                ...
                <th class="text-center Heading">Date of Investigation Started</th>
                <th class="text-center Heading">Vaccinated By</th>
				 <th class="text-center Heading">Form Status</th>
                <th class="text-center Heading">
                  <a href="<?php echo base_url(); ?>AEFI-CIF/Add" data-toggle="tooltip" title="Add New AEFI Investigation Form">
...
?>
                           ...
                           <tr>
                              ...
                              <td class="text-center"><?php echo $row['child_name']; ?></td>
                              
                              <td class="text-center"><?php echo $row['case_epi_no']; ?></td>

                              <td class="text-center"><?php echo $row['date_investigation_started']; ?></td> 

                              <td class="text-center"><?php echo $row['vaccinated_by']; ?></td>
