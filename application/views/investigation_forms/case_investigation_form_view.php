...
<div class="row">
 ...
 <?php if($this -> session -> flashdata('message')){  ?><div class="alert alert-danger text-center " role="alert"><strong><?php echo $this -> session -> flashdata('message'); ?></strong></div> <?php } ?>
   <div class="panel-heading"> Case Investigation Form View</div>
     <div class="panel-body">
       <form class="form-horizontal" method="post" onsubmit="return confirm('Do you really want to Approve this cross notified case?')" action="<?php echo base_url(); ?>Case_investigation/caseInvestigation_Approve">
     ...
     <input type="hidden" name="cross_case_id" value="<?php echo $a-> cross_case_id; ?>" />
      ...
      <tr>
        ...
        <tbody>
            <tr>              
              ...
              <td><?php if(isset($a) && $a -> clinical_representation != "" && $a -> clinical_representation != NULL){ echo $a -> symptoms;} ?></td>
            </tr>
            <tr>
           ...
           <td><?php if(isset($a)){ echo $a -> type_specimen;} ?></td>           
         </tr>
         <tr> 
      ...
      <div class="row">
        ...
        <a href="<?php echo base_url(); ?>Case_investigation/case_investigation_edit/<?php echo $a->id; ?>/<?php echo $a->year; ?>" style="background:#008d4c none repeat scroll 0% 0%;" class="btn btn-primary btn-md" ><i class="fa fa-pencil-square-o"></i> Update </a>
