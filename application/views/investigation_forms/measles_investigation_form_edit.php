...
<?php 
	...
	//$specimenArray = array();
	//echo $measles_Result->id; exit();
	$specimenArray = $measles_Result->type_specimen; 
	$specimenArray = explode(',', $specimenArray);
	$specimenArray = array_flip($specimenArray);
	//print_r(array_flip($specimenArray)); exit();
							...
							<!-- <tr>
								...
								<td>
									<select id="rb_tcode" name="rb_tcode" class="form-control">
										<?php if(isset($measles_Result) && $measles_Result -> rb_tcode != ""){ ?>
										<option value="<?php echo $measles_Result -> rb_tcode; ?>"><?php echo getCrossProvince_TehsilOptions(false,$measles_Result -> rb_tcode); ?></option>
										<?php }else{ ?> 
										<?php getCrossProvince_TehsilOptions(false); } ?>
									</select>
								</td>
								...
								<td>
									<select id="rb_uncode" name="rb_uncode" class="form-control">
										<?php if(isset($measles_Result) && $measles_Result->rb_uncode != " "){ getCrossProvince_UCsOptions(false,$measles_Result->rb_uncode); }else{ ?>
        			...
        			<table class="table table-bordered   table-striped table-hover mytable2 mytable3">
						...
						<?php if(isset($measles_Result) && !$measles_Result->rb_distcode>0 && $measles_Result-> cross_notified != 1 ){ ?>	           
							<tr class="crossNotify">
								...
								<td><p>District</p></td>
								<td id="districttd">
									<input type="hidden" id="distcode" name="distcode" value="<?php $distcode = (isset($measles_Result))?$measles_Result-> distcode:$measles_Result-> distcode; echo $distcode; ?>">
						...
						<?php } ?>
            				...
            				<tr>
								...
								<td style="padding-top: 5px;">
									<?php echo getMeaslesCaseTypes(false,$measles_Result->case_type); ?>
      			...
      			<table class="table table-bordered table-striped table-hover mytable2 mytable3 disabledclass">
						...
						<?php if(isset($measles_Result) && $measles_Result-> procode != $_SESSION["Province"] && $measles_Result-> approval_status == 'Pending' && $measles_Result->facode == '' ){ ?>
							<tr class="otherProvinceAddress">	
								...
								<p><?php echo get_Province_Name($measles_Result->procode); ?></p>	
									<input type="hidden" class="getProcode" name="procode" value="<?php if(isset($measles_Result)) { echo $measles_Result-> procode; } ?>">	
								</td>
								<td><p>District</p></td>
								<td>
					...
					<table class="table table-bordered table-striped table-hover mytable2 mytable3 disabledclass">
						...
						<tbody>
							...
							<tr>
								...
								<td>									
									<select name="th_tcode" id="th_tehsil" class="otherprovince form-control">
										<option>
											<?php if(isset($measles_Result-> th_tcode) && $measles_Result-> th_tcode > 0){ 
												//print_r($measles_Result);
												echo getCrossProvince_TehsilOptions(false,$measles_Result-> th_tcode,$measles_Result-> th_distcode); 
											} ?>
										</option>										
									</select>									
							...
							<tr>
								...
								<td>									
									<select name="th_uncode" id="th_uc" class="otherprovince form-control">
										<option>
											<?php if(isset($measles_Result-> th_uncode) && $measles_Result-> th_uncode > 0){
												echo getCrossProvince_UCsOptions(false,$measles_Result-> th_uncode,$measles_Result-> th_tcode);
											} ?>
										</option>
									</select>									
							...
							<tr>
				            	...
				            	<td>
				            		...
				            		<span style="padding-left: 10px;">
				            			<input class="specimen_collected" type="radio" id="sc_no" name="specimen_collected" value="0" style="cursor: pointer;"><span style="padding-left: 2px;">No</span>
				            		</span>
				            	</td>
							</tr>
							<tr>
								...
								<td>
									<select name="type_specimen[]" id="type_specimen" class="form-control multiselect">
										<!-- <option value="">--Select--</option> -->
										<option <?php if(isset($measles_Result)){ if(array_key_exists("Blood", $specimenArray)){ echo 'selected="selected" class="active"'; } } ?> value="Blood">Blood</option>
										<option <?php if(isset($measles_Result)){ if(array_key_exists("Oral Swab", $specimenArray)){ echo 'selected="selected" class="active"'; } } ?> value="Oral Swab">Oral Swab</option>
										<option <?php if(isset($measles_Result)){ if(array_key_exists("Throat Swab", $specimenArray)){ echo 'selected="selected" class="active"'; } } ?> value="Throat Swab">Throat Swab</option>
										<option <?php if(isset($measles_Result)){ if(array_key_exists("Serum", $specimenArray)){ echo 'selected="selected" class="active"'; } } ?> value="Serum">Serum</option>
										<option <?php if(isset($measles_Result)){ if(array_key_exists("Urine", $specimenArray)){ echo 'selected="selected" class="active"'; } } ?> value="Urine">Urine</option>
										<option <?php if(isset($measles_Result)){ if(array_key_exists("Oral Fluid", $specimenArray)){ echo 'selected="selected" class="active"'; } } ?> value="Oral Fluid">Oral Fluid</option>
									...
									<?php //print_r($specimenArray); ?>
								</td>
								<!-- <td class="other_specimen"><p>Other Specimen Type</p></td>
								<td><input class="form-control other_specimen" name="other_specimen" id="other_specimen" value="<?php if(isset($measles_Result) && $measles_Result->type_specimen  == "Other"){ echo $measles_Result->other_specimen; } ?>" type="text"></td> -->
							...
							<tr>
								<td class="final_classification"><p>Final Classification <span style="color:red;"></span></p></td>
								<td>
									<select name="final_classification" id="final_classification" class="form-control final_classification">
										<option value="">--Select--</option>
										<!--<option <?php if(isset($measles_Result)){ if($measles_Result->final_classification == "Positive Measles"){ echo 'selected="selected"'; } } ?> value="Positive Measles">Positive Measles</option>
										<option <?php if(isset($measles_Result)){ if($measles_Result->final_classification == "Negative Measles"){ echo 'selected="selected"'; } } ?> value="Negative Measles">Negative Measles</option>
										<option <?php if(isset($measles_Result)){ if($measles_Result->final_classification == "Positive Rubella"){ echo 'selected="selected"'; } } ?> value="Positive Rubella">Positive Rubella</option>
										<option <?php if(isset($measles_Result)){ if($measles_Result->final_classification == "Negative Rubella"){ echo 'selected="selected"'; } } ?> value="Negative Rubella">Negative Rubella</option>-->
			...
			<td><input class="form-control" id="h" readonly="readonly" type="text"></td>
							...
							<tr>
								...
								<td>District Health Officer
									<select name="labresult_tobesentto_district" id="labresult_tobesentto_district" class="form-control hide noSpecimen" required="required">
								...
								<td id="mslmsl" class="">
									<select colspan="3" name="specimen_result" class="form-control testpossibleno othertest measles noSpecimen" id="other">
										...
										if($measles_Result->case_type == 'Msl') { ?>
											...
											<option <?php echo ($measles_Result->specimen_result == 'Result Awaited')?'selected="selected"':''; ?> value='Result Awaited'>Result Awaited</option>										
										<?php } else { ?>
							...
							<tr>
								...
								<td>
									<select colspan="3" name="lab_final_classification" class="form-control lab_final_classification" id="lab_final_classification">
										<option value="">--Select--</option>
										<option <?php echo ($measles_Result->lab_final_classification == 'Lab Confirmed Measles')?'selected="selected"':''; ?> value="Lab Confirmed Measles">Lab Confirmed Measles</option>
										<option <?php echo ($measles_Result->lab_final_classification == 'Lab Confirmed Rubella')?'selected="selected"':''; ?> value="Lab Confirmed Rubella">Lab Confirmed Rubella</option>
										<option <?php echo ($measles_Result->lab_final_classification == 'Discarded')?'selected="selected"':''; ?> value="Discarded">Discarded</option>
										<option <?php echo ($measles_Result->lab_final_classification == 'Epi Linked')?'selected="selected"':''; ?> value="Epi Linked">Epi Linked</option>
									</select>									
								</td>
							</tr>
							<tr>
				...
				<table class="table table-bordered table-condensed table-striped table-hover mytable3 ">
					...
					<tbody>
						<tr>
							...
							<input type="hidden" name="submitted_date" value="<?php if(isset($measles_Result)){ echo $measles_Result->submitted_date; } else{ echo $current_date; } ?>" type="date">
							<?php } else{ ?>
...
////end ////
	...
	//----------------Epidemiology Part-------------------//
	<?php if(isset($measles_Result) && $measles_Result->type_specimen == 'None'){ ?>
		$('.labresult_tobesentto').removeAttr('required','required');
		$('.labresult_tobesentto_district').removeAttr('required','required');
		...
		$('.noSpecimen').val('');		
	<?php } else if(isset($measles_Result) && ($measles_Result->type_specimen != 'None' || $measles_Result->type_specimen != 'Discarded') && ($measles_Result->specimen_quantity_adequate == 2)) { ?>
		$('.final_classification').removeClass('hide');
		$('.noSpecimen').attr('disabled','disabled');
		$('#sqa_yes').prop('checked',false);
		$('#sqa_no').prop('checked',true);
	<?php } else if(isset($measles_Result) && ($measles_Result->type_specimen != 'None' || $measles_Result->type_specimen != 'Discarded') && ($measles_Result->specimen_quantity_adequate == 1)) { ?>
		$('.final_classification').addClass('hide');
		$('#sqa_yes').prop('checked',true);
		$('#sqa_no').prop('checked',false);
	<?php } ?>

	<?php if(isset($measles_Result) && $measles_Result->type_specimen != 'None' && $measles_Result->specimen_quantity_adequate != 1 && $measles_Result->specimen_quantity_adequate != 2){ ?>
		$('.final_classification').addClass('hide');
		$('#sqa_yes').prop('checked',true);
		$('#sqa_no').prop('checked',false);
	<?php } ?>

	<?php if(isset($measles_Result) && $measles_Result->specimen_collected > 0 || $measles_Result->type_specimen != 'None'){ ?>
		$('#sc_yes').prop('checked',true);
		$('#sc_no').prop('checked',false);
	<?php } else { ?>
		$('#sc_yes').prop('checked',false);
		$('#sc_no').prop('checked',true);
	<?php } ?>

	<?php if(isset($measles_Result) && $measles_Result->final_classification == 'Epi Linked') { ?>
		//alert('abc');
		$('.noSpecimen').attr('disabled','disabled');
	<?php } else { ?>
	...
	<?php }?>
	$(document).ready(function(){
		var specimen_quantity_adequate = $('input:radio[name=specimen_quantity_adequate]').val();
		if(specimen_quantity_adequate == 2){
			$('.noSpecimen').attr('disabled','disabled');
		} 
		else{
			$('.noSpecimen').removeAttr('disabled','disabled');
		...
		var final_classification  = $('#final_classification').val();
		if(final_classification == 'Epi Linked'){
			$('.noSpecimen').attr('disabled','disabled');
			$('.linked_epid_number').removeClass('hide');
			$('#Ok11').removeClass('hide');
		}
		else if(final_classification == 'Clinically Compatible'){
			$('.noSpecimen').attr('disabled','disabled');
	...
	$(document).ready(function() {
		...
		$('.specimenButton').on('click', function() {
		...
		for(var i in selectedOptions) {
		    ...
		    //alert(optionVal);
		    $("#type_specimen option[value='"+optionVal+"']").prop('selected', true);
		}
	...
	$('#type_specimen').change(function(){
		...
		$('.specimenButton').text(selectedOptions);
		<?php if(isset($measles_Result) && ($measles_Result->specimen_quantity_adequate == 1)) { ?>
			$('#sqa_yes').prop('checked',true);
			$('#sqa_no').prop('checked',false);
		<?php } else { ?>
			$('#sqa_yes').prop('checked',false);
