							...
							<div class="col-xs-3">
								<select id="distcode" name="distcode" class="filter-status form-control">
									...
									<?php $distcode = $this -> session -> District; { ?>
										...
										<option style="background: #8FEBAD;" value="<?php echo 'by_dist'; ?>">Approved cases cross notified by <?php echo get_District_Name($distcode);?></option>
										<option style="background: #EBD38F;" value="<?php echo 'from_dist'; ?>">Approved cases cross notified to <?php echo get_District_Name($distcode);?></option>
										<option style="background: rgba(219, 37, 37, 0.5);" value="<?php echo 'pending_dist'; ?>">Pending cases within <?php echo get_District_Name($distcode);?> and KPK</option>
						...
						<tr>
							...
							<?php if (($_SESSION['UserLevel']=='3') && ($_SESSION['utype']=='DEO')){ ?>
								<th class="text-center Heading">
									<a href="<?php echo base_url(); ?>Measles_investigation/measles_investigation" data-toggle="tooltip" title="Add New">
