	...
	<div class="row">
		<div class="panel panel-primary">
			...
			<div class="panel-heading">
				<?php if(isset($nntForm_Result)) { ?> Update NNT Investigation Form <?php } else { ?> Add NNT Investigation Form <?php } ?>
					...
					<table id="rb_info" class="table table-bordered table-striped table-hover mytable2 mytable3 disabledclass">
						...
						<tbody>
							...
							<tr>
								...
								<td>
									<select id="rb_tcode" name="rb_tcode" required="required" class="form-control">
							...
							<tr>
								...
								<td>
									<input class="form-control" name="rb_faddress" id="rb_faddress" value="<?php if(isset($nntForm_Result)){ echo $nntForm_Result->rb_faddress; } ?>" type="text">
								</td>
							</tr>
						</tbody>
					</table>
		          		...
		          		<tbody>
							...
							<?php if(isset($nntForm_Result) && $nntForm_Result-> cross_notified == 1 && $nntForm_Result -> cross_notified_from_distcode == $this -> session -> District){}else{ ?>
								<tr id="healthFacilityTr">
									...
									<td>
										<input class="form-control" required="required" name="reported_from" id="reported_from" value="<?php if(isset($nntForm_Result)){ echo $nntForm_Result->reported_from; } ?>" type="text">
									</td>
								</tr>
		            		<?php } ?>
							<tr>
							...
							<tr>
								...
								<td class="disabledclass">
									<input class="form-control" name="mode_reporting" id="mode_reporting" value="<?php if(isset($nntForm_Result)){ echo $nntForm_Result->mode_reporting; } ?>" type="text">
								</td>
							...
							<tr>
								...
								<td class="disabledclass">
									<input class="dp form-control" name="date_investigation" id="date_investigation" value="<?php if(isset($nntForm_Result) && $nntForm_Result->date_investigation != ""){ if($nntForm_Result->date_investigation!= '1969-12-31'){ echo date('d-m-Y',strtotime($nntForm_Result->date_investigation)); }else{ echo ''; } } ?>" type="text">
								</td>
							...
							<tr> 
								...
								<td class="disabledclass">
									<input class="dp form-control" name="date_onset" id="date_onset" value="<?php if(isset($nntForm_Result) && $nntForm_Result->date_onset != ""){ if($nntForm_Result->date_onset!= '1969-12-31'){ echo date('d-m-Y',strtotime($nntForm_Result->date_onset)); }else{ echo ''; } } ?>" type="text" required="required">
								</td>
								<td><p>Clinical Representation</p></td>
								<td>
									<input class="form-control text-center" readonly="readonly" name="clinical_representation" id="clinical_representation" value="<?php if(isset($nntForm_Result)){ echo ($nntForm_Result->clinical_representation); } else{ echo "Unable to Suck & cry become stiff or has spasms"; }?>" type="text">
								</td>
							</tr>
							<tr>
								...
								<td>
									<input class="dp form-control" name="date_notification_level" id="date_notification_level" value="<?php if(isset($nntForm_Result) && $nntForm_Result->date_notification_level !=""){ if($nntForm_Result->date_notification_level!= '1969-12-31'){ echo date('d-m-Y',strtotime($nntForm_Result->date_notification_level)); }else{ echo ''; } } ?>" type="text">
								</td>
							</tr>
							<tr>
								<td><p>Cases</p></td>
								<td class="disabledclass">
									<input class="form-control" name="cases" id="cases" value="<?php if(isset($nntForm_Result)){ echo $nntForm_Result->cases; } ?>" type="text">
								</td>
								<td><p>Deaths</p></td>
								<td class="disabledclass">
									<input class="form-control" name="deaths" id="deaths" value="<?php if(isset($nntForm_Result)){ echo $nntForm_Result->deaths; } ?>" type="text">
								</td>
							</tr>
				            <tr>
				              	<td><p>Mothers Full name <span style="color:red;">*</span></p></td>
				              	<td class="disabledclass">
				              		<input class="form-control" name="full_mother_name" id="full_mother_name" required="required" value="<?php if(isset($nntForm_Result)){ echo $nntForm_Result->full_mother_name; } ?>" type="text">
				              	</td>	             
				              	<td><p>Head of household full name</p></td>
				              	<td class="disabledclass">
				              		<input class="form-control" name="head_full_name" id="head_full_name" value="<?php if(isset($nntForm_Result)){ echo $nntForm_Result->head_full_name; } ?>" type="text">
				              	</td>
				            </tr>
				            <tr>
							...
							<tr>
								...
								<td class="disabledclass">
									<input class="form-control" name="ethnic_group" id="ethnic_group" value="<?php if(isset($nntForm_Result)){ echo $nntForm_Result->ethnic_group; } ?>" type="text">
								</td>
								<td><p>Contact Number</p></td>
			                    <td>
			                    	<input class="numberclass form-control" name="contact_numb" id="contact_numb" value="<?php if(isset($nntForm_Result)){ echo $nntForm_Result->contact_numb; } ?>" type="text">
			                    </td>
							</tr>		
		       			</tbody>
		    		</table>
