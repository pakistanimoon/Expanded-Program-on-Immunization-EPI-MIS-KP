...
<div class="row">
 <div class="panel panel-primary">
   <div class="panel-heading">View AFP Outbreak Investigation Line List of Suspected Cases</div>
     <div class="panel-body">

        <table class="table table-bordered   table-striped table-hover  mytable">
          <tr>
            <td><label>Village/Mahalla</label></td>
            <td><?php echo $afpLineListResult[0]['village_mahalla']; ?></td>
            <td><label>Union Council</label></td>
            <td><?php echo get_UC_Name($afpLineListResult[0]['uncode']); ?></td>
            
            <td><label>Tehsil/Taluka</label></td>
            <td><?php echo get_Tehsil_Name($afpLineListResult[0]['tcode']); ?></td>
          </tr>
          <tr>
            <td><label>District</label></td>
            <td><?php echo get_District_Name($afpLineListResult[0]['distcode']); ?></td>
            <td><label>Province/Area</label></td>
            <td>Khyber Pakhtunkhwa</td>
            <td><label>Date of Investigation</label></td>
            <td><?php echo date('d-m-Y',strtotime($afpLineListResult[0]['date_investigation'])); ?></td>
          </tr>
          <tr>
             
            <td><label>Investigation done by</label></td>
            <td><?php echo $afpLineListResult[0]['investigation_by']; ?></td>
        ...
        <div class="row">
         <hr>
            <div style="text-align: right;" class="col-md-4 col-md-offset-8">
              ...
              <a href="<?php echo base_url(); ?>Linelists/afp_linelist_edit/<?php echo $afpLineListResult[0]['distcode']; ?>/<?php echo $afpLineListResult[0]['linelist_group']; ?>" style="background: rgb(22, 108, 29) none repeat scroll 0% 0%;" class="btn btn-primary btn-md"><i class="fa fa-pencil-square-o"></i> Update </a>
