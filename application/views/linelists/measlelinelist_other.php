       ...
       <form class="form-horizontal">
        ...
        <table class="table table-bordered table-condensed table-striped table-hover mytable">
          <thead>
            <tr>
				<th rowspan="1">S #</th>
				<th rowspan="1">Name of Reporting Unit*</th>
				<th rowspan="1">Type of Case**</th>
				<th rowspan="1">Week#</th>
				<th rowspan="1">Case EPID Number***</th>
				<th rowspan="1">Name of Case*</th>
				<th rowspan="1">Father Name</th>
				<th rowspan="1">Address of the child House#/Street# etc</th>
				<th rowspan="1">UC</th>
				<th rowspan="1">Tehsil</th>
				<th rowspan="1">District</th>
				<th rowspan="1">Age in Months</th>
				<th rowspan="1">Gender</th>
				<th rowspan="1">Date of Onset</th>
				<th rowspan="1">Date of Investigation***</th>
				<th rowspan="1">Date of Notification</th>
				<th rowspan="1"># of Measles vaccine doses received</th>
				<th rowspan="1">Date of last measles dose</th>
				<th rowspan="1">Date of specimen collection (if any)</th> 
				<th rowspan="1">Clinical Presentation of the case</th>
				<th rowspan="1">Specimen Result</th>
            </tr>
		  ...
		  foreach($measles as $key => $row){ 
            ...
            if($row['patient_gender']=='1')
              ...
              $patient_gender= '';
		 ?>
		 <?php /* if($key == 0 || $row['week'] != $previousWeekNumber){ */ /* AND $row['week'] != '0'*/?>
			<!--<tr class="text-center">
				<td class="text-center success" style="font-size: 15px;font-weight: bold;text-align: center;" colspan="20">
