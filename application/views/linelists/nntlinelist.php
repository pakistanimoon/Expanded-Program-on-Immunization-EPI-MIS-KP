       ...
       <form class="form-horizontal">
		...
		/* $previousWeekNumber = $row['week'];
           ...
           <tr class="nntDrillDownRow">
             <?php if (($_SESSION['UserLevel']=='3') && ($_SESSION['utype']=='DEO')){ ?>
                    <td>
                        <!-- <a href="<?php //echo base_url(); ?>NNT-CIF/Edit/<?php //echo $row['id']; ?>" data-toggle="tooltip" title="View" class="btn btn-xs btn-default"><i class="fa fa-search"></i></a> --> 
...
<script type="text/javascript">
    ...
    $(document).on('click',".nntDrillDownRow", function(){
        ...
        if(ulevel==3){
            var code = $(this).find("td:nth-child(2)").data('id');
        }
        else{
