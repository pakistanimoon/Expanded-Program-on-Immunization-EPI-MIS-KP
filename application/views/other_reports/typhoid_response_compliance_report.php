			...
			<table id="fixTable" class="table">
				<thead>
					<tr>
						...
						<th class="Heading text-center" style="background: #008d4c; color: white; width: 200px; border: 1px solid black;" colspan="11">No. Of Children Vaccinated</th>
					...
					<tr>
						...
						<th class="Heading text-center" style="background: #008d4c; color: white; width: 200px; border: 1px solid black;">TCV</th>
