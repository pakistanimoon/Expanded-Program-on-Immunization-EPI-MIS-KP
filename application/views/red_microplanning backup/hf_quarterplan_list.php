						...
						<thead>
							<tr>
								...
								<th class="text-center Heading">
									<a href="<?php echo base_url(); ?>red_microplan/Facility_quarterplan/hf_quarterplan_add" data-toggle="tooltip" title="Add New Supervisor">
							...
							?>
								<tr>
							      ...
							      <td class="text-center">
								      <a href="<?php echo base_url(); ?>red_microplan/Facility_quarterplan/hf_quarterplan_view/<?php echo $row['facode']; ?>/<?php echo $row['year']; ?>/<?php echo $row['quarter']; ?>" data-toggle="tooltip" title="View" class="btn btn-xs btn-default"><i class="fa fa-search"></i></a>
								      <a href="<?php echo base_url(); ?>red_microplan/Facility_quarterplan/hf_quarterplan_edit/<?php echo $row['facode']; ?>/<?php echo $row['year']; ?>/<?php echo $row['quarter']; ?>" data-toggle="tooltip" title="Edit" class="btn btn-xs btn-default"><i class="fa fa-pencil"></i></a>
							      </td>
						 		</tr>
							<?php } ?>
						</tbody>
