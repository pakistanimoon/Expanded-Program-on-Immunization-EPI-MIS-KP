	<div class="container">
		<div class="row">
			<div class="panel panel-primary">
				...
				<div class="panel-heading" style="font-size:17px; border-color:white !important;">Situation Analysis List</div>
					...
					<form method="post" id="filter-form">
						...
						<div class="row" style="width:100%; padding:4px 17px">					
							...
							<div class="col-md-3">
								<?php
									$distcode = $this-> session-> District; 
									$query="SELECT distinct area_name from situation_analysis_db where distcode='{$distcode}' order by area_name ASC";
									$result = $this->db->query($query)->result_array();
								?>
							...
							?>
								<tr>
							      ...
							      <td class="text-center">
								      ...
								      <a href="<?php echo base_url(); ?>red_rec_microplan/Situation_analysis/situation_main_edit/<?php echo $row['techniciancode']; ?>/<?php echo $row['year']; ?>" data-toggle="tooltip" title="Edit" class="btn btn-xs btn-default"><i class="fa fa-pencil"></i></a>
							      </td>
						 		</tr>
							<?php } ?>
						</tbody>
