				...
				<div class="panel-body" style="padding-top:1px;">
					...
					<div class="row">
						<div class="col-md-12">
							...
							<a href="<?php echo base_url();?>red_microplan/Situation_analysis/situation_analysis_edit/<?php echo $data[0]['facode']; ?>/<?php echo $data[0]['year']; ?>"><button type="button" class="form-btn"><i class="fa fa-pencil" aria-hidden="true"></i> Update</button></a>							<a href="<?php echo base_url(); ?>red_microplan/Special_activities/special_activities_view/<?php echo $data[0]['facode']; ?>/<?php echo $data[0]['year']; ?>"><button type="button" class="form-btn"><i class="fa fa-search" aria-hidden="true"></i> Special Activities Form View </button></a>							
						</div>
					</div>				
