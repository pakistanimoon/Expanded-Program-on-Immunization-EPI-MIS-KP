					...
					<div class="panel-body" style="padding-top:1px;">
						<table class="table table-bordered plan_table" >
							...
							<tbody id="tableplanbody">
								...
								?>
								<tr>
								 	<td><input type="text" value="<?php echo $val['area_name']; ?>" name="area_name[<?php echo $key+1; ?>]" class="form-control area_name" readonly="readonly"></td>
									<td><input type="text" value="<?php echo $val['category']; ?>" name="category[<?php echo $key+1; ?>]" class="form-control text-center category" readonly="readonly"></td>                                   								   <input type="hidden" name="fk[<?php echo $key+1; ?>]" value="<?php echo $val['recid']; ?>">
								 										<td>
