...
?>
   <?php  foreach($row as $key => $val){
	...
	<tr>
		<td rowspan="5" style="vertical-align:middle">
			<input type="text" id="area1_name"  name="vcode[<?php echo $numarea; ?>]" value="<?Php print_r (get_Village_Name($val['vcode'])); ?>" class="form-control" readonly>
			<input type="text" hidden="hidden" id="area1_code"  name="area_code[<?php echo $numarea; ?>]" value="<?Php print_r ($val['vcode']); ?>">
			<input type="text" hidden="hidden" id="facode"  name="facode[<?php echo $numarea; ?>]" value="<?Php print_r ($val['facode']); ?>">
		...
		<table>
				<tbody>
					...
					<tr>
						...
						<input type="hidden" class="type1" name="area_code_dt[<?php echo $numarea; ?>][<?php echo $index; ?>]" value="<?Php print_r ($val['vcode']); ?>"  >
						<input type="hidden" class="type1" name="facode_dt[<?php echo $numarea; ?>][<?php echo $index; ?>]" value="<?Php print_r ($val['facode']); ?>"  >
   ...
   <?php } ?>
	...
	<tr>
		...
		<td>
			<input type="text" id="area1_resperson_m1" value="<?Php print_r ($val['technicianname']); ?>" name="area_resperson[<?php echo $numarea; ?>]" class="form-control">
			<input type="hidden" id="area1_resperson_m1" value="<?Php print_r ($val['techniciancode']); ?>" name="area_resperson_m1[<?php echo $numarea; ?>]" class="form-control">
		</td>
		<td><label for="date_of_scheduled">Person Responsible<br><span class="urdu">ذمہ دارشخص کا نام</span></label></td>
		<td>
			<input type="text" id="area1_resperson_m2" value="<?Php print_r ($val['technicianname']); ?>" name="area_resperson[<?php echo $numarea; ?>]" class="form-control">
			<input type="hidden" id="area1_resperson_m2" value="<?Php print_r ($val['techniciancode']); ?>" name="area_resperson_m2[<?php echo $numarea; ?>]" class="form-control">
			
			</td>
		<td><label for="date_of_scheduled">Person Responsible<br><span class="urdu">ذمہ دارشخص کا نام</span></label></td>
		<td>
			<input type="text" id="area1_resperson_m3" value="<?Php print_r ($val['technicianname']); ?>" name="area_resperson[<?php echo $numarea; ?>]" class="form-control">
			<input type="hidden" id="area1_resperson_m3" value="<?Php print_r ($val['techniciancode']); ?>" name="area_resperson_m3[<?php echo $numarea; ?>]" class="form-control">
			</td>
	</tr>
	<tr>
	...
	<?php } ?>
		...
		<tr class="bottr">
			<td><label for="Person responsible ">Person Responsible <br><span class="urdu">ذمہ دار شخص کا نام</span></label></td>
			<td>
				<!--<input type="text" id="ra_resperson_m1" value="<?Php print_r ($val['technicianname']); ?>"  name="ra_resperson_m1" class="form-control">-->
				<input type="text" id="ra_resperson_m1"   name="ra_resperson_m1" class="form-control">
			</td>
			<td><label for="Person responsible ">Person Responsible<br><span class="urdu">ذمہ دار شخص کا نام</span> </label></td>
			<td>
				<!--<input type="text" id="ra_resperson_m2" value="<?Php print_r ($val['technicianname']); ?>"  name="ra_resperson_m2" class="form-control">-->
				<input type="text" id="ra_resperson_m2"   name="ra_resperson_m2" class="form-control">
			</td>
			<td><label for="Person responsible ">Person Responsible<br><span class="urdu">ذمہ دار شخص کا نام</span></label></td>
			<td>
				<!--<input type="text" id="ra_resperson_m3" value="<?Php print_r ($val['technicianname']); ?>"  name="ra_resperson_m3" class="form-control">-->
				<input type="text" id="ra_resperson_m3"   name="ra_resperson_m3" class="form-control">
			</td>
		</tr>
		<tr class="bottr">
...
////////////On change quarter set Qaurter calendar in  //////////////////
	$(document).on('change','#quarter', function(){
		...
		if(month1 != "0" ){
			var day = '01';
			var eday = '31';
			var date1 = year+'-'+month1+'-'+day;//2019-04-01
			var edate1 = year+'-'+month1+'-'+eday;//2019-04-31
