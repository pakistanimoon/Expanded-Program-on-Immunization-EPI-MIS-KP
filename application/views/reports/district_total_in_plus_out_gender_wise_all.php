			...
			<tbody>  
				...
				if( /*! (($total['New Borns Male'] == 0) AND ($total['New Borns FeMale'] == 0) AND ($total['Targeted_Male_Children'] == 0) AND ($total['Targeted_Female_Children'] == 0) )*/1)
				{
					...
					foreach($data as $val)
					{
						...
						echo implode("</td><td style='text-align:center; border: 1px solid black;' class='text-center'>",$val);
					...
					echo "<tr><td style='text-align:center; border: 1px solid black;' class='text-center'></td><td style='text-align:center; border: 1px solid black;' class='text-center'></td><td class='text-center' style='background-color: grey'><strong> Total: </strong></td><td style='background-color: grey'>";
					echo implode("</td><td style='background-color: grey'>",$total);
					//echo implode("</td><td class=\"text-red\">",$total);
					echo "</td></tr>";
				}
				else{
					echo "<tr><td style='text-align:center; border: 1px solid black;' class='text-center'></td><td style='text-align:center; border: 1px solid black;' class='text-center'></td><td colspan='32' class='text-center'><strong> No Record Found </strong></td><td style='text-align:center; border: 1px solid black;' class='text-center'>";
				}
				?>
			</tbody>
		</table>
