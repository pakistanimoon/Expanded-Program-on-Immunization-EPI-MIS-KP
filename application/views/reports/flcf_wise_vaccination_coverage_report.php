     ...
     <table  class="table tableuc table-condensed footable table-vcenter tbl-consolidated-uc row-border  order-column" data-filter="#filter" data-filter-text-only="true">
        <thead>
			<tr style="background-color: #15681E;color: #FFF;">
				...
				<th class="Heading text-center" style="background: #008d4c; color: white; width: 200px; border: 1px solid black;" colspan="8" class="thuc col">OPV</th>
				<th class="Heading text-center" style="background: #008d4c; color: white; width: 200px; border: 1px solid black;" colspan="6" class="thuc col">Pentavalent</th>
				<th class="Heading text-center" style="background: #008d4c; color: white; width: 200px; border: 1px solid black;" colspan="6" class="thuc col">PVC 10</th>
				...
				<!--<th class="Heading text-center" style="background: #008d4c; color: white; width: 200px; border: 1px solid black;" rowspan="2" class="thuc col">%</th>-->
				<th class="Heading text-center" style="background: #008d4c; color: white; width: 200px; border: 1px solid black;" colspan="4" class="thuc col">Measles</th>
			  
				<th class="Heading text-center" style="background: #008d4c; color: white; width: 200px; border: 1px solid black;" colspan="7" class="thuc col">TT Pregnant Women</th>
				<th class="Heading text-center" style="background: #008d4c; color: white; width: 200px; border: 1px solid black;" colspan="5" class="thuc col">TT Non-Pregnant Women (15-49 Years)</th>
			...
			<tr>
				<th class="Heading text-center" style="background: #008d4c; color: white; width: 200px; border: 1px solid black;" class="thuc col">BCG/OPV 0</th>
	...
	$('.Coverage').on('click', function(){
	   ...
	   <?php if(isset($data['year'])) { ?>
	    ...
	    if(code.toString().length == 3){
	    	//alert(code);
	    	url = "<?php echo base_url();?>Reports/flcf_wise_vaccination_coverage?distcode="+code+"&report_year="+year;
	    }
