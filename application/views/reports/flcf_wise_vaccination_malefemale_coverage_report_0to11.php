		...
		<table id="fixTable"  class="table table-bordered table-hover table-striped">
			<thead>
				<tr>
					...
					<th class="Heading text-center" rowspan="3" style="min-width: 170px;">Tehsil Name</th>
			...
			<tbody>  
				...
				$percentage   = array(
					...
					"percmip_o","percfip_o","percmmea_o","percfmea_o",
				...
				$i=1;
				$maleTargetArray=array(7,11,15,19,23,27,31,35,39,43,47,51,55,59,63,67,71,75,79);
				...
				foreach($data as $val)
				{
					echo "<tr class='DrillDownRow'><td style='text-align:center; border: 1px solid black;' class='text-center'>".$count."</td><td>";
				...
				<td style='text-align:center; border: 1px solid black;' class='text-center'></td>
				<td style='text-align:center; border: 1px solid black;' class='text-center'><strong> Total: </strong></td><td>";
				...
				echo "</td></tr>";
					...
					<td style='text-align:center; border: 1px solid black;' class='text-center'></td>
					<td style='text-align:center; border: 1px solid black;' class='text-center'></td>
					<td style='text-align:center; border: 1px solid black;' class='text-center' colspan='32' class='text-center'>
					<strong> No Record Found </strong></td><td>";
				}
				?>
			</tbody>
		</table>
