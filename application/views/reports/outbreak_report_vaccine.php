			...
			<div class="panel-body">					
					<table class="table table-bordered plan_table">						
						...
						<tbody id="trRow">
							...
							<?php } ?>
							<tr>
								<td style="text-align:center; background-color: black;color: white;" class="text-center">Total</td>
								<td style="text-align:center; background-color: black;color: white;" class="text-center"><?php echo $m_m;?></td>
								<td style="text-align:center; background-color: black;color: white;" class="text-center"><?php echo $m_f;?></td>
								<td style="text-align:center; background-color: black;color: white;" class="text-center"><?php echo $m_m1;?></td>
								<td style="text-align:center; background-color: black;color: white;" class="text-center"><?php echo $m_f1;?></td>
								<td style="text-align:center; background-color: black;color: white;" class="text-center"><?php echo $years_m;?></td>
								<td style="text-align:center; background-color: black;color: white;" class="text-center"><?php echo $years_f;?></td>
								<td style="text-align:center; background-color: black;color: white;" class="text-center"><?php echo $total_m;?></td>
								<td style="text-align:center; background-color: black;color: white;" class="text-center"><?php echo $total_f;?></td>
								<td style="text-align:center; background-color: black;color: white;" class="text-center"><?php echo $total_m_f;?></td>
							</tr>
						</tbody>					
					</table>		
			</div>
