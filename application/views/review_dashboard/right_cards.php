					...
					<section id="rev_aside">
						<div class="container-fluid p-0">
							...
							foreach($rightCardsMainArray as $key => $indicator){
								////////by usama for % sing
								if($indicator['id']=='faczerotech') {
										$sing='';					
								}elseif($indicator['id']=='uczeroepi'){
										$sing='';
								}elseif($indicator['id']=='epizeroilr'){
										$sing='';
								}elseif($indicator['id']=='vaccinatortopopulationratio'){
										$sing='';
								}elseif($indicator['id']=='Accessandutilization'){
										$sing='';
								}else{
										$sing='&#37;';
								}
											...
											<tbody>
												<tr>
													<td class="main-box bg-<?php echo $i; ?> p-2">
														...
														<span class="fig"><?php echo $indicator['value']; ?><?php echo $sing ; ?>
											...
											<div id="carousel-example<?php echo $i; ?>" class="carousel slide carousel-example multi-item-carousel" data-ride="carousel" data-wrap="false"  data-interval="false">
												<table class="table m-0">
													<tbody>
														<tr>
															<td class="p-0">
																<ul class="nav nav-pills carousel-inner row w-100 mx-auto">
																	<?php
																	$j=0;
