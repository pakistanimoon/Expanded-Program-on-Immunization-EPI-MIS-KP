            ...
            <thead>
              <tr>
                ...
                <th class="text-center Heading" style="width:100px;">
                    <a href="<?php echo base_url(); ?>Cold-Chain-Mechanic/Add" class="red-tooltip" data-toggle="tooltip" title="Add New Cold-Chain-Mechanic">
...
<script type="text/javascript">
 ...
 $(document).ready(function() { 
    ...
    var columns = [
          ...
          { data: "ccm_code" ,
            ...
            render : function(data, type, row) {
                return '<a data-original-title="View" href="<?php echo base_url(); ?>Cold-Chain-Mechanic/View/'+data+'" data-toggle="tooltip" title="" class="btn btn-xs btn-default"><i class="fa fa-search"></i></a><a data-original-title="Edit" href="<?php echo base_url(); ?>Cold-Chain-Mechanic/Edit/'+data+'" data-toggle="tooltip" title="" class="btn btn-xs btn-default"><i class="fa fa-pencil"></i></a>'
            }  
          }
        ]; 
  <?php } elseif ($_SESSION['utype']=='Manager'){?>
    var columns = [
          ...
          { data: "ccm_code" ,
            ...
            render : function(data, type, row) {
			//	alert(date);
                return '<a data-original-title="View" href="<?php echo base_url(); ?>Cold-Chain-Mechanic/View/'+data+'" data-toggle="tooltip" title="" class="btn btn-xs btn-default"><i class="fa fa-search"></i></a>'
            }  
          }
        ]; 
  <?php } ?>
  var table = $('#codb-tbl').DataTable({
        ...
        "ajax": {
            url : "<?php echo base_url(); ?>Ajax_calls/ccm_dataTables",
            type : 'GET'
        },
        "columns": columns,
        dom: 'lrtips'
