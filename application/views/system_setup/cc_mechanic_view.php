 ...
 <form  class="form-horizontal form-bordered" action="<?php echo base_url(); ?>System_setup/codb_edit">
                <div class="form-group">
                  <div class="row">
                    ...
                    <div class="row">
                        <label class="col-xs-2 col-xs-offset-1 control-label"  for = "bankbranch" > Mechanic Name </label>
                      <div class="col-xs-2 col-xs-offset-2 cmargin5">
                        <span> <?php echo $codata['ccm_name'];?> </span>
                      </div>
                     <div class="col-xs-2 col-xs-offset-1">
               ...
               <?php if (($_SESSION['UserLevel']=='3') && ($_SESSION['utype']=='DEO')){?>
                  <div class="row">
                             <div class="col-xs-4 col-xs-offset-8">
                               ...
                               <a href=" <?php echo base_url(); ?>Cold-Chain-Mechanic/Edit/<?php echo $codata['ccm_code']; ?>" class="btn btn-md btn-success "><i class="fa fa-pencil-square-o"></i> Update </a>
                                <a href="<?php echo base_url(); ?>Cold-Chain-Mechanic/List" type="reset" class="btn btn-md btn-success "><i class="fa fa-arrow-left"></i> Back </a>
                            
                </div>  <input type="hidden" name="ccm_code" value="<?php echo  $codata['ccm_code']?>" />
              </div>
              <?php }?>
