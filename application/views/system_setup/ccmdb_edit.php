...
<div class="row">
    ...
    <form id="dataform" action="<?php echo base_url(); ?>System_setup/ccmdb_save" method="post" enctype="multipart/form-data" class="form-horizontal form-bordered" onSubmit="">
                  ...
                  <div class="col-xs-3">
                    <select id="tcode" name="tcode" class="form-control" size="1" >
                      ...
                      foreach($resultTeh as $row){
                        ?>
                        <option <?php ($ccmdata['tcode'] == $row['tcode'] ? 'selected="selected"' : '') ?> value="<?php echo $row['tcode']; ?>" <?php echo set_select('tcode',$row['tcode']); ?> /><?php echo $row['tehsil'];?></option>
                        <?php
                      }
                      ?>
                    </select>
						...
						<?php 
						 foreach($resultFac as $row){
						  ?>
						   ...
						   <option value="<?php echo $row['facode'];?>"  <?php if($ccmdata['facode'] == $row['facode'] ){ echo 'selected="selected"'; } else  { echo ''; } ?>  /> <?php echo $row['fac_name'];?>
							<?php
						  }
						  ?>
						</select>
                  </div>
                  <label class="col-xs-2 control-label"  for = "ccmcode" >Mechanic Code </label>
                <div class="col-xs-3">
                <label class="control-label"  for = "ccmcode" ><?php echo $ccmdata['ccmcode']; ?></label>
                  <input type="hidden" required name="ccmcode" id="ccmcode" placeholder="Cold Chain Mechanic Code"  value="<?php echo $ccmdata['ccmcode']; ?>"  class="form-control "/>
                  
                </div>
          </div>
              <div class="row">
                <label class="col-xs-2 col-xs-offset-1 control-label"  for = "ccmname" >Mechanic Name </label>
                <div class="col-xs-3">
                  <input type="text" required name="  ccmname" id="ccmname" placeholder="Cold Chain Mechanic Name"  value="<?php if(validation_errors() != false) { echo set_value('ccmname'); } else { echo $ccmdata['ccmname']; } ?>"  class="form-control "/><?php echo form_error('ccmname'); ?>
                </div>
                  <label class="col-xs-2 control-label"  for = "fathername" > Father Name </label>
                  <div class="col-xs-3">
                  <input type="text"  name="fathername" id="fathername" placeholder="Father Name"  value="<?php if(validation_errors() != false) { echo set_value('fathername'); } else { echo $ccmdata['fathername']; } ?>"  class="form-control "/><?php echo form_error('fathername'); ?>
</div>
                  </div>
</div>
              ...
              <div class="row">
                  ...
                  <div class="col-xs-3">
                    <select id="marital_status" name="marital_status" class="form-control" size="1" >
                         <option <?php if($ccmdata['marital_status'] == 'Married') { echo 'selected="selected"'; } else { echo ''; } ?> value="Married">Married</option>
                        <option  <?php if($ccmdata['marital_status'] == 'Single') { echo 'selected="selected"'; } else { echo ''; } ?> value="Single">Single</option>
                    </select>
                  </div>
                  <label class="col-xs-2 control-label"  for = "nic" >Phone Number </label>
                  <div class="col-xs-3">
                     <input required name="phone" id="phone" placeholder="Phone Number"  class="form-control " value="<?php if(validation_errors() != false) { echo set_value('phone'); } else { echo $ccmdata['phone']; } ?>"/><?php echo form_error('phone'); ?>
 </div>
                  </div>
                  <div class="row">
                  <label class="col-xs-2 col-xs-offset-1 control-label"  for = "cnic" > CNIC # </label>
                  <div class="col-xs-3">
                    <input required name="  nic" id="nic" placeholder="Enter Your CNIC #"  value="<?php if(validation_errors() != false) { echo set_value('nic'); } else { echo $ccmdata['nic']; } ?>"  class="form-control "/><span id="site_response"></span><?php echo form_error('nic'); ?>
</div>
                  <label class="col-xs-2 control-label"  for = "date_of_birth" > Date of Birth </label>
                  <div class="col-xs-3">
                    <input type="text" required name="  date_of_birth" id="date_of_birth" placeholder="dd-mm-yyyy"  value="<?php echo isset($ccmdata['date_of_birth']) ? date('d-m-Y', strtotime($ccmdata['date_of_birth'])) : '';?>"  class="form-control "/><?php echo form_error('date_of_birth'); ?>
 </div>
                  </div>
                  </div>
                ...
                <div class="form-group">
                 <div class="row">
                      ...
                      <div class="col-xs-3">
                         <input type="text" required name="  permanent_address" id="permanent_address" placeholder="Permanent Address"  value="<?php if(validation_errors() != false) { echo set_value('permanent_address'); } else { echo $ccmdata['permanent_address']; } ?>"  class="form-control "/><?php echo form_error('permanent_address'); ?>
                </div>
                      <label class="col-xs-2 control-label"  for = "present_address" > Present Address </label>
                      <div class="col-xs-3">
                        <input type="text" required name="  present_address" id="present_address" placeholder="Present Address"  value="<?php if(validation_errors() != false) { echo set_value('present_address'); } else { echo $ccmdata['present_address']; } ?>"  class="form-control "/><?php echo form_error('present_address'); ?>
</div>
                      </div>
<div class="row">
                      ...
                      <option  <?php if($ccmdata['lastqualification'] == 'Middle') { echo 'selected="selected"'; }else echo ''; ?> value="Middle">Middle</option>
                      <option <?php if($ccmdata['lastqualification'] == 'Matric') { echo 'selected="selected"'; }else echo ''; ?> value="Matric">Matric</option>
                      ...
                      <div class="col-xs-3">
                       <input type="text"  name="  passingyear" id="passingyear" placeholder="Passing Out Year"  value="<?php if(validation_errors() != false) { echo set_value('passingyear'); } else { echo $ccmdata['passingyear']; } ?>"  class="form-control "/><?php echo form_error('passingyear'); ?>
</div>
                      </div>
<div class="row">
                      <label class="col-xs-2 col-xs-offset-1 control-label"  for = "institutename" > Institute Name </label>
                      <div class="col-xs-3">
                          <input type="text"  name="  institutename" id="institutename" placeholder="Institute Name"  value="<?php if(validation_errors() != false) { echo set_value('institutename'); } else { echo $ccmdata['institutename']; } ?>"  class="form-control "/>
  </div>
                    </div>
                 </div>
 ...
 <div class="form-group">    
              <div class="row">
                  <label class="col-xs-2 col-xs-offset-1 control-label"  for = "date_joining" > Date Of Joining </label>
                      <div class="col-xs-3">
                        <input type="text"  name="  date_joining" id="date_joining" placeholder="Date Of Joining"  value=" <?php if(validation_errors() != false) { echo set_value('date_joining'); } else { echo isset($ccmdata['date_joining']) ? date('d-m-Y', strtotime($ccmdata['date_joining'])) : ''; } ?>" class="form-control "/>
</div>
                      <label class="col-xs-2 control-label"  for = "place_of_joining" > Place of Joining </label>
                      <div class="col-xs-3">
                        <input type="text"  name="  place_of_joining" id="place_of_joining" placeholder="Place of Joining"  value="<?php if(validation_errors() != false) { echo set_value('place_of_joining'); } else { echo $ccmdata['place_of_joining']; } ?>"  class="form-control "/>
</div>
                      </div>
	<div class="row">
		<label class="col-xs-2 col-xs-offset-1 control-label"  for = "employee_type" > Employee Type </label>
				<div class="col-xs-3">
					<select id="employee_type" name="employee_type" class="form-control" size="1" >
						<option value="Contract" <?php if($ccmdata['employee_type'] == 'Contract') { echo 'selected="selected"'; }else echo ''; ?> <?php echo set_select('employee_type', 'Contract', TRUE); ?>>Contract</option>
						<option value="Regular" <?php if($ccmdata['employee_type'] == 'Regular') { echo 'selected="selected"'; }else echo ''; ?>  <?php echo set_select('employee_type', 'Regular'); ?>>Regular </option>
						<option value="Contingent" <?php if($ccmdata['employee_type'] == 'Contingent') { echo 'selected="selected"'; }else echo ''; ?>  <?php echo set_select('employee_type', 'Contingent'); ?>>Contingent </option>
					</select>
					</div>
                      ...
                      <option <?php if($ccmdata['status'] == 'Active') { echo 'selected="selected"'; }else echo ''; ?> value="Active">Active</option>
                        <option <?php if($ccmdata['status'] == 'Terminated') { echo 'selected="selected"'; }else echo ''; ?>  value="Terminated">Terminated</option>
                        <option <?php if($ccmdata['status'] == 'Died') { echo 'selected="selected"'; }else echo ''; ?>  value="Died">Died</option>
                        <option <?php if($ccmdata['status'] == 'Retired') { echo 'selected="selected"'; }else echo ''; ?>  value="Retired">Retired</option>
                      </select>
                      </div>
                      ...
                      <div class="col-xs-3">
                          <input type="text"  name="date_termination" id="date_termination" placeholder="Date Of Termination"  value=" <?php if(validation_errors() != false) { echo set_value('date_termination'); } else { echo isset($ccmdata['date_termination']) ? date('d-m-Y', strtotime($ccmdata['date_termination'])) : ''; } ?>"  class="form-control "/>
</div>
</div>
					...
					<div class="col-xs-3">
						<input  type="text"  name="date_retired" id="date_retired" placeholder="Date Retired"  class="form-control " value=" <?php if(validation_errors() != false) { echo set_value('date_retired'); } else { echo isset($ccmdata['date_retired']) ? date('d-m-Y', strtotime($ccmdata['date_retired'])) : ''; } ?>"/>
					</div>
					</div>
					<div class="showDied" id="showDied" style="display: none;">
					<label class="col-xs-2 control-label"  for = "date_termination" > Date Died </label>
					<div class="col-xs-3">
						<input  type="text"  name="date_died" id="date_died" placeholder="Date Died"  class="form-control " value=" <?php if(validation_errors() != false) { echo set_value('date_died'); } else { echo isset($ccmdata['date_died']) ? date('d-m-Y', strtotime($ccmdata['date_died'])) : ''; } ?>"/>
					</div>
					</div>
					...
					<div class="col-xs-3">
						<input  type="text"  name="date_transfer" id="date_transfer" placeholder="Date Transfered"  class="form-control " value=" <?php if(validation_errors() != false) { echo set_value('date_transfer'); } else { echo isset($ccmdata['date_transfer']) ? date('d-m-Y', strtotime($ccmdata['date_transfer'])) : ''; } ?>"/>
					</div>
					</div>
                     </div>
</div>
	...
	<div class="form-group">
           ...
           <div class="col-xs-3">
		    <input type="text"  name="basic_training_start_date" id="basic_training_start_date" placeholder="Basic Training Start Date"  value=" <?php if(validation_errors() != false) { echo set_value('basic_training_start_date'); } else { echo isset($ccmdata['basic_training_start_date']) ? date('d-m-Y', strtotime($ccmdata['basic_training_start_date'])) : ''; } ?>"  class="form-control "/>
            </div>
           <div class="col-xs-3">
            <input type="text"  name="basic_training_end_date" id="basic_training_end_date" placeholder="Basic Training End Date"  value=" <?php if(validation_errors() != false) { echo set_value('basic_training_end_date'); } else { echo isset($ccmdata['basic_training_end_date']) ? date('d-m-Y', strtotime($ccmdata['basic_training_end_date'])) : ''; } ?>"  class="form-control "/>        </div>
          </div>
		  <div class="row">
           <label class="col-xs-3 col-xs-offset-1 control-label" for="routine_epi"> Routine EPI </label>
           <div class="col-xs-3">
         <input type="text"  name="routine_epi_start_date" id="routine_epi_start_date" placeholder="Routine EPI Training Start Date"  value=" <?php if(validation_errors() != false) { echo set_value('routine_epi_start_date'); } else { echo isset($ccmdata['routine_epi_start_date']) ? date('d-m-Y', strtotime($ccmdata['routine_epi_start_date'])) : ''; } ?>"  class="form-control "/>        </div>
           <div class="col-xs-3">
           <input type="text"  name="routine_epi_end_date" id="routine_epi_end_date" placeholder="Routine EPI Training End Date"  value=" <?php if(validation_errors() != false) { echo set_value('routine_epi_end_date'); } else { echo isset($ccmdata['routine_epi_end_date']) ? date('d-m-Y', strtotime($ccmdata['routine_epi_end_date'])) : ''; } ?>"  class="form-control "/>          </div>
          </div>
		  <div class="row">
           <label class="col-xs-3 col-xs-offset-1 control-label" for="survilance_training_start_date"> Surveillance </label>
           <div class="col-xs-3">
           <input type="text"  name="survilance_training_start_date" id="survilance_training_start_date" placeholder="Survilance Training Start Date"  value=" <?php if(validation_errors() != false) { echo set_value('survilance_training_start_date'); } else { echo isset($ccmdata['survilance_training_start_date']) ? date('d-m-Y', strtotime($ccmdata['survilance_training_start_date'])) : ''; } ?>"  class="form-control "/>        </div>
           <div class="col-xs-3">
            <input type="text"  name="survilance_training_end_date" id="survilance_training_end_date" placeholder="Survilance Training End Date"  value=" <?php if(validation_errors() != false) { echo set_value('survilance_training_end_date'); } else { echo isset($ccmdata['survilance_training_end_date']) ? date('d-m-Y', strtotime($ccmdata['survilance_training_end_date'])) : ''; } ?>"  class="form-control "/>        </div>
          </div>
		  <div class="row">
           <label class="col-xs-3 col-xs-offset-1 control-label" for="cold_chain_training_start_date"> Cold Chain </label>
           <div class="col-xs-3">
          <input type="text"  name="cold_chain_training_start_date" id="cold_chain_training_start_date" placeholder="Cold Chain Training Start Date"  value=" <?php if(validation_errors() != false) { echo set_value('cold_chain_training_start_date'); } else { echo isset($ccmdata['cold_chain_training_start_date']) ? date('d-m-Y', strtotime($ccmdata['cold_chain_training_start_date'])) : ''; } ?>"  class="form-control "/>         </div>
           <div class="col-xs-3">
            <input type="text"  name="cold_chain_training_end_date" id="cold_chain_training_end_date" placeholder="Cold Chain Training End Date"  value=" <?php if(validation_errors() != false) { echo set_value('cold_chain_training_end_date'); } else { echo isset($ccmdata['cold_chain_training_end_date']) ? date('d-m-Y', strtotime($ccmdata['cold_chain_training_end_date'])) : ''; } ?>"  class="form-control "/>         </div>
          </div>
		  <div class="row">
           <label class="col-xs-3 col-xs-offset-1 control-label" for="vlmis_training_start_date"> vLMIS/EPI MIS </label>
           <div class="col-xs-3">
           <input type="text"  name="vlmis_training_start_date" id="vlmis_training_start_date" placeholder="vLMIS Training Start Date"  value=" <?php if(validation_errors() != false) { echo set_value('vlmis_training_start_date'); } else { echo isset($ccmdata['vlmis_training_start_date']) ? date('d-m-Y', strtotime($ccmdata['vlmis_training_start_date'])) : ''; } ?>"  class="form-control "/>         </div>
           <div class="col-xs-3">
            <input type="text"  name="vlmis_training_end_date" id="vlmis_training_end_date" placeholder="vLMIS Training End Date"  value=" <?php if(validation_errors() != false) { echo set_value('vlmis_training_end_date'); } else { echo isset($ccmdata['vlmis_training_end_date']) ? date('d-m-Y', strtotime($ccmdata['vlmis_training_end_date'])) : ''; } ?>"  class="form-control "/>         </div>
          </div>
		  				</div>	
 <div class="row bgrow" style="text-align: center;color: white;font-size: 15px;font-family: Arial;padding-top: 5px;"> Banking Details</div>
  <div class="form-group">
	   <div class="row">
		...
		<div class="col-xs-3">
			  <select id="bankid" required name="bankid" class="form-control" size="1" >
				...
				foreach($resultbank as $row){
				  ?>
				  <option value="<?php echo $row['bankid'];?>"  <?php if($ccmdata['bid'] == $row['bankid'] ){ echo 'selected="selected"'; } else  { echo ''; } ?>  /><?php echo $row['bankcode']."-".$row['bankname'];?>
					<?php
				  }
												?>
			  </select>
		...
		<div class="col-xs-3">
			 <input name="branchcode" id="branchcode" placeholder="Branch Code"  class="form-control " value="<?php if(validation_errors() != false) { echo set_value('branchcode'); } else { echo $ccmdata['branchcode']; } ?>"/><?php echo form_error('branchcode'); ?>
		</div>
		</div>
		<div class="row">
		<label class="col-xs-2 col-xs-offset-1 control-label"  for = "branchname" > Branch Name </label>
		<div class="col-xs-3">
			 <input name="branchname" id="branchname" placeholder="Branch Name"  class="form-control " value="<?php if(validation_errors() != false) { echo set_value('branchname'); } else { echo $ccmdata['branchname']; } ?>"/><?php echo form_error('branchname'); ?>
		</div>
		<label class="col-xs-2 control-label"  for = "bankaccountno" > Bank Account Number  </label>
		<div class="col-xs-3">
			 <input name="bankaccountno" id="bankaccountno" placeholder="Bank Account Number"  class="form-control " value="<?php if(validation_errors() != false) { echo set_value('bankaccountno'); } else { echo $ccmdata['bankaccountno']; } ?>"/><?php echo form_error('bankaccountno'); ?>
		</div>
		</div>
		<div class="row">
		...
		<div class="col-xs-3">
			  <select id="payscale" required name="payscale" class="form-control" size="1" >
						...
						<?php 
						for($i=1;$i<23;$i++){?>
		  <option <?php if($ccmdata['payscale'] == 'BPS-'.$i) { echo "selected='selected'"; }else{} ?> value="<?php echo "BPS-".$i ;?>" <?php echo set_select('payscale',"BPS-".$i); ?> /><?php echo "BPS-".$i ;?>
			  <?php }
						?>
																			  </select>
		</div>
		...
		<div class="col-xs-3">
			<input type="text"  name="basicpay" id="basicpay" placeholder="Basic Pay"  class="form-control " value="<?php if(validation_errors() != false) { echo set_value('basicpay'); } else { echo $ccmdata['basicpay']; } ?>"/><?php echo form_error('basicpay'); ?>
		</div>
		</div>
													</div>
 <hr>
...
$("#status").bind('change', function(){
  ...
  $(document).on('blur','#nic', function(){
   var nic = $(this).val();
   var code = $(ccmcode).val();
	if(nic!=''){
	   $.ajax({ 
		type: 'POST',
		data: 'nic='+nic+'&code='+code,
		url: '<?php echo base_url();?>Ajax_calls/checkCCMNic',
		success: function(data){
		 if(data!=''){
		  if(data=='yes'){
			$('#site_response').css('display','block');
			$('#site_response').css('color','red');
			$('#site_response').html('CNIC Already Exist For Another Cold Chain Mechanic.');
