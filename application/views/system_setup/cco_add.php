...
<div class="container bodycontainer">
 ...
 <!-- <div class="panel-body">
     ...
     <!--<label class="col-xs-2 control-label"   for = "cocode" > Computer Operator Code </label>-->
              <input type="hidden" name="cco_code" id="cco_code" required value="<?php echo set_value('cco_code'); ?>" >
            ...
            <div class="row">
               ...
               <label class="col-xs-2 col-xs-offset-1 control-label"  for = "coname" >Cold Chain Operator Name <span style="color:red;">*</span></label>
               <div class="col-xs-3">
                 <input type="text" required name="cco_name" id="cco_name" placeholder="Cold Chain Operator Name"  class="form-control " value="<?php echo set_value('go_name'); ?>" /> <?php echo form_error('coname'); ?>   </div>
  ...
  <label class="col-xs-2 control-label"  for = "passingyear" > Passing Year </label>
	   ...
	   <div class="row">
		...
		<div class="col-xs-3">
            ...
            <div class="row"><div class="col-xs-11" style="padding:0px; text-align:right;">
