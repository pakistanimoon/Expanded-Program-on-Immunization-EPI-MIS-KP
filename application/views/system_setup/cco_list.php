...
<a href="<?php echo base_url(); ?>Cold-Chain-Operator/Add" class="red-tooltip" data-toggle="tooltip" title="Add New Cold-Chain-Operator">
...
<script type="text/javascript">
 ...
 $(document).ready(function() { 
    ...
    var columns = [
          ...
          { data: "cco_code" ,
            ...
            render : function(data, type, row) {
                return '<a data-original-title="View" href="<?php echo base_url(); ?>Cold-Chain-Operator/View/'+data+'" data-toggle="tooltip" title="" class="btn btn-xs btn-default"><i class="fa fa-search"></i></a><a data-original-title="Edit" href="<?php echo base_url(); ?>Cold-Chain-Operator/Edit/'+data+'" data-toggle="tooltip" title="" class="btn btn-xs btn-default"><i class="fa fa-pencil"></i></a>'
            }  
          }
        ]; 
  <?php } elseif ($_SESSION['utype']=='Manager'){?>
    var columns = [
          ...
          { data: "cco_code" ,
            orderable: false,
            render : function(data, type, row) {
                return '<a data-original-title="View" href="<?php echo base_url(); ?>Cold-Chain-Operator/View/'+data+'" data-toggle="tooltip" title="" class="btn btn-xs btn-default"><i class="fa fa-search"></i></a>'
            }  
          }
        ]; 
  <?php } ?>
  var table = $('#codb-tbl').DataTable({
        ...
        "ajax": {
            url : "<?php echo base_url(); ?>Ajax_calls/cco_dataTables",
            type : 'GET'
        },
        "columns": columns,
        dom: 'lrtips'
