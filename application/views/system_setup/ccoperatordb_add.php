...
<div class="container bodycontainer">
  ...
  <div class="row">
    <div class="panel panel-primary">
     ...
     <div class="panel-heading"> New Cold Chain Operator Form
     </div>
     <div class="panel-body">
       <form name="dataform" id="dataform" action="<?php echo base_url(); ?>System_setup/ccoperatordb_save" method="post" enctype="multipart/form-data" class="form-horizontal form-bordered" onSubmit="">     
     ...
     <!--<label class="col-xs-2 control-label"   for = "ccoperatorcode" > Computer Operator Code </label>
              <input type="hidden" name="ccoperatorcode" id="ccoperatorcode" required value="<?php echo set_value('ccoperatorcode'); ?>" >
              <div class="col-xs-1 cmargin18">
                <input type="text" disabled="disabled"  class="form-control  right" style="text-align: -webkit-right;" id="ccoperatorcodef" value="CO.Code" />
              </div>
                <div class="col-xs-2 cmargin19">
               <input type="text" style=" text-align: -webkit-left;" required name="ccoperatorcodel" id="ccoperatorcodel" placeholder="code"  class="form-control " value="<?php echo set_value('ccoperatorcodel'); ?>"/>
               </div>-->
            ...
            <div class="row">
               ...
               <label class="col-xs-2 col-xs-offset-1 control-label"  for = "ccoperatorname" > CC Operator Name </label>
               <div class="col-xs-3">
                 <input type="text" required name="ccoperatorname" id="ccoperatorname" placeholder="Computer Operator Name"  class="form-control " value="<?php echo set_value('ccoperatorname'); ?>" /> <?php echo form_error('ccoperatorname'); ?>   </div>
             ...
             <div class="row bgrow" style="text-align: center;color: white;font-size: 15px; font-family: Arial;padding-top: 5px; "> Basic Information</div>
              ...
              <div class="row">
               ...
               <label class="col-xs-2 col-xs-offset-1 control-label"  for = "date_of_birth" >Date Of Birth </label>
                <div class="col-xs-3">
                  <input type="text"  name="date_of_birth" id="date_of_birth" placeholder="Date Of Birth"  class="form-control " value="<?php echo set_value('date_of_birth'); ?>"/>
                </div>
               
               <label class="col-xs-2 control-label"  for = "nic" > CNIC # </label>
                  <div class="col-xs-3">
                     <input required name="nic" id="nic" placeholder="Enter Your CNIC #"  class="form-control " value="<?php echo set_value('nic'); ?>"/><span id="site_response"></span>
                  </div>
               ...
               <label class="col-xs-2 col-xs-offset-1 control-label"  for = "permanent_address" > Permanent Address </label>
                <div class="col-xs-3">
                  <input type="text" required name="  permanent_address" id="permanent_address" placeholder="Permanent Address"  class="form-control " value="<?php echo set_value('permanent_address'); ?>"/>
                </div>
                 <label class="col-xs-2 control-label"  for = "present_address" > Present Address </label>
                <div class="col-xs-3">
                  <input type="text" required name="  present_address" id="present_address" placeholder="Present Address"  class="form-control " value="<?php echo set_value('present_address'); ?>"/>
                </div>
               ...
               <div class="row">
                ...
                <div class="col-xs-3">
                  <input type="text" required name="postalcode" id="postalcode" placeholder="Postal Code"  class="form-control " value="<?php echo set_value('postalcode'); ?>"/>
                </div>
                <label class="col-xs-2 control-label"  for = "present_address" > City </label>
                  <div class="col-xs-3">
                    <input type="text" required name="city" id="city" placeholder="City"  class="form-control " value="<?php echo set_value('city'); ?>"/>
                  </div>
               ...
               <div class="row">
                ...
                <div class="col-xs-3">
                  <input type="text" required name="phone" id="phone" placeholder="Phone"  class="form-control " value="<?php echo set_value('phone'); ?>"/><?php echo form_error('phone'); ?>
                </div>
                ...
                <div class="col-xs-3">
        					<select id="marital_status" name="marital_status" class="form-control" size="1" >
        						...
        						<option value="Un Married" <?php echo set_select('marital_status', 'Un Married'); ?>>Un Married</option>
		...
		<div class="col-xs-3">
            ...
            <div class="row">
             <div class="col-xs-7" style="margin-left:62.5%">
               ...
               <a href="<?php echo base_url();?>System_setup/ccoperatordb_list" class="btn btn-md btn-success"><i class="fa fa-times"></i> Cancel </a>
...
<script type="text/javascript">
  ...
  $(document).on('blur','#nic', function(){
    ...
    success: function(data){
     if(data!=''){
      if(data=='yes'){
        ...
        $("#site_response").html('CNIC Already Exist For Another Computer Operator.');
	...
	$(document).ready(function() {    
    $('#ccoperatorname, #fathername, #permanent_address, #present_address, #branchname').on('keyup', function(event) {
        var $this = $(this),
            val = $this.val();
