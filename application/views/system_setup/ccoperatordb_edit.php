          ...
          <div class="form-group">
                <div class="row">
                      ...
                      <div class="col-xs-3 cmargin5">
                        ...
                        <!--<label class="col-xs-2 control-label"   for = "cocode" >Computer Operator Code  </label>
                      <div class="col-xs-3 cmargin5">
                        <span> <?php echo $codata['ccoperatorcode'];?> </span>
                        <input type="hidden" required name="cocode" id="cocode" placeholder="AS Code"  value="<?php echo $codata['ccoperatorcode'];?>"  class="form-control "/>
                      </div>-->
                    </div>
                    <div class="row">
                        <label class="col-xs-2 col-xs-offset-1 control-label"  for = "ccoperatorname" > CC Operator Name </label>
                      <div class="col-xs-3">
                       <input type="text" required name="ccoperatorname" id="ccoperatorname" placeholder="Computer Operator Name"  value="<?php if(validation_errors() != false) { echo set_value('ccoperatorname'); } else { echo $codata['ccoperatorname']; } ?>"  class="form-control "/><?php echo form_error('ccoperatorname'); ?>
                      </div>
             ...
             <label class="col-xs-2 col-xs-offset-1 control-label"  for = "fathername" > Date Of Birth</label>
                ...
                <div class="row">
                  ...
                  <div class="col-xs-3">
                    <input type="text" required name="present_address" id="present_address" placeholder=" Present Address"  value="<?php if(validation_errors() != false) { echo set_value('present_address'); } else { echo $codata['present_address']; } ?>"  class="form-control "/>
                  </div>
                </div>
                <div class="row">
                ...
                <div class="row">
                  ...
                  <div class="col-xs-3">
                    <input type="text"  name="phone" id="phone" placeholder="Phone"  value="<?php if(validation_errors() != false) { echo set_value('phone'); } else { echo $codata['phone']; } ?>"  class="form-control "/><?php echo form_error('phone'); ?>
                  </div>    
                ...
                <div class="row">
                  ...
                  <div class="col-xs-3">
                    <select name="lastqualification" id="lastqualification" class="form-control"> 
                      ...
                      <option <?php if($codata['lastqualification'] == 'BA') { echo 'selected="selected"'; }else echo ''; ?> value="BA">B.A/B.Sc/B.Ed</option>
                      <option <?php if($codata['lastqualification'] == 'MA') { echo 'selected="selected"'; }else echo ''; ?> value="MA">M.A/M.Sc/M.Ed</option>
              ...
              <div class="row">
			   <label class="col-xs-2 col-xs-offset-1 control-label"  for = "asname" > Institute Name </label>
                <div class="col-xs-3">
                  <input type="text" required name="institutename" id="institutename" placeholder="Institute Name"  value="<?php if(validation_errors() != false) { echo set_value('institutename'); } else { echo $codata['institutename']; } ?>"  class="form-control "/>
                </div>
