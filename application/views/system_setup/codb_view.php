...
<div class="row">
    ...
    <?php if(!$this->uri->segment(4)){ ?>
      <ol class="breadcrumb">
        ...
        <?php }?> 
      <div class="panel-heading"> Computer Operator Details
        </div>
         <div class="panel-body">
 <form  class="form-horizontal form-bordered" action="<?php echo base_url(); ?>System_setup/codb_edit">
                <div class="form-group">
                  <div class="row">
                    ...
                    <div class="row">
                      ...
                      <div class="col-xs-2 col-xs-offset-2 cmargin5">
                        <span> <?php echo $codata['coname'];?> </span>
                      </div>
                     <div class="col-xs-2 col-xs-offset-1">
		 ...
		 <div class="row bgrow" style="text-align: center;color: white;font-size: 15px; font-family: Arial;padding-top: 5px; "> Address and Qualification</div>
          ...
          <div class="row bgrow " style="text-align: center;color: white;font-size: 15px;font-family: Arial;padding-top: 5px;"> Joining Details</div>
           ...
           <div class="col-xs-3">
             <p style="padding-left: 197px; padding-top: 8px;"><?php echo isset($codata['basic_training_start_date'])? date('d-m-Y', strtotime($codata['basic_training_start_date'])) : '';?></p>          </div>
           <div class="col-xs-3">
            <p style="padding-left: 202px; padding-top: 8px;"><?php echo isset($codata['basic_training_end_date'])? date('d-m-Y', strtotime($codata['basic_training_end_date'])) : '';?></p>        </div>
          </div>
		  <div class="row">
           <label class="col-xs-3 col-xs-offset-1 control-label" for="routine_epi"> Routine EPI </label>
           <div class="col-xs-3">
            <p style="padding-left: 197px; padding-top: 8px;"><?php echo isset($codata['routine_epi_start_date'])? date('d-m-Y', strtotime($codata['routine_epi_start_date'])) : '';?></p>          </div>
           <div class="col-xs-3">
           <p style="padding-left: 202px; padding-top: 8px;"><?php echo isset($codata['routine_epi_end_date'])? date('d-m-Y', strtotime($codata['routine_epi_end_date'])) : '';?></p>          </div>
          </div>
		  <div class="row">
           <label class="col-xs-3 col-xs-offset-1 control-label" for="survilance"> Surveillance </label> 
           <div class="col-xs-3">
            <p style="padding-left: 197px; padding-top: 8px;"><?php echo isset($codata['survilance_training_start_date'])? date('d-m-Y', strtotime($codata['survilance_training_start_date'])) : '';?></p>         </div>
           <div class="col-xs-3">
             <p style="padding-left: 202px; padding-top: 8px;"><?php echo isset($codata['survilance_training_end_date'])? date('d-m-Y', strtotime($codata['survilance_training_end_date'])) : '';?></p>         </div>
          </div>
		  <div class="row">
           <label class="col-xs-3 col-xs-offset-1 control-label" for="cold_chain"> Cold Chain </label>
           <div class="col-xs-3">
            <p style="padding-left: 197px; padding-top: 8px;"><?php echo isset($codata['cold_chain_training_start_date'])? date('d-m-Y', strtotime($codata['cold_chain_training_start_date'])) : '';?></p>          </div>
           <div class="col-xs-3">
           <p style="padding-left: 202px; padding-top: 8px;"><?php echo isset($codata['cold_chain_training_end_date'])? date('d-m-Y', strtotime($codata['cold_chain_training_end_date'])) : '';?></p>          </div>
          </div>
		  <div class="row">
           <label class="col-xs-3 col-xs-offset-1 control-label" for="vlmis"> vLMIS/EPI-MIS </label>
           <div class="col-xs-3">
            <p style="padding-left: 197px; padding-top: 8px;"><?php echo isset($codata['vlmis_training_start_date'])? date('d-m-Y', strtotime($codata['vlmis_training_start_date'])) : '';?></p>       </div>
           <div class="col-xs-3">
            <p style="padding-left: 202px; padding-top: 8px;"><?php echo isset($codata['vlmis_training_end_date'])? date('d-m-Y', strtotime($codata['vlmis_training_end_date'])) : '';?></p>       </div>
        </div>
		  <!--<div class="row">
           <label class="col-xs-3 control-label" for="epimis"> EPI-MIS </label>
           <div class="col-xs-3">
           <p style="padding-left: 197px; padding-top: 8px;"><?php echo isset($codata['epimis_training_start_date'])? date('d-m-Y', strtotime($codata['epimis_training_start_date'])) : '';?></p>          </div>
           <div class="col-xs-3">
            <p style="padding-left: 202px; padding-top: 8px;"><?php echo isset($codata['epimis_training_end_date'])? date('d-m-Y', strtotime($codata['epimis_training_end_date'])) : '';?></p>      </div>
          </div>-->
				</div>	
               ...
               <?php if (($_SESSION['UserLevel']=='3') && ($_SESSION['utype']=='DEO')){?>
                  <div class="row">
                             <div class="col-xs-4 col-xs-offset-8">
                               ...
                               <a href=" <?php echo base_url(); ?>Computer-Operator/Edit/<?php echo $codata['cocode']; ?>" class="btn btn-md btn-success "><i class="fa fa-pencil-square-o"></i> Update </a>
                                <a href="<?php echo base_url(); ?>Computer-Operator-List" type="reset" class="btn btn-md btn-success "><i class="fa fa-arrow-left"></i> Back </a>
                            
                </div>  <input type="hidden" name="cocode" value="<?php echo  $codata['cocode']?>" />
              </div>
              <?php }?>
