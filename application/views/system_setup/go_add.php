...
<div class="container bodycontainer">
  ...
  <div class="row">
    <div class="panel panel-primary">
     ...
     <div class="panel-heading"> New Generator Operator Form
     </div>
          <div class="panel-body">
       <form name="dataform" id="dataform" action="<?php echo base_url(); ?>System_setup/go_save" method="post" enctype="multipart/form-data" class="form-horizontal form-bordered" onSubmit="">     
 ...
 <!-- <div class="panel-body">
     ...
     <!--<label class="col-xs-2 control-label"   for = "cocode" > Computer Operator Code </label>-->
              <input type="hidden" name="go_code" id="go_code" required value="<?php echo set_value('go_code'); ?>" >
              <div class="col-xs-1 cmargin18">
               ...
               <input type="hidden" style=" text-align: -webkit-left;" required name="cocodel" id="cocodel" placeholder="code"  class="form-control " value="<?php echo set_value('cocodel'); ?>"/>
               </div>
            ...
            <div class="row">
               ...
               <label class="col-xs-2 col-xs-offset-1 control-label"  for = "coname" >Generator Operator Name <span style="color:red;">*</span></label>
               <div class="col-xs-3">
                 <input type="text" required name="go_name" id="go_name" placeholder="Generator Operator Name"  class="form-control " value="<?php echo set_value('go_name'); ?>" /> <?php echo form_error('coname'); ?>   </div>
...
//$('#distcode').on('change' , function (){
  ...
  $('#cocodel').val('');
  $('#cocodef').val(distcode);
  
  $.ajax({
    type: "GET",
    data: "distcodego="+distcode,
    async: false,
    url: "<?php echo base_url(); ?>Ajax_calls/checkCodes",
    success: function(result){
...
<script type="text/javascript">
  ...
  $(document).on('blur','#nic', function(){
    ...
    $.ajax({ 
      type: 'POST',
      data: "nic="+nic,
      url: '<?php echo base_url();?>Ajax_calls/checkgoNIC',
    ...
    success: function(data){
     if(data!=''){
      if(data=='yes'){
        ...
        $("#site_response").html('CNIC Already Exist For Another Generator Operator.');
