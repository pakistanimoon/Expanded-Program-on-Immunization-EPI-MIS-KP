...
<?php if($this -> session -> flashdata('message')){  ?><div class="alert alert-success text-center" role="alert"><strong><?php echo $this -> session -> flashdata('message'); ?></strong></div> <?php } ?>
    <div class="panel panel-primary">
      ...
      <div class="panel-heading"> List of Measles Focal Person
        </div>
...
<table id="mfpdb-tbl" class="table table-bordered table-hover table-striped footable table-vcenter tbl-listing" data-filter="#filter" data-filter-text-only="true">
            <thead>
              <tr>
  ...
  <?php
      ...
      foreach($results as $row){
        ...
        <tr class="DrilledDown">
          ...
          <td class="text-left" ><?php echo $row['mfpname']; ?></td>
        ...
        <?php if ($_SESSION['UserLevel']=='3'  || $_SESSION['utype']=='DEO'){?>
          <td class="text-center">
                      <a data-original-title="View" href="<?php echo base_url(); ?>Measles-Focal-Person/View/<?php echo $row['mfpcode']; ?>" data-toggle="tooltip" title="" class="btn btn-xs btn-default"><i class="fa fa-search"></i></a>
                      <a data-original-title="Edit" href="<?php echo base_url(); ?>Measles-Focal-Person/Edit/<?php echo $row['mfpcode']; ?>" data-toggle="tooltip" title="" class="btn btn-xs btn-default"><i class="fa fa-pencil"></i></a>
...
<script type="text/javascript">
 ...
 $(document).ready(function() { 
    ...
    var columns = [
          ...
          { data: "mfpcode" ,
            ...
            render : function(data, type, row) {
				...
				{					
				 return '<a data-original-title="View" href="<?php echo base_url(); ?>Measles-Focal-Person/View/'+data+'" data-toggle="tooltip" title="" class="btn btn-xs btn-default"><i class="fa fa-search"></i></a>'
          
				}else{
				
                return '<a data-original-title="View" href="<?php echo base_url(); ?>Measles-Focal-Person/View/'+data+'" data-toggle="tooltip" title="" class="btn btn-xs btn-default"><i class="fa fa-search"></i></a><a data-original-title="Edit" href="<?php echo base_url(); ?>Measles-Focal-Person/Edit/'+data+'" data-toggle="tooltip" title="" class="btn btn-xs btn-default"><i class="fa fa-pencil"></i></a>'
				}
			}  
          }
        ]; 
  ...
  var table = $('#mfpdb-tbl').DataTable({
        ...
        "ajax": {
            url : "<?php echo base_url(); ?>Ajax_calls/mfp_dataTables",
            type : 'GET'
        },
        "columns": columns,
        dom: 'lrtips'
