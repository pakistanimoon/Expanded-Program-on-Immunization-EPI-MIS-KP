    ...
    <tr>
      ...
      <?php if (($_SESSION['UserLevel']=='3') && ($_SESSION['utype']=='DEO')){ ?>
        <th class="text-center Heading" style="width:50px;">
           <a href="<?php echo base_url(); ?>Supervisor/Add" class="red-tooltip" data-toggle="tooltip" title="Add New Supervisor">
            <i class="fa fa-plus"></i> <p style="color:white;">Add New</p>
          </a>
        </th>
      <?php }?>
