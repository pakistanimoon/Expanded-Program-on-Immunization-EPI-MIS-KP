...
<div class="row">
                  ...
                  <div class="col-xs-3">
                    <select id="status" name="status" class="form-control" size="1" >
                      ...
                      <option <?php if($techniciandata['status'] == 'Active') { echo 'selected="selected"'; } else { echo ''; } ?> value="Active">Active</option>
                       ...
                       <option <?php if($techniciandata['status'] == 'Resigned') { echo 'selected="selected"'; } else { echo ''; } ?>  value="Resigned">Resigned</option>
 ...
 <div class="row">
					...
					<div class="col-xs-3">
						<input  type="text"  name="date_resigned" id="date_resigned" placeholder="Date Resigned"  class="form-control " value="<?php if(validation_errors() != false) { echo set_value('date_resigned'); } else { echo isset($techniciandata['date_resigned']) ? date('d-m-Y', strtotime($techniciandata['date_resigned'])) : ''; } ?>"/>
					</div>
					</div>
