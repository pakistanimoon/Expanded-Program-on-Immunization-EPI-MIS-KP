...
<div class="container bodycontainer">
 ...
 <!-- <div class="panel-body">
     ...
     <!--<label class="col-xs-2 control-label"   for = "cocode" > Computer Operator Code </label>-->
              <input type="hidden" name="ccm_code" id="ccm_code" required value="<?php echo set_value('cocode'); ?>" >
            ...
            <div class="row">
               ...
               <label class="col-xs-2 col-xs-offset-1 control-label"  for = "ccm_name" > Mechanic Name <span style="color:red;">*</span></label>
               <div class="col-xs-3">
                 <input type="text" required name="ccm_name" id="ccm_name" placeholder="Cold Chain Mechanic Name"  class="form-control " value="<?php echo set_value('coname'); ?>" /> <?php echo form_error('coname'); ?>   </div>
...
<script type="text/javascript">
  ...
  $(document).on('blur','#nic', function(){
    ...
    $.ajax({ 
      type: 'POST',
      data: "nic="+nic,
      url: '<?php echo base_url();?>Ajax_calls/checkCc_mechanic_NIC',
