...
<div class="container bodycontainer">
  ...
  <div class="row">
    <div class="panel panel-primary">
     ...
     <div class="panel-heading"> New Cold Chain Technician Form
     </div>
 ...
 <!-- <div class="panel-body">
     ...
     <!--<label class="col-xs-2 control-label"   for = "cocode" > Computer Operator Code </label>-->
              <input type="hidden" name="cc_techniciancode" id="cc_techniciancode" required value="<?php echo set_value('cc_techniciancode'); ?>" >
            ...
            <div class="row">
               ...
               <label class="col-xs-2 col-xs-offset-1 control-label"  for = "coname" >CC Technician Name <span style="color:red;">*</span></label>
               <div class="col-xs-3">
                 <input type="text" required name="cc_technicianname" id="cc_technicianname" placeholder="Cold Chain Technician Name"  class="form-control " value="<?php echo set_value('cc_technicianname'); ?>" /> <?php echo form_error('cc_technicianname'); ?>   </div>
    ...
    success: function(data){
     if(data!=''){
      if(data=='yes'){
        ...
        $("#site_response").html('CNIC Already Exist For Another CC Technician.');
