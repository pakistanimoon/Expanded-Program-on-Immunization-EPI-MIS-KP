...
<a href="<?php echo base_url(); ?>Cold-Chain-Technician/Add" class="red-tooltip" data-toggle="tooltip" title="Add New Cold Chain Technician">
 ...
 $(document).ready(function() { 
  ...
  <?php if (($_SESSION['UserLevel']=='3') && ($_SESSION['utype']=='DEO')){?>
    var columns = [
          ...
          { data: "status" },
          { data: "is_temp_saved" },
          { data: "cc_techniciancode" ,
            orderable: false,
            render : function(data, type, row) {
                return '<a data-original-title="View" href="<?php echo base_url(); ?>Cold-Chain-Technician/View/'+data+'" data-toggle="tooltip" title="" class="btn btn-xs btn-default"><i class="fa fa-search"></i></a><a data-original-title="Edit" href="<?php echo base_url(); ?>Cold-Chain-Technician/Edit/'+data+'" data-toggle="tooltip" title="" class="btn btn-xs btn-default"><i class="fa fa-pencil"></i></a>'
            }  
          }
        ]; 
  <?php } elseif ($_SESSION['utype']=='Manager'){?>
    var columns = [
          ...
          { data: "cc_techniciancode" ,
            orderable: false,
            render : function(data, type, row) {
                return '<a data-original-title="View" href="<?php echo base_url(); ?>Cold-Chain-Technician/View/'+data+'" data-toggle="tooltip" title="" class="btn btn-xs btn-default"><i class="fa fa-search"></i></a>'
            }  
          }
        ]; 
  <?php } ?>
  var table = $('#codb-tbl').DataTable({
        ...
        "ajax": {
            url : "<?php echo base_url(); ?>Ajax_calls/cc_tech_dataTables",
            type : 'GET'
        },
        "columns": columns,
        dom: 'lrtips'
