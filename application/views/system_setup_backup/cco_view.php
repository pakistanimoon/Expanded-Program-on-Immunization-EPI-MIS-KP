                ...
                <div class="form-group">
                  <div class="row">
                    ...
                    <div class="row">
                      ...
                      <div class="col-xs-2 col-xs-offset-2 cmargin5">
                        <span> <?php echo $codata['cco_name'];?> </span>
                      </div>
                     <div class="col-xs-2 col-xs-offset-1">
               ...
               <?php if (($_SESSION['UserLevel']=='3') && ($_SESSION['utype']=='DEO')){?>
                  <div class="row">
                             <div class="col-xs-4 col-xs-offset-8">
                               ...
                               <a href=" <?php echo base_url(); ?>Cold-Chain-Operator/Edit/<?php echo $codata['cco_code']; ?>" class="btn btn-md btn-success "><i class="fa fa-pencil-square-o"></i> Update </a>
                                <a href="<?php echo base_url(); ?>Cold-Chain-Operator/List" type="reset" class="btn btn-md btn-success "><i class="fa fa-arrow-left"></i> Back </a>
                            
                </div>  <input type="hidden" name="cocode" value="<?php echo  $codata['cco_code']?>" />
              </div>
              <?php }?>
