...
<div class="row">
    ...
    <?php if(!$this->uri->segment(4)){ ?>
      <ol class="breadcrumb">
        ...
        <?php }?> 
      <div class="panel-heading"> Cold Chain Operator Details
        </div>
         <div class="panel-body">
        <form  class="form-horizontal form-bordered" action="<?php echo base_url(); ?>System_setup/ccoperatordb_edit">
                <div class="form-group">
                  <div class="row">
                    ...
                    <div class="row">
                        <label class="col-xs-2 col-xs-offset-1 control-label"  for = "bankbranch" > CC Operator Name </label>
                      <div class="col-xs-2 col-xs-offset-2 cmargin5">
                        <span> <?php echo $codata['ccoperatorname'];?> </span>
                      </div>
                     <div class="col-xs-2 col-xs-offset-1">
         ...
         <div class="row bgrow " style="text-align: center;color: white;font-size: 15px;font-family: Arial;padding-top: 5px;"> Joining Details</div>
              <div class="form-group">
                ...
                <div class="row">
                 <div class="col-xs-2 col-xs-offset-1">
                <label class="control-label"  for = "lhscode" > Employee Type</label>
                </div>
                <div class="col-xs-2 cmargin5">
              ...
              <div class="form-group">
               ...
               <?php if (($_SESSION['UserLevel']=='2') && ($_SESSION['utype']=='Manager') ){?>
                  <div class="row">
                            ...
                            <?php if(!$this->uri->segment(4)){ ?>
                               <a href=" <?php echo base_url(); ?>System_setup/ccoperatordb_edit/<?php echo $codata['c_id']; ?>" class="btn btn-md btn-success "><i class="fa fa-pencil-square-o"></i> Update </a>
                                <a href="<?php echo base_url(); ?>System_setup/ccoperatordb_list" type="reset" class="btn btn-md btn-success "><i class="fa fa-arrow-left"></i> Back </a>
                            <?php }?>
                </div>  <input type="hidden" name="c_id" value="<?php echo  $codata['c_id']?>" />
              </div>
              <?php }?>
            </div>
      </form>
