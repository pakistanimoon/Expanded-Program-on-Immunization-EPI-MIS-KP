...
<div class="container bodycontainer">
  ...
  <div class="row">
    <div class="panel panel-primary">
     ...
     <div class="panel-heading"> New Computer Operator Form
     </div>
 ...
 <!-- <div class="panel-body">
     ...
     <!--<label class="col-xs-2 control-label"   for = "cocode" > Computer Operator Code </label>-->
              <input type="hidden" name="cocode" id="cocode" required value="<?php echo set_value('cocode'); ?>" >
            ...
            <div class="row">
               ...
               <label class="col-xs-2 col-xs-offset-1 control-label"  for = "coname" > Computer Operator Name <span style="color:red;">*</span></label>
               <div class="col-xs-3">
                 <input type="text" required name="coname" id="coname" placeholder="Computer Operator Name"  class="form-control " value="<?php echo set_value('coname'); ?>" /> <?php echo form_error('coname'); ?>   </div>
