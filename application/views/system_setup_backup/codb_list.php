...
<?php if($this -> session -> flashdata('message')){  ?><div class="alert alert-success text-center" role="alert"><strong><?php echo $this -> session -> flashdata('message'); ?></strong></div> <?php } ?>
    <div class="panel panel-primary">
      ...
      <div class="panel-heading"> List of Computer Operator
        </div>
...
<table id="codb-tbl" class="table table-bordered table-hover table-striped footable table-vcenter tbl-listing" data-filter="#filter" data-filter-text-only="true">
            ...
            <?php if ($_SESSION['UserLevel']=='3' && $utype=='DEO' ){?> 
                <th class="text-center Heading"  style="width:100px;">
                    <a href="<?php echo base_url(); ?>Computer-Operator/Add" class="red-tooltip" data-toggle="tooltip" title="Add New Computer-Operator">
...
<script type="text/javascript">
 ...
 $(document).ready(function() { 
    ...
    var columns = [
          ...
          { data: "cocode" ,
            ...
            render : function(data, type, row) {
				...
				{					
				 return '<a data-original-title="View" href="<?php echo base_url(); ?>Computer-Operator/View/'+data+'" data-toggle="tooltip" title="" class="btn btn-xs btn-default"><i class="fa fa-search"></i></a>'
          
				}else{
				
                return '<a data-original-title="View" href="<?php echo base_url(); ?>Computer-Operator/View/'+data+'" data-toggle="tooltip" title="" class="btn btn-xs btn-default"><i class="fa fa-search"></i></a><a data-original-title="Edit" href="<?php echo base_url(); ?>Computer-Operator/Edit/'+data+'" data-toggle="tooltip" title="" class="btn btn-xs btn-default"><i class="fa fa-pencil"></i></a>'
				}
			}  
          }
        ]; 
  ...
  var table = $('#codb-tbl').DataTable({
        ...
        "ajax": {
            url : "<?php echo base_url(); ?>Ajax_calls/co_dataTables",
            type : 'GET'
        },
        "columns": columns,
        dom: 'lrtips'
