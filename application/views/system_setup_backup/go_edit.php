...
<div class="container bodycontainer">
  <div class="row">
    <div class="panel panel-primary">
     ...
     <div class="panel-heading"> Update Generator Operator Form
     </div>
   ...
   <div class="form-group">
                <div class="row">
                      ...
                      <div class="col-xs-3 cmargin5">
                        ...
                        <label type="hidden" hidden class="control-label"  for = "cocode" >Generator Operator Code  </label>
                      <div class="col-xs-3 cmargin5">
                       <label type="hidden" hidden class="col-xs-2 control-label"   for = "cocode" ><?php echo $codata['go_code'];?>  </label>
                        <!--<span> <?php echo $codata['go_code'];?> </span>-->
                        <input type="hidden" required name="go_code" id="go_code" placeholder="AS Code"  value="<?php echo $codata['go_code'];?>"  class="form-control "/>
                      </div>
                    </div>
                    <div class="row">
                        <label class="col-xs-2 col-xs-offset-1 control-label"  for = "asname" > Generator Operator Name </label>
                      <div class="col-xs-3">
                       <input type="text" required name="go_name" id="go_name" placeholder="Generator Operator Name"  value="<?php if(validation_errors() != false) { echo set_value('go_name'); } else { echo $codata['go_name']; } ?>"  class="form-control "/><?php echo form_error('go_name'); ?>
                      </div>
            ...
            <div class="row">
             <div class="col-xs-11" style="padding:0px; text-align:right;">
			  ...
			  <!--- <button type="submit" name="is_temp_saved" value="0" class="btn btn-md btn-success bc1" style="margin-left: 0.12%;"><i class="fa fa-floppy-o "></i> Submit </button> --->
               ...
               <a href="<?php echo base_url();?>Generator-Operator/List" class="btn btn-md btn-success"><i class="fa fa-times"></i> Cancel </a>
             </div>
           </div>
         </form>
