...
<div class="row">
    ...
    <?php if(!$this->uri->segment(4)){ ?>
      <ol class="breadcrumb">
        ...
        <?php }?> 
      <div class="panel-heading"> Generator Operator Details
        </div>
 ...
 <form  class="form-horizontal form-bordered" action="<?php echo base_url(); ?>System_setup/codb_edit">
                <div class="form-group">
                  <div class="row">
                    ...
                    <div class="row">
                        <label class="col-xs-2 col-xs-offset-1 control-label"  for = "bankbranch" > Generator Operator Name </label>
                      <div class="col-xs-2 col-xs-offset-2 cmargin5">
                        <span> <?php echo $codata['go_name'];?> </span>
                      </div>
                     <div class="col-xs-2 col-xs-offset-1">
            ...
            <div class="row">
              <div class="col-xs-2 col-xs-offset-1">
                ...
                <div class="col-xs-2 col-xs-offset-2 cmargin5">
                  ...
                  <div class="col-xs-2 col-xs-offset-1">
                <label class="control-label"  for = "lhscode" > Phone</label>
                </div>
                <div class="col-xs-2 cmargin5">
               ...
               <?php if (($_SESSION['UserLevel']=='3') && ($_SESSION['utype']=='DEO')){?>
                  <div class="row">
                             <div class="col-xs-4 col-xs-offset-8">
                               ...
                               <a href=" <?php echo base_url(); ?>Generator-Operator/Edit/<?php echo $codata['go_code']; ?>" class="btn btn-md btn-success "><i class="fa fa-pencil-square-o"></i> Update </a>
                                <a href="<?php echo base_url(); ?>Generator-Operator/List" type="reset" class="btn btn-md btn-success "><i class="fa fa-arrow-left"></i> Back </a>
                            
                </div>  <input type="hidden" name="cocode" value="<?php echo  $codata['go_code']?>" />
              </div>
              <?php }?>
