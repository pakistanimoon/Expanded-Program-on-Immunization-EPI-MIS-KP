...
<div class="row">
    <div class="panel panel-primary">
      ...
      <div class="panel-heading"> Update HF Incharge Form
        </div>
         <div class="panel-body">
 <form id="dataform" action="<?php echo base_url(); ?>System_setup/med_technician_save" method="post" enctype="multipart/form-data" class="form-horizontal form-bordered" onSubmit="">
<input type="hidden" name="previous_code" id="previous_code" value="<?php echo $techniciandata['previous_code']; ?>" />
 ...
 <label class="col-xs-2 col-xs-offset-1 control-label"  for = "distcode" > District </label>
                  ...
                  <div class="col-xs-3">
                    <select id="tcode" required name="tcode" class="form-control" size="1" >
                      ...
                      foreach ($resultTeh as $row){
                        ?>
                        <option <?php if($techniciandata['tcode'] == $row['tcode']){ echo 'selected="selected"'; } else { echo ''; } ?> value="<?php echo $row['tcode'];?>" /><?php echo $row['tehsil']; ?></option>
                        <?php
                      }
                      ?>
                    </select>
          ...
          <div class="row">
		    <label class="col-xs-2 col-xs-offset-1 control-label"  for = "distcode" > Union Council </label>
                  <div class="col-xs-3">
                     <select id="uncode" name="uncode" class="form-control" size="1" >
                              <?php 
                              foreach($resultUnC as $row){
                                ?>
                                <option <?php if($techniciandata['uncode'] == $row['uncode']){ echo 'selected="selected"'; } else { echo ''; } ?> value="<?php echo $row['uncode'];?>" <?php echo set_select('uncode',$row['uncode']); ?>  /><?php echo $row['un_name'];?>
                                  <?php
                                }
                                ?>
                                </select>
				...
				<label class="col-xs-2 control-label" >  Health Facility Name</label>
                  <div class="col-xs-3">
                    <input type="text" disabled="disabled" class="form-control" value="<?php echo $techniciandata['facilityname']; ?>" />
					  <input type="hidden" name="techniciancode" id="techniciancode" value="<?php echo $techniciandata['techniciancode']; ?>" />
                  </div>
                  <!--<label class="col-xs-2 control-label"  for = "lhscode" >  Technician Code </label>
                <div class="col-xs-3">
                <label class="control-label"  for = "techniciancode" ><?php echo $techniciandata['techniciancode']; ?></label>
              ...
              <div class="row">
                <label class="col-xs-2 col-xs-offset-1 control-label"  for = "lhsname" > Incharge Name </label>
                <div class="col-xs-3">
                  <input type="text" required name="  technicianname" id="technicianname" placeholder="Incharge Name"  value="<?php if(validation_errors() != false) { echo set_value('technicianname'); } else { echo $techniciandata['technicianname']; } ?>"  class="form-control "/><?php echo form_error('technicianname'); ?>
                </div>
              ...
              <div class="form-group">
                <div class="row">
                  ...
                  <div class="col-xs-3">
                     <input required name="phone" id="phone" placeholder="Phone Number"  class="form-control " value="<?php if(validation_errors() != false) { echo set_value('phone'); } else { echo $techniciandata['phone']; } ?>"/><?php echo form_error('phone'); ?>
 </div>
                  </div>
                  <div class="row">
...
<div class="row">
                  ...
                  <div class="col-xs-3">
                    <input type="text" required name="  catch_area_name" id="catch_area_name" placeholder="Catchment Area Name"  value="<?php echo $techniciandata['catch_area_name'];?>"  class="form-control "/>
                  </div>
                      <label class="col-xs-2 control-label"  for = "catch_area_pop" > Catchment Area Population </label>
                  <div class="col-xs-3">
                  <input type="number" required name="  catch_area_pop" id="catch_area_pop" placeholder="Catchment Area Population"  value="<?php echo $techniciandata['catch_area_pop'];?>"  class="form-control "/>
                  </div>
                      </div>
 ...
 <div class="form-group">    
              <div class="row">
                  ...
                  <div class="col-xs-3">
                    <input type="text" required name="  permanent_address" id="permanent_address" placeholder="Permanent Address"  value="<?php if(validation_errors() != false) { echo set_value('permanent_address'); } else { echo $techniciandata['permanent_address']; } ?>"  class="form-control "/>
                  </div>
            <label class="col-xs-2 control-label"  for = "present_address" > Present Address </label>
                  <div class="col-xs-3">
                    <input type="text" required name="  present_address" id="present_address" placeholder="Present Address"  value="<?php if(validation_errors() != false) { echo set_value('present_address'); } else { echo $techniciandata['present_address']; } ?>"  class="form-control "/>
                  </div>
                      </div>
                      <div class="row">
                  ...
                  <div class="col-xs-3">
                    <select name="lastqualification" id="lastqualification" class="form-control">
                       <option <?php if($techniciandata['lastqualification'] == 'MBBS') { echo 'selected="selected"'; } else { echo ''; } ?> value="MBBS">MBBS</option>
                      <option <?php if($techniciandata['lastqualification'] == 'MBBS, MPH') { echo 'selected="selected"'; } else { echo ''; } ?> value="MBBS, MPH">MBBS, MPH</option>
                      <option <?php if($techniciandata['lastqualification'] == 'MD') { echo 'selected="selected"'; } else { echo ''; } ?> value="MD">MD</option>
                      <option <?php if($techniciandata['lastqualification'] == 'MD, MPH') { echo 'selected="selected"'; } else { echo ''; } ?> value="MD, MPH">MD, MPH</option>
					  <option <?php if($techniciandata['lastqualification'] == 'Matric') { echo 'selected="selected"'; } else { echo ''; } ?> value="Matric">Matric</option>
					  <option <?php if($techniciandata['lastqualification'] == 'FA') { echo 'selected="selected"'; } else { echo ''; } ?> value="FA">FA</option>
					  <option <?php if($techniciandata['lastqualification'] == 'BA') { echo 'selected="selected"'; } else { echo ''; } ?> value="BA">BA</option>
					  <option <?php if($techniciandata['lastqualification'] == 'MA') { echo 'selected="selected"'; } else { echo ''; } ?> value="MA">MA</option>
					  <option <?php if($techniciandata['lastqualification'] == 'BBA/MBA') { echo 'selected="selected"'; } else { echo ''; } ?> value="BBA/MBA">BBA/MBA</option>
  ...
  <div class="row">
                  ...
                  <div class="col-xs-3">
					...
					<div class="col-xs-3">
						<input  type="text"  name="date_transfer" id="date_transfer" placeholder="Date Transfered"  class="form-control " value="<?php if(validation_errors() != false) { echo set_value('date_transfer'); } else { echo isset($techniciandata['date_transfer']) ? date('d-m-Y', strtotime($techniciandata['date_transfer'])) : ''; } ?>"/>
					</div>
					</div>
