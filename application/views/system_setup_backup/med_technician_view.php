...
<?php if($this -> session -> flashdata('message')){  ?><div class="alert alert-success text-center" role="alert"><strong><?php echo $this -> session -> flashdata('message'); ?></strong></div> <?php } ?>
    ...
    <?php if(!$this->uri->segment(4)){ ?>
      <ol class="breadcrumb">
        ...
        <?php }?> 
      <div class="panel-heading"> HF Incharge Details
        </div>
              ...
              <label class="col-xs-2 col-xs-offset-1"  for = "tcode" > Tehsil </label>
                <div class="col-xs-2 col-xs-offset-1">
                 <p> <?php echo $techniciandata['tehsilname'];?></p>
				     ...
				     <div class="row">
					   <label class="col-xs-2 col-xs-offset-1"  for = "tcode" > Union Council </label>
                <div class="col-xs-2 col-xs-offset-1">
                 <p> <?php echo $techniciandata['unioncouncil'];?></p>
                      </div>
              ...
              <!--<label class="col-xs-2 col-xs-offset-1"  for = "tcode" >  Technician Code </label>
                <div class="col-xs-2 col-xs-offset-1">
                 <p> <?php echo $techniciandata['techniciancode'];?></p>
				    ...
				    <div class="row">
                  <label class="col-xs-2 col-xs-offset-1"  for = "supervisorname" > Incharge Name</label>
                  <div class="col-xs-2 col-xs-offset-1">
            ...
            <p style="padding-left: 202px; padding-top: 8px;"><?php echo isset($techniciandata['epimis_training_end_date'])? date('d-m-Y', strtotime($techniciandata['epimis_training_end_date'])) : '';?></p>      </div>
               ...
               <?php if (($_SESSION['UserLevel']=='3') && ($_SESSION['utype']=='DEO') ){?>
                  <div class="row">
                            ...
                            <?php //if(!$this->uri->segment(4)){ ?>
                               <a href=" <?php echo base_url(); ?>HF-Incharge/Edit/<?php echo $techniciandata['techniciancode']; ?>" class="btn btn-md btn-success "><i class="fa fa-pencil-square-o"></i> Update </a>
                                <a href="<?php echo base_url(); ?>HF-Incharge/List" type="reset" class="btn btn-md btn-success "><i class="fa fa-arrow-left"></i> Back </a>
                            <?php //} ?>
			  ...
			  <?php if (($_SESSION['UserLevel']=='2') && ($_SESSION['utype']=='Manager') ){?>
                 ...
                 <div class="row">
                             <div class="col-xs-4 col-xs-offset-8">
                                <a href="<?php echo base_url(); ?>setup_listing/med_technician_listing" type="reset" class="btn btn-md btn-success "><i class="fa fa-arrow-left"></i> Back </a>
                          </div>
                    </div>
                    <?php }?>
