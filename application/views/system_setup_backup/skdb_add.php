...
<div class="container bodycontainer">
  ...
  <div class="row">
    <div class="panel panel-primary">
     ...
     <div class="panel-heading"> New Store Keeper Form
     </div>
 ...
 <!-- <div class="panel-body">
     ...
     <!--<label class="col-xs-2 control-label"   for = "cocode" > Computer Operator Code </label>-->
              <input type="hidden" name="skcode" id="skcode" required value="<?php echo set_value('skcode'); ?>" >
              <div class="col-xs-1 cmargin18">
               ...
               <input type="hidden" style=" text-align: -webkit-left;" required name="skcodel" id="skcodel" placeholder="code"  class="form-control " value="<?php echo set_value('skcodel'); ?>"/>
               </div>
            ...
            <div class="row">
               ...
               <label class="col-xs-2 col-xs-offset-1 control-label"  for = "skname" >Store Keeper Name <span style="color:red;">*</span></label>
               <div class="col-xs-3">
                 <input type="text" required name="skname" id="skname" placeholder="Store Keeper Name"  class="form-control " value="<?php echo set_value('skname'); ?>" /> <?php echo form_error('skname'); ?>   </div>
              ...
              <div class="row">
               ...
               <label class="col-xs-2 col-xs-offset-1 control-label"  for = "date_of_birth" >Date Of Birth <span style="color:red;">*</span></label>
                <div class="col-xs-3">
                  <input type="text"  name="date_of_birth" id="date_of_birth" placeholder="Date Of Birth" onchange="dop()" class="form-control " value="<?php echo set_value('date_of_birth'); ?>"/>
                </div>
...
//$('#distcode').on('change' , function (){
  ...
  $('#skcodel').val('');
  $('#skcodef').val(distcode);
  
  $.ajax({
    type: "GET",
    data: "distskcode="+distcode,
    async: false,
    url: "<?php echo base_url(); ?>Ajax_calls/checkCodes",
    success: function(result){
