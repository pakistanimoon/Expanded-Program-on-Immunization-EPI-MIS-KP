...
<script type="text/javascript">
	...
	$(document).on('click', '.crdview_grphwrp', function (){
		...
		if(dataId){
			var data = {reportStatus:reportStatus,id:dataId,ajax:true,reportType:reportType,month:month,year:year,map_id:'livefeedleftmap',bar_id:'bar_graph_1',fmonth:fmonth,quarter:quarter,compType:compType,week:week};
		}
		else{
			var data = {reportStatus:reportStatus,id:dataId,ajax:true,reportType:reportType,month:month,year:year,map_id:'livefeedleftmap',bar_id:'bar_graph_1',fmonth:fmonth,quarter:quarter,compType:compType,week:week};
		}
	...
	function eventHandler(e, run, fmonth){
		...
		if(run){
        	var url = '<?php echo base_url(); ?>thematic_maps/ThematicCompliance/UcWiseMapData/'+dataId+'/'+reportType+'/'+year+'/'+month+'/'+quarter+'/'+compType+'/'+week;
