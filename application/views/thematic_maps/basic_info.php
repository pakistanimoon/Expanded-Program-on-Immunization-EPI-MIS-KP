    ...
    $('#container').highcharts('Map', {
		...
		tooltip: {
			...
			formatter: function () {
				...
				return 'District: <b>' + this.point.name + ' (' + this.point.id + ')' + '</b><br> <?php echo $title[$basicInfo]; ?>: <b>' + this.point.value + ' %</b>';
...
function draw_a_new_map(id){
	...
	$.ajax({
		...
		url: "<?php echo base_url(); ?>maps/BasicInfo",
	...
	$('#container1').highcharts('Map', {
		...
		tooltip: {
			...
			formatter: function () {
				...
				return 'UnionCounci: <b>' + this.point.name + ' (' + this.point.id + ')' + '</b><br> <?php echo $title[$basicInfo]; ?>: <b>' + this.point.value + ' %</b>';
