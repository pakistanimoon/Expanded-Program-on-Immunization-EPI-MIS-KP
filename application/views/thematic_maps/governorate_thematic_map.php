				...
				<div class="carview_wraper">
					<ul class="row">
						<?php
							...
							*/
							$cardOne['heading'] 	= "Card 1";
							$cardOne['image'] 		= "chart1.png";
							$cardOne['value'] 		= 1; // For Numeric Values Send value formated in number_format.
							$cardTwo['heading'] 	= "Card 2";
							$cardTwo['image'] 		= "peichart.jpg";
							$cardTwo['value'] 		= 2; // For Numeric Values Send value formated in number_format.
							$cardThree['heading'] 	= "Card 3  ";
							$cardThree['image'] 	= "timely.png";
							$cardThree['value'] 	= 3; // For Percentage Values Send value concatenated with % to be shown in percentage.
							$cardFour['heading'] 	= "Card 4";
							$cardFour['image'] 		= "complince.png";
							$cardFour['value']		= 4; // For Numeric Values Send value formated in number_format.
