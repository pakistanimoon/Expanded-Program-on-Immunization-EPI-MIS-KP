		...
		<div class="row">
			<div class="col-md-6">
				<div class="section-title">
					<span>Monthly Vaccination Coverage Trend</span><strong style="font-size:11px;"><?php echo $distYear ?></strong>
						<div class="pull-right">
							<a style="color:#000000; cursor: pointer;" title="Line View"><span ><i class="icon fa fa-line-chart" id='coverage_monthlyfullyimm-line11'></i></span></a>
							<a style="color:#000000; cursor: pointer;" title="Bar View"><span ><i class="icon fa fa-bar-chart" id='coverage_monthlyfullyimm-bar11'></i></span></a> 
				</div>
				</div>
				<div id="vaccination-coverage-ipv1_ipv2">Your desire result will render here....</div>
			</div>
			<div class="col-md-6">
				<div class="section-title">
					<span>Monthly Vaccination Coverage Trend</span><strong style="font-size:11px;"><?php echo $distYear ?></strong>
				<div class="pull-right">
						<a style="color:#000000; cursor: pointer;" title="Line View"><span ><i class="icon fa fa-line-chart" id='coverage_monthlyfullyimm-line12'></i></span></a>
						<a style="color:#000000; cursor: pointer;" title="Bar View"><span ><i class="icon fa fa-bar-chart" id='coverage_monthlyfullyimm-bar12'></i></span></a> 
					</div>
					</div>
				<div id="vaccination-coverage-tcv">Your desire result will render here....</div>
			</div>
		</div>
	</div>
</div>
...
$(document).ready(function() {
	...
	//ipv
	$("#coverage_monthlyfullyimm-line11").click(function(){
		coverage_monthlyfullyimm11('msline');
	});
	$("#coverage_monthlyfullyimm-bar11").click(function(){
		coverage_monthlyfullyimm11('mscolumn2d');
	});
	$("#coverage_monthlyfullyimm-line11").trigger("click");
	function coverage_monthlyfullyimm11(chartType='mscolumn2d')
	{
		
	FusionCharts.ready(function() {
		var salesChart = new FusionCharts({
			type: chartType,
			renderAt: 'vaccination-coverage-ipv1_ipv2',
			width: '100%',
			height: '350',
			dataFormat: 'json',
			dataSource: {
	...
	//tcv
	$("#coverage_monthlyfullyimm-line12").click(function(){
		coverage_monthlyfullyimm12('msline');
	});
	$("#coverage_monthlyfullyimm-bar12").click(function(){
		coverage_monthlyfullyimm12('mscolumn2d');
	});
	$("#coverage_monthlyfullyimm-line12").trigger("click");
	function coverage_monthlyfullyimm12(chartType='mscolumn2d')
	{
		
	FusionCharts.ready(function() {
		var salesChart = new FusionCharts({
			type: chartType,
			renderAt: 'vaccination-coverage-tcv',
			width: '100%',
			height: '350',
			dataFormat: 'json',
			dataSource: {
