<div class="container-fluid">
	<div style="padding-top:10px">
		<div class="row">
			...
			<div class="col-md-6">
				<div class="section-title">
					<span>Penta 1 – MR 1 Dropout Rate </span><strong style="font-size:11px;"><?php echo $distYear ?></strong>
					<div class="pull-right">
	...
	<div style="padding-top:10px">
		<div class="row">
			<div class="col-md-6">
				<div class="section-title">
					<span>MR 1 - MR 2 Dropout Rate</span><strong style="font-size:11px;"><?php echo $distYear ?></strong>
					<div class="pull-right">
	...
	<div style="padding-top:10px">
		<div class="row">
			<div class="col-md-6">
				<div class="section-title">
					<span>BCG - MR 1 Dropout Rate</span><strong style="font-size:11px;"><?php echo $distYear ?></strong>
					<div class="pull-right">
							<a style="color:#000000; cursor: pointer;" title="Line View"><span ><i class="icon fa fa-line-chart" id='dropout_monthlyfullyimm-line5'></i></span></a>
							<a style="color:#000000; cursor: pointer;" title="Bar View"><span ><i class="icon fa fa-bar-chart" id='dropout_monthlyfullyimm-bar5'></i></span></a> 
							</div>
				</div>
				<div id="uc-dropout-graph5">Your desire result will render here....</div>
			</div>
			<div class="col-md-6">
				<div class="section-title">
					<span>IPV 1 - IPV 2 Dropout Rate</span><strong style="font-size:11px;"><?php echo $distYear ?></strong>
					<div class="pull-right">
							<a style="color:#000000; cursor: pointer;" title="Line View"><span ><i class="icon fa fa-line-chart" id='dropout_monthlyfullyimm-line6'></i></span></a>
							<a style="color:#000000; cursor: pointer;" title="Bar View"><span ><i class="icon fa fa-bar-chart" id='dropout_monthlyfullyimm-bar6'></i></span></a> 
							</div>
				</div>
				<div id="uc-dropout-graph6">Your desire result will render here....</div>
			</div>
		</div>
	</div>
	<div style="padding-top:10px">
...
$(document).ready(function() {
	...
	//bcg and mr1
	$("#dropout_monthlyfullyimm-line5").click(function(){
		coverage_monthlyfullyimm5('msline');
	});
	$("#dropout_monthlyfullyimm-bar5").click(function(){
		coverage_monthlyfullyimm5('mscolumn2d');
	});
	$("#dropout_monthlyfullyimm-line5").trigger("click");
	function coverage_monthlyfullyimm5(chartType='mscolumn2d')
	{	
	FusionCharts.ready(function() {
		var salesChart = new FusionCharts({
			type: chartType,
			renderAt: 'uc-dropout-graph5',
			width: '100%',
			height: '350',
			dataFormat: 'json',
			dataSource: {
			...
			"categories": [{
				"category": [
					<?php foreach($bcg_measles1 as $key => $value){ ?>
					{
						"label": "<?php echo $value['fmonth']; ?>"
					}, 
					<?php } ?>
	...
	//ipv1 and ipv2
	$("#dropout_monthlyfullyimm-line6").click(function(){
		coverage_monthlyfullyimm6('msline');
	});
	$("#dropout_monthlyfullyimm-bar6").click(function(){
		coverage_monthlyfullyimm6('mscolumn2d');
	});
	$("#dropout_monthlyfullyimm-line6").trigger("click");
	function coverage_monthlyfullyimm6(chartType='mscolumn2d')
	{	
	FusionCharts.ready(function() {
		var salesChart = new FusionCharts({
			type: chartType,
			renderAt: 'uc-dropout-graph6',
			width: '100%',
			height: '350',
			dataFormat: 'json',
			dataSource: {
