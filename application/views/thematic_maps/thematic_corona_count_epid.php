	...
	function eventHandler(e, run, fmonth){
		...
		var to_week = 'All';
		 if(run){
			...
			//var url = '<?php echo base_url(); ?>thematic_maps/ThematicCountEPID/onClickUcWiseMapData/'+dataId+'/'+year+'/'+week+'/'+disease+'/'+gender;
			var url = '<?php echo base_url(); ?>thematic_maps/ThematicCoronaCountEPID/onClickUcWiseMapData/'+dataId+'/'+year+'/'+from_week+'/'+to_week+'/'+disease+'/'+gender;
			window.open(url, '_blank');
		}else{
