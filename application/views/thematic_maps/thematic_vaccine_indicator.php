...
<script type="text/javascript">
	...
	function eventHandler(e, run, fmonth){
		...
		var gender = 'Both';
		 if(run){
			...
			var data = {uncode:dataId,vaccineId:vacc_ind,reportType:reportType,month:month,year:year,gender_wise:gender,fmonth:fmonth,quarter:quarter,vaccineBy:vaccineBy};
	...
	function getDistrictWiseData(e, fmonth){
		...
		var code="";
		if(dataId.length==3){
			var data = {distcode:dataId,vaccineId:vacc_ind,reportType:reportType,month:month,year:year,gender_wise:gender,fmonth:fmonth,quarter:quarter,vaccineBy:vaccineBy};
		}
