  		...
  		<div class="panel panel-primary"> 
    		...
    		<div class="panel-heading">EPI-MIS | Create Menu Form</div>
  	   		    <div class="panel-body">
    	   		    <form name="dataform" id="dataform" action="<?php echo base_url();?>User_menu/update_menu" method="post" enctype="multipart/form-data" class="form-horizontal form-bordered" onSubmit="">
			    		<div class="row">
			    		   <div class="form-group">
						   	<label class="col-xs-2 control-label col-md-offset-1" for = "menu_item" >Menu Title</label>
								   ...
								   <input required name="menu_item" id="menu_item" placeholder="Menu Title"  class="form-control " value=""/>
								   <?php echo form_error('menu_item'); ?>
							  	</div>
								  <label class="col-xs-2 control-label" for = "menu_url" >Menu Url</label>
							  	<div class="col-xs-3">
									<input required name="menu_url" id="menu_url" placeholder="Menu Url"  class="form-control " value=""/>
						...
						<div class="row">
						  	<div class="form-group">
							  	...
							  	<div class="col-xs-3 unameUC">
									<input name="menu_icon" id="menu_icon" placeholder="Menu Icon"  class="form-control " value=""/>
							  	</div> 
...
<!-- JavaScript code for getting menu in tree structure.. !-->
...
<!-- JavaScript code for getting users in tree structure.. !-->
<script type="text/javascript">
function cluster()
{
	var checked_ids = new Array();
