...
foreach($tabledata as $row){
	...
	if($row['data_source']=='web'){
		//<a href="'.base_url().'vaccination/edit/'.$row['fmonth'].'/'.$row['facode'].'" data-toggle="tooltip" title="Edit" class="btn btn-xs btn-default"><i class="fa fa-pencil"></i></a>
		$edit_del='<a  data-toggle="tooltip" title="Delete" onclick ="consumptiondelcst(this)" class="btn btn-xs btn-default"><i class="fa fa-close"></i></a>';	
	}
