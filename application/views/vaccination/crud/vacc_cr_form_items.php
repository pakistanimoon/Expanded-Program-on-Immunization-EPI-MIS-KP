	...
	if($previtemname == $moonitemname){
		...
		if($singleVacc["item_id"] == "6"){
			...
			foreach($vaccinatedcells as $moonind=>$value){
				...
				$childvaccinatedcell .= '
					<td class="'.$sectionclass.' '.(($singleVacc["item_category_id"]!=1)?'mergedvaccinatedcells':'').'" '.(($singleVacc["item_category_id"]!=1)?'colspan = "78"':'').'>
						<input class="'.(($value=='iutd1' || $value=='iutd2' || $value=='iutd3') ? "form-control numberclass dotcounttd" : (($value=='iudc1' || $value=='iudc2' || $value=='iudc3') ?  "form-control numberclass dotcountdc" : "form-control numberclass childvacc ")).'" name="product[vaccinated]['.$singleVacc["item_id"].'][moonrownum]['.$value.']" type="text" data-prodgroup="'.$singleVacc["item_id"].'" '.(($singleVacc["item_category_id"]!=1)?'disabled="disabled"':'').'>
	...
	$fullyimmunized .= '
		<tr class="cst-item-row" data-prodrow="9999" data-prodrowindex="0">
			...
			<td colspan="5">
				...
				<input class="form-control numberclass " id="txt1fully" name="product[vaccinated][9999][0][iufm1]" type="text" data-prodgroup="9999" onkeyup="sumfully()" style="width: Calc(100% - 25px);display: inline;">
			</td >
			<td colspan="5">
				<span style="padding-top: 4px;padding-left: 3px;padding-right: 3px;font-weight: bold">F:</span>
				<input class="form-control numberclass " id="txt2fully" name="product[vaccinated][9999][0][iuff1]" type="text" data-prodgroup="9999" onkeyup="sumfully()" style="width: Calc(100% - 25px);display: inline;">
			</td>
			<td colspan="5">
				<span style="padding-top: 4px;padding-left: 3px;padding-right: 3px;font-weight: bold">Total:</span>
				<input class="form-control numberclass " id="totalfully" name="totalfully" type="text" data-prodgroup="9999" style="width: Calc(100% - 45px);display: inline;" disabled="disabled">
			</td>
		</tr>';
...
if($fmcells!==""){
	...
	foreach($fmcells as $key=>$value){
		...
		$vaccinatedcell .= '
			<td class="'.$sectionclass.' ">
				<input class="form-control numberclass " name="product[vaccinated][9998][0]['.$value.']" type="text" data-prodgroup="9998">
			</td>';
	}
	$dtpbooster .= '
		<tr class="cst-item-row" data-prodrow="9998" data-prodrowindex="0">
			...
			<td colspan="5">
				<span style="padding-top: 4px;padding-left: 3px;padding-right: 3px;    font-weight: bold">M:</span>
				<input class="form-control numberclass " id="txt1dtp" name="product[vaccinated][9998][0][iufm1]" type="text" data-prodgroup="9998" onkeyup="sumdtp()" style="width: Calc(100% - 25px);display: inline;">
			</td >
			<td colspan="5">
				<span style="padding-top: 4px;padding-left: 3px;padding-right: 3px;font-weight: bold">F:</span>
				<input class="form-control numberclass " id="txt2dtp" name="product[vaccinated][9998][0][iuff1]" type="text" data-prodgroup="9998" onkeyup="sumdtp()" style="width: Calc(100% - 25px);display: inline;">
			</td>
			<td colspan="5">
				<span style="padding-top: 4px;padding-left: 3px;padding-right: 3px;font-weight: bold">Total:</span>
				<input class="form-control numberclass " id="totaldtp" name="totaldtp" type="text" data-prodgroup="9998" style="width: Calc(100% - 45px);display: inline;" disabled="disabled">
			</td>
		</tr>';
