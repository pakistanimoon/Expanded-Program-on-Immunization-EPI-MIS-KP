				...
				<?php echo form_open(base_url().'vaccination/save',array("id"=>"vacc_cr_form","class"=>"form-horizontal")); ?>
					...
					<div id="parent">
						<table id="fixTable" class="fixTable22 table table-bordered table-condensed table-striped table-hover mytable3">
							<thead>
								...
								<tr class="text-center">
									...
									<th colspan="2">12-23</th>
									<th colspan="2">>23</th>
									<th colspan="2" class="outsideuc">0-11</th>
									<th colspan="2" class="outsideuc">12-23</th>
									<th colspan="2" class="outsideuc">>23</th>
									<th colspan="2" class="outsideuc">0-11</th>
									<th colspan="2" class="outsideuc">12-23</th>
									<th colspan="2" class="outsideuc">>23</th>
									<th colspan="2" class="outsideuc">0-11</th>
									...
									<th colspan="2" class="outsideuc">12-23</th>
									<th colspan="2" class="outsideuc">>23</th>
									<th colspan="2" class="outsidedist">0-11</th>
									<th colspan="2" class="outsidedist">12-23</th>
									<th colspan="2" class="outsidedist">>23</th>
									<th colspan="2" class="outsidedist">0-11</th>
									<th colspan="2" class="outsidedist">12-23</th>
									<th colspan="2" class="outsidedist">>23</th>
									<th colspan="2" class="outsidedist">0-11</th>
								...
								<tr class="text-center">
									...
									<th>M</th>
									<th>F</th>
									<th class="outsideuc">M</th>
									<th class="outsideuc">F</th>
									<th class="outsideuc">M</th>
									<th class="outsideuc">F</th>
									<th class="outsideuc">M</th>
									<th class="outsideuc">F</th>
									...
									<th class="outsideuc">M</th>
									<th class="outsideuc">F</th>
									<th class="outsidedist">M</th>
									<th class="outsidedist">F</th>
									<th class="outsidedist">M</th>
									<th class="outsidedist">F</th>
									<th class="outsidedist">M</th>
									<th class="outsidedist">F</th>
						...
						<!--<table class="table table-bordered table-condensed table-striped table-hover mytable3">
							<thead>
								<tr>
									<th rowspan="5" style="width:14%;"><label>Product</label></th>
									<th rowspan="5" style="width:7%;"><label>Batch number</label></th>
									<th rowspan="5" style="width:1%;"><label>Doses Per Vial</label></th>
									<th rowspan="4"><label>Opening Balance</label></th>
									<th rowspan="4"><label>Received</label></th>
									<th rowspan="5"><label>#</label></th>
									<th colspan="24" class="mergedvaccinatedcellsTT"><label>Vaccinated</label></th>
									<th colspan="2" rowspan="4"><label>Used</label></th>
									<th colspan="2" rowspan="4"><label>Unusable</label></th>
									<!--<th colspan="3" rowspan="4"><label>Adjustment</label></th>--
									<th colspan="2" rowspan="4"><label>Closing Balance</label></th>
								</tr>
								<tr>
									<th colspan="8"><label>Inside UC</label></th>
									<th colspan="8" class="outsideucTT"><label>Outside UC</label></th>
									<th colspan="8" class="outsidedistTT"><label>Out District</label></th>
								</tr>
								<tr>
									...
									<th colspan="2" class="outsideucTT"><label>Fixed</label></th>
									<th colspan="2" class="outsideucTT"><label>Outreach</label></th>
									<th colspan="2" class="outsideucTT"><label>Mobile</label></th>
									<th colspan="2" class="outsideucTT"><label>Health House</label></th>
									
									<th colspan="2" class="outsidedistTT"><label>Fixed</label></th>
									<th colspan="2" class="outsidedistTT"><label>Outreach</label></th>
									<th colspan="2" class="outsidedistTT"><label>Mobile</label></th>
									<th colspan="2" class="outsidedistTT"><label>Health House</label></th>
								</tr>
								<tr class="text-center">
									...
									<td class="outsideucTT">Pregnant Women</td>
									<td class="outsideucTT">Non-Pregnant</td>
									<td class="outsideucTT">Pregnant Women</td>
									<td class="outsideucTT">Non-Pregnant</td>
									<td class="outsideucTT">Pregnant Women</td>
									<td class="outsideucTT">Non-Pregnant</td>
									...
									<td class="outsidedistTT">Pregnant Women</td>
									<td class="outsidedistTT">Non-Pregnant</td>
									<td class="outsidedistTT">Pregnant Women</td>
									<td class="outsidedistTT">Non-Pregnant</td>
									<td class="outsidedistTT">Pregnant Women</td>
									<td class="outsidedistTT">Non-Pregnant</td>
								...
								<tr style="background: white none repeat scroll 0% 0%; color: black;">
									...
									<th>C</th>
									<th></th>
									<th colspan="24" class="mergedvaccinatedcellsTT">D</th>
									<th colspan="2">E</th>
									<th colspan="2">F</th>
									<!--<th></th>
									<th></th>
							...
							<tbody id="myTableTT" class="consumptionitemsTT default">
								<tr class="text-center">
									<td colspan="38" class="mergedvaccinatedcellsTT" style="font-size:20px">Please Select criteria from above section, Item(s) will be loaded automatically.</td>									
								</tr>
							</tbody>
						</table>-->
					</div>
