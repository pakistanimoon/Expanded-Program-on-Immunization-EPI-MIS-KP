...
<div class="container bodycontainer">
	...
	<?php if($this -> session -> flashdata('message')){  ?><div class="alert alert-success text-center" role="alert"><strong><?php echo $this -> session -> flashdata('message'); ?></strong></div> <?php } ?>
	  <div class="panel panel-primary">
    	...
    	<div class="panel-heading">Village/Mohalla View</div>
  	  	<div class="panel-body">
				...
				<div class="row">
					...
					<label class="col-xs-2 col-xs-offset-1 control-label">Postal Office:</label>
					  	<div class="col-xs-3">
							<?php echo $data[0]['postal_address']; ?>
					  	</div>
					</div>
				</div>-->
				...
				<div class="row">
					<div class="col-xs-7 " style="margin-left:78.5%;" >
					   <a href=" <?php echo base_url();?>Edit-village/<?php echo $data[0]['uncode']; ?>" class="btn btn-md btn-success"><i class="fa fa-pencil-square-o"></i> Update </a>
