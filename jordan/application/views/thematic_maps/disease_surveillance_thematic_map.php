				...
				<div class="carview_wraper">
					<ul class="row">
						<?php
							...
							*/
							$cardOne['heading'] 	= "Polio";
							$cardOne['image'] 		= "chart1.png";
							$cardOne['value'] 		= 0; // For Numeric Values Send value formated in number_format.
							$cardTwo['heading'] 	= "Tetanus Neonatal";
							$cardTwo['image'] 		= "peichart.jpg";
							$cardTwo['value'] 		= 3; // For Numeric Values Send value formated in number_format.
							$cardThree['heading'] 	= "Measles  ";
							$cardThree['image'] 	= "timely.png";
							$cardThree['value'] 	= 148; // For Percentage Values Send value concatenated with % to be shown in percentage.
							$cardFour['heading'] 	= "Diphtheria ";
							$cardFour['image'] 		= "complince.png";
							$cardFour['value']		= 0; // For Numeric Values Send value formated in number_format.
...
<script type="text/javascript">
	...
	function formatter(e,distwisemap='false'){
		...
		return text+': <b>' + e.point.name + ' (' + e.point.id + ')' + '</b><br> ' + 'No. of Cases and Deaths: <b>' + e.point.value + '</b>';
	}
	...
	function eventHandler(e, run){
		...
		if(run){
			if(dataId.length <= 2){
				var url = '<?php echo base_url(); ?>thematic_maps/DiseaseSurveillance/onClickDistrictWiseMapData/'+dataId+'/';
