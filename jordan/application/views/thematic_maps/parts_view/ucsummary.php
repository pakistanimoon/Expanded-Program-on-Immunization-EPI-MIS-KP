...
<div class="container-fluid">
	...
	<div class="section-title">
	<span>Monthly Vaccination Comparsion Trends</span><strong style="font-size:11px;"><?php echo $distYear ?></strong>
	<div class="pull-right">
	...
	<div class="col-md-6">
	<div class="section-title">
	<span>Monthly Vaccination Comparsion</span><strong style="font-size:11px;"><?php echo $distYear ?></strong>
	<div class="pull-right">
...
// start 
	...
	FusionCharts.ready(function() {
		var salesChart = new FusionCharts({
			...
			dataSource: {
				"chart": {
					"caption": "Monthly Vaccination Comparsion<?php echo $distYear1; ?>",
					"subcaption": "PENTA-1, PENTA-3, Measles-1, Measles-2",
	...
	FusionCharts.ready(function() {
		var salesChart = new FusionCharts({
			...
			dataSource: {
				"chart": {
					"caption": "Monthly Vaccination Comparsion<?php echo $distYear1; ?>",
					"subcaption": "OPV 2, Penta 2, PCV10 2, Rota 2",
					"yaxisname": "Percentage",
					"xaxisname": "Year-Month",
					"linethickness": "2",
					"numberPostfix": "/-",
	...
	FusionCharts.ready(function() {
		var salesChart = new FusionCharts({
			...
			dataSource: {
				"chart": {
					"caption": "Monthly Vaccination Comparsion<?php echo $distYear1; ?>",
					"subcaption": "OPV 3, Penta 3, PCV10 3, IPV",
					"yaxisname": "Percentage",
					"xaxisname": "Year-Month",
					"linethickness": "2",
					"numberPostfix": "/-",
		...
		var salesChart = new FusionCharts({
			...
			dataSource: {
				"chart": {
					...
					"subcaption": "PENTA-I - Measles-I, PENTA-I - PENTA-III, Measles-I - Measles-II, TT-I - TT-II",
					"yaxisname": "Percentage",
					"linethickness": "2",
					"numberPostfix": "%",
					"showValues" : "1",
			...
			"dataset": [{
			  "seriesname": "PENTA-I - Measles-I Dropout",
			  "data": [
				<?php foreach($penta1_measles1 as $key => $value){ ?>
					{
						"value": "<?php echo ($value['dropout'] != NULL AND $value['dropout'] >= 0)?round($value['dropout']):0; ?>"
			...
			{
			  "seriesname": "Measles-I - Measles-II Dropout",
			  "data": [
