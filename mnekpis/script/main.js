/*$(function () {
  ...
  $(".anchor-uk").each(function(i){
   ...
   //console.log(url);
   if(url == pgurl){
    $(this).parent().closest('ul').parent().find('a').removeClass('collapsed');
    $(this).parents('ul').addClass('in');
     $(this).parents('ul').css('height',"auto");
    $(this).parents('li[class^="parent-uk"]').addClass('active');
   }/*else{
    $(this).parent().closest('ul').parent().find('a').addClass('collapsed');
    $(this).parents('ul[id="toggleUser"]').removeClass('in');
     $(this).parents('ul[id="toggleUser"]').css('height',"0px");
    $(this).parents('li[class^="parent-uk"]').removeClass('active');
   }*/
  });
 });
    $(document).on('click','.parent-uk',function(){
        $(".anchor-uk").each(function(i){
        $(this).parent().closest('ul').parent().find('a').addClass('collapsed');
    $(this).parents('ul[id="toggleUser"]').removeClass('in');
     $(this).parents('ul[id="toggleUser"]').css('height',"0px");
