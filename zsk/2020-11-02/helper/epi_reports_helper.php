...
if(!function_exists('getListingReportTable')){
		function getListingReportTable($allData,$listingFor,$allTotal=NULL,$sectionTotal = 'Yes',$indicator_report='NO',$otherReports='NO',$showinnerTotal = 'Yes')
    {
      ...
      //  echo "<pre>"; print_r($data);exit();
			...
			$html .= ' 
				<div class="row">
    	   	   	  <div class="col-xs-2 col-xs-offset-5">
    	   	   		<h4 style="margin-top: 0px; font-size: 20px; font-weight: 900;">District:</h4>
    	   	   	  </div>
    	   	      <div class="col-xs-">
    	   	   		<h5 style="font-weight: 600; position: relative; top: -5px;">' . DistrictName($data['distcode']) . '</h5>
    	   	   	  </div>
    	   	   </div>';
    	}
		...
		if (array_key_exists("year",$data) && $data['year'] != ''){
            ...
            <div class="col-xs-2 col-xs-offset-5" style="">
    	   	   		<h4 style="margin-top: 0px;font-size: 20px; font-weight: 900;">Year:</h4>
    	   	   	  </div>
                        <div class="col-xs-2">
    	   	   		<h5 style="position: relative; font-weight: 600; margin-top: 5px;">' . $data['year']  . '</h5>
    	   	   	  </div>
    	   	   </div>';
		}
		...
		if (array_key_exists("from_week",$data) && $data['from_week'] != ''){
			$html .= ' <div class="row">
    	   	   	  <div class="col-xs-2 col-xs-offset-5">
    	   	   		<h5 style="margin-top: 0px;font-size: 20px; font-weight: 900;">From Week:</h4>
    	   	   	  </div>
    	   	      <div class="col-xs-2" style="">
    	   	   		<h5 style="font-weight: 600; margin-top: 4px;">' . sprintf("%02d",$data['from_week'])  . '</h5>
    	   	   	  </div>
    	   	   </div>';
		}
		if (array_key_exists("to_week",$data) && $data['to_week'] != ''){
			$html .= ' <div class="row">
    	   	   	  <div class="col-xs-2 col-xs-offset-5">
    	   	   		<h5 style="margin-top: 0px;font-size: 20px; font-weight: 900;">To Week:</h4>
    	   	   	  </div>
    	   	      <div class="col-xs-2">
    	   	   		<h5 style="font-weight: 600; margin-top: 4px;">' . sprintf("%02d",$data['to_week']) . '</h5>
    	   	   	  </div>
    	   	   </div>';
		}
