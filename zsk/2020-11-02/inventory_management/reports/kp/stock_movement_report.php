		...
		<div class="panel panel-primary">
			...
			<div class="panel-body">
				<table class="table table-bordered   table-striped table-hover  mytable">
					<tr>
						<td><label>From Warehouse Store</label></td> 
						<td><?php if(isset($wh_type)){
						if($wh_code=="all")
								{
									echo "All Districts";
								}
						...
						<td><label>TO Warehouse Store</label></td>
						<td><?php if(isset($to_wh_type)){ 
								if($to_wh_code=="all")
								{
									echo "All Districts";
								}
					...
					<tr>
						...
						<td><?php if(isset($indicator)){switch($indicator){case 1:$indtitle="Issue";break;case 2:$indtitle="Receive";break;case 3:$indtitle="Stock In Hand";break;}echo $indtitle; } ?></td>
					</tr>
				</table>
	<?php }?>
				<table class="table table-bordered table-condensed table-striped table-hover mytable" border="1" >
					<thead>
						<tr>
							<th>Product</th>
							<th><?php echo $label = date("M-y",strtotime($yearmonth[0]."-01")); ?></th>
							<th><?php echo $label = date("M-y",strtotime($yearmonth[1]."-01")); ?></th>
							<th><?php echo $label = date("M-y",strtotime($yearmonth[2]."-01")); ?></th>
							<th><?php echo $label = date("M-y",strtotime($yearmonth[3]."-01")); ?></th>
							<th><?php echo $label = date("M-y",strtotime($yearmonth[4]."-01")); ?></th>
							<th><?php echo $label = date("M-y",strtotime($yearmonth[5]."-01")); ?></th>
							<th><?php echo $label = date("M-y",strtotime($yearmonth[6]."-01")); ?></th>
							<th><?php echo $label = date("M-y",strtotime($yearmonth[7]."-01")); ?></th>
							<th><?php echo $label = date("M-y",strtotime($yearmonth[8]."-01")); ?></th>
							<th><?php echo $label = date("M-y",strtotime($yearmonth[9]."-01")); ?></th>
							<th><?php echo $label = date("M-y",strtotime($yearmonth[10]."-01")); ?></th>
							<th><?php echo $label = date("M-y",strtotime($yearmonth[11]."-01")); ?></th>
					...
					<tbody>
						...
						foreach($reportdata as $key=>$row){
							...
							*/?>
							<tr>
								<th><?php echo $row["item_name"]; ?></td>
								<td><?php echo $row["totalm1"]; ?></td>
								<td><?php echo $row["totalm2"]; ?></td>
								<td><?php echo $row["totalm3"]; ?></td>
								<td><?php echo $row["totalm4"]; ?></td>
								<td><?php echo $row["totalm5"]; ?></td>
								<td><?php echo $row["totalm6"]; ?></td>
								<td><?php echo $row["totalm7"]; ?></td>
								<td><?php echo $row["totalm8"]; ?></td>
								<td><?php echo $row["totalm9"]; ?></td>
								<td><?php echo $row["totalm10"]; ?></td>
								<td><?php echo $row["totalm11"]; ?></td>
								<td><?php echo $row["totalm12"]; ?></td>
