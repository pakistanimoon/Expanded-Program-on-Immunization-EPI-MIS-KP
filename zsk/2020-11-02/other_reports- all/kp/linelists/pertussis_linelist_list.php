...
<div class="row">
    <div class="panel panel-primary">
     ...
     <ol class="breadcrumb">
      ...
      <div class="panel-heading"> List for Pertussis Outbreak Investigation Linelist of Suspected Cases
        </div>
              ...
              <tr class="success">
                ...
                <th class="text-center Heading">Date of Investigation</th>
                 <th class="text-center Heading">
                  <a href="<?php echo base_url(); ?>Linelists/pertussis_linelist" data-toggle="tooltip" title="Add New Pertussis LineList">
...
?>
                           ...
                           <tr>
                              ...
                              <td class="text-center">
                                <!--<a href="<?php echo base_url(); ?>Linelists/pertussis_linelist_view/<?php echo $row['distcode']; ?>/<?php echo $row['linelist_group']; ?>" data-toggle="tooltip" title="View" class="btn btn-xs btn-default"><i class="fa fa-search"></i></a>-->
                              	<a href="<?php echo base_url(); ?>Linelists/pertussis_linelist_edit/<?php echo $row['distcode']; ?>/<?php echo $row['linelist_group']; ?>" data-toggle="tooltip" title="Edit" class="btn btn-xs btn-default"><i class="fa fa-pencil"></i></a>
                              </td>	
                           </tr>
    ...
    $(document).on("click",".paginateMe",  function (e){
      ...
      $('#tbody').html('<h1><td colspan="10" class="text-center" ><img src="<?php echo base_url(); ?>includes/images/ajax-loader_blue.gif"> loading...</td></h1>');
        ...
        $.ajax({
          ...
          dataType:"json",
          url: "<?php echo base_url(); ?>Ajax_calls/pertussis_linelist_filter?page="+page,
  ...
  $('.filter-status').on('change' , function (){
    ...
    $('#tbody').html('<h1><td colspan="10" class="text-center" ><img src="<?php echo base_url(); ?>includes/images/ajax-loader_blue.gif"> loading...</td></h1>');
        ...
        $.ajax({
          type: "GET",
          data: $('#filter-form').serialize(),
          url: "<?php echo base_url(); ?>Ajax_calls/pertussis_linelist_filter",
          dataType: "json",
          success: function(result){
            console.log(result);
            $('#tbody').html('');
