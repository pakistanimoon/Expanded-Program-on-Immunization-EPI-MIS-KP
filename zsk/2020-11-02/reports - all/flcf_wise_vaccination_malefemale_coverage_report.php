...
<div class="container bodycontainer">
	...
	<div id="parent">
		<table id="fixTable"  class="table table-bordered table-hover table-striped">
			<thead>
				<tr>
					<th rowspan="3" style="min-width: 56px; background: #008d4c; color: white; width: 200px; border: 1px solid black;">S No.</th>
					<?php if(!isset($data[0]['uncode']) && isset($data[0]['distcode'])) {?>
   	   				<th rowspan="3" style="min-width:170px; background: #008d4c; color: white; width: 200px; border: 1px solid black;">Distcode</th>
					<th rowspan="3" style="min-width: 170px; background: #008d4c; color: white; width: 200px; border: 1px solid black;">District</th>
					<?php } else if(isset($data[0]['tcode'])) {?>
   	   				<th rowspan="3" style="min-width:170px; background: #008d4c; color: white; width: 200px; border: 1px solid black;">Tehsil Code</th>
					<th rowspan="3" style="min-width: 170px; background: #008d4c; color: white; width: 200px; border: 1px solid black;">Tehsil Name</th>
   	   				<?php } else if(isset($data[0]['uncode'])) {?>
					<th rowspan="3" style="min-width:100px; background: #008d4c; color: white; width: 200px; border: 1px solid black;">Uncode</th>
					<th rowspan="3" style="min-width: 207px; background: #008d4c; color: white; width: 200px; border: 1px solid black;">UnionCouncil</th>
					<?php } else { ?>
					<th rowspan="3" style="min-width:100px; background: #008d4c; color: white; width: 200px; border: 1px solid black;">EPI Center Code</th>
					<th rowspan="3" style="min-width: 207px; background: #008d4c; color: white; width: 200px; border: 1px solid black;">EPI Center</th>
					<?php } ?>
				...
				<tr>
					...
					<th class="Heading text-center" style="background: #008d4c; color: white; width: 200px; border: 1px solid black;" rowspan="2">F</th>
					<th class="Heading text-center" style="background: #008d4c; color: white; width: 200px; border: 1px solid black;" rowspan="2">%</th>
					<th class="Heading text-center" style="background: #008d4c; color: white; width: 200px; border: 1px solid black;" class="Heading text-center" style="background: #008d4c; color: white; width: 200px; border: 1px solid black;" colspan="4">0</th>
			...
			<tbody>  
				...
				foreach($data as $val)
				{
					if(($val['New Borns Male']==NULL || $val['New Borns FeMale']==NULL) && $val['mbcg']!=NULL)
					{
						$val['percmbcg']=
						$val['percfbcg']=
						$val['percmopv_o']=
					...
					echo "<tr class='DrillDownRow'><td>".$count."</td><td style='text-align:center; border: 1px solid black;' class='text-center'>";
				...
				echo "<tr><td style='text-align:center; border: 1px solid black;' class='text-center'></td>
				<td style='text-align:center; border: 1px solid black;' class='text-center'></td>
				<td class='text-center'><strong> Total: </strong></td><td>";
				echo implode("</td><td style='text-align:center; border: 1px solid black;' class=\"text-red\">",$total);
				echo "</td></tr>";
				}
				else{
					echo "<tr><td style='text-align:center; border: 1px solid black;' class='text-center'></td>
					<td style='text-align:center; border: 1px solid black;' class='text-center'></td>
					<td style='text-align:center; border: 1px solid black;' class='text-center' colspan='32'><strong> No Record Found </strong></td><td>";
				}
				?>
			</tbody>
		</table>
