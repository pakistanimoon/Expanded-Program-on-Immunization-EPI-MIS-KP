     ...
     <table  class="table tableuc table-condensed footable table-vcenter tbl-consolidated-uc row-border  order-column" data-filter="#filter" data-filter-text-only="true">
        <thead>
			<tr style="background-color: #15681E;color: #FFF;">
				<th rowspan="2" class="thuc col">S.No</th>
				<th rowspan="2" class="thuc col"><?php if($distcode > 0){echo "FLCF Code";}else{echo "Distcode";} ?></th>
				<th rowspan="2" class="thuc col"><?php if($distcode > 0){echo "Name of FLCF";}else{echo "District";} ?></th>
				<th rowspan="2" class="thuc col"><?php if($distcode > 0){echo "Name of UC";}else{echo "UCs";} ?></th>
				<th colspan="2" class="thuc col">Target</th>
				<th rowspan="2" class="thuc col">BCG</th>
				<!--<th rowspan="2" class="thuc col">%</th>-->
				<th rowspan="2" class="thuc col">Hep B</th>
				<!--<th rowspan="2" class="thuc col">%</th>-->
				
				<th colspan="4" class="thuc col">OPV</th>
				<th colspan="3" class="thuc col">Pentavalent</th>
				<th colspan="3" class="thuc col">PVC 10</th>
				<th rowspan="2" class="thuc col">IPV</th>
				<!--<th rowspan="2" class="thuc col">%</th>-->
				<th colspan="2" class="thuc col">Measles</th>
			  
				<th colspan="5" class="thuc col">TT PL</th>
				<th colspan="5" class="thuc col">CBAs</th>
				<!--<th colspan="3" class="thuc col">Drop Outs</th>-->
			...
			<tr>
				...
				<th class="thuc col">Children</th>
				<th class="thuc col">Women</th>
			
				<th class="thuc col">0</th>
				<!--<th class="thuc col">%</th>-->
				<th class="thuc col">I</th>
				<!--<th class="thuc col">%</th>-->
				 <th class="thuc col">II</th>
				<!--<th class="thuc col">%</th>-->
				 <th class="thuc col">III</th>
				<!--<th class="thuc col">%</th>-->
				...
				<!--<th class="thuc col">%</th>-->
				 <th class="thuc col">III</th>
				<th class="thuc col">IV</th>
				<th class="thuc col">V</th>
				...
				<th class="thuc col">IV</th>
				<th class="thuc col">V</th>
				<!--<th class="thuc col">BCG-MI</th>
				<th class="thuc col">PI-PIII</th>
				<th class="thuc col">TTI-TTII</th>-->
			</tr>
		</thead>
		<tbody id="tbody tablebody">  
			...
			foreach($data as $val)
			{
				echo "<tr class=\"Coverage\"><td class=\"tduc\">".$count."</td><td class=\"tduc\">";
				//print_r($val);
				echo implode("</td><td class=\"tduc\">",$val);
