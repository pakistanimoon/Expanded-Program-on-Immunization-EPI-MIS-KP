...
<div class="row">
		...
		<div class="col-xs-6 text-left">
			<td><?php echo get_District_Name($argu['0']);?> </tdtd>
		</div>
  	 </div>
			...
			<div class="panel-body">					
					<table class="table table-bordered plan_table">						
						...
						<tbody id="trRow">
							...
							<tr>
								<td><?php echo $view['vaccines']?></td>
								<td><?php $m_m=$m_m+$view['0_11_m_m']; echo $view['0_11_m_m']?></td>
								<td><?php $m_f=$m_f+$view['0_11_m_f']; echo $view['0_11_m_f']?></td>
								<td><?php $m_m1=$m_m1+$view['12_23_m_m']; echo $view['12_23_m_m']?></td>
								<td><?php $m_f1=$m_f1+$view['12_23_m_f']; echo $view['12_23_m_f']?></td>
								<td><?php $years_m=$years_m+$view['years_m']; echo $view['years_m']?></td>
								<td><?php $years_f=$years_f+$view['years_f']; echo $view['years_f']?></td>
								<td><?php $total_m=$total_m+$view['total_m']; echo $view['total_m']?></td>
								<td><?php $total_f=$total_f+$view['total_f']; echo $view['total_f']?></td>
								<td><?php $total_m_f=$total_m_f+$view['total_m_f']; echo $view['total_m_f']?></td>		 
							</tr>
							<?php } ?>
							<tr>
