		...
		<table id="fixTable"  class="table table-bordered table-hover table-striped">
			<thead>
				<tr>
					...
					<th colspan="24">OPV</th>
					<th colspan="18">Pentavalent</th>
					<th colspan="18">PCV 10</th>
					<th colspan="6">IPV</th>
					<th colspan="12">Rota</th>
					<th colspan="6">Measles</th>
					<th colspan="6">Fully Immunized</th>
					<th colspan="6">Measles</th>
				...
				<tr>
					<!-- BCG --> 
					<th rowspan="2">Total Vaccination Male</th>
					<th rowspan="2"><?php echo $vaccinationType; ?> Vaccination Male</th>
					<th rowspan="2"><?php echo $vaccinationType; ?> % Male</th>
					<th rowspan="2">Total Vaccination Female</th>
					<th rowspan="2"><?php echo $vaccinationType; ?> Vaccination Female</th>
					<th rowspan="2"><?php echo $vaccinationType; ?> % Female</th>
					<!-- Hep B --> 
					<th rowspan="2">Total Vaccination Male</th>
					<th rowspan="2"><?php echo $vaccinationType; ?> Vaccination Male</th>
					<th rowspan="2"><?php echo $vaccinationType; ?> % Male</th>
