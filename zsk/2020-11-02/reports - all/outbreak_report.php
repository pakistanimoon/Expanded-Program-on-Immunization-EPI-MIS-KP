...
<div class="row">
 ...
 <!-- <div class="row">
		...
		<div class="col-xs-6 text-left">
			<td style="text-align:center; border: 1px solid black;" class="text-center"><?php //echo  get_Tehsil_Name($argu['1']); ?> </td>
		</div>
  	 </div>
<?php //} if($argu['2']!='') { ?>
 <div class="row">
...
<!-- <div class="row">
		...
		<div class="col-xs-6 text-left">
			<td style="text-align:center; border: 1px solid black;" class="text-center"><?php //echo $argu['6']?> </td>
		</div>
  	 </div>
<?php// } if($argu['7']!='') { ?>
 ...
 <div class="row">
		...
		<div class="col-xs-6 text-left">
			<td style="text-align:center; border: 1px solid black;" class="text-center"><?php //echo $argu['7']?> </td>
		</div>
  	 </div> -->
	<?php //} ?>  	 
		...
		<div class="panel panel-primary"  style="margin-top: 70px">
			...
			<div class="panel-body">					
					<table class="table table-bordered plan_table">						
						<thead>
							<tr>
								<th rowspan="2" style="width:10%;">All Vaccines List</th>
								...
								<th class="Heading text-center" style="background: #008d4c; color: white; width: 200px; border: 1px solid black;" colspan="2">&gt; Years</th>
						...
						<tbody id="trRow">
							...
							<?php } ?>
							<tr>
								<td style="background-color: black; color: white; border: 1px solid black;" class="text-center">Total</td>
								<td style="background-color: black; color: white; border: 1px solid black;" class="text-center"><?php echo $m_m;?></td>
								<td style="background-color: black; color: white; border: 1px solid black;" class="text-center"><?php echo $m_f;?></td>
								<td style="background-color: black; color: white; border: 1px solid black;" class="text-center"><?php echo $m_m1;?></td>
								<td style="background-color: black; color: white; border: 1px solid black;" class="text-center"><?php echo $m_f1;?></td>
								<td style="background-color: black; color: white; border: 1px solid black;" class="text-center"><?php echo $years_m;?></td>
								<td style="background-color: black; color: white; border: 1px solid black;" class="text-center"><?php echo $years_f;?></td>
								<td style="background-color: black; color: white; border: 1px solid black;" class="text-center"><?php echo $total_m;?></td>
								<td style="background-color: black; color: white; border: 1px solid black;" class="text-center"><?php echo $total_f;?></td>
								<td style="background-color: black; color: white; border: 1px solid black;" class="text-center"><?php echo $total_m_f;?></td>
							</tr>
						</tbody>					
					</table>		
			</div>
