        ...
        <table class="table table-bordered table-condensed table-striped table-hover mytable">
          <t1head>
            <tr>
              ...
              <th class="Heading text-center" style="background: #008d4c; color: white; width: 200px; border: 1px solid black;" rowspan="2"># of pertussis<br>vaccine doses received</th>
              <th class="Heading text-center" style="background: #008d4c; color: white; width: 200px; border: 1px solid black;" rowspan="2">Date<br>of last<br> pertussis dose</th>
